void Xbyak::print_misc(xed_decoded_inst_t *xedd) {
  xed_uint_t i = 0;
...
void Xbyak::print_attributes(xed_decoded_inst_t *xedd) {
...
void Xbyak::print_reads_zf_flag(xed_decoded_inst_t *xedd) {
...
void Xbyak::print_flags(xed_decoded_inst_t *xedd) {
...
void Xbyak::print_memops(xed_decoded_inst_t *xedd) {
...
void Xbyak::print_operands(xed_decoded_inst_t *xedd) {
...
void Xbyak::xt_dump_a64fx_operandsV3(xt_a64fx_operands_structV3_t *a64) {
  std::cout << std::dec;
...
void Xbyak::xt_dump_a64fx_operands(xt_a64fx_operands_struct_t *a64) {
  std::cout << "==============================" << std::endl;
...
void Xbyak::xt_dump_x86_64_decoded_info(xed_decoded_inst_t *p) {
