 ...
 *******************************************************************************/
void Xbyak::CodeGenerator::translateOR(xed_decoded_inst_t *p) {
  ...
  if (false || (a64.dstWidth == 64 && a64.dstType == A64_OP_REG &&
                a64.srcType == A64_OP_IMM && true)) {
    if (a64.simm != 0) {
      xa_->mov_imm(X_TMP_1, static_cast<int64_t>(a64.simm));
    } else {
  ...
  if (false || (a64.dstWidth == 64 && a64.dstType == A64_OP_MEM &&
                a64.srcType == A64_OP_IMM && true)) {
    xa_->orr(X_TMP_0, X_TMP_0, a64.uimm);
  }
  ...
  if (false || (a64.dstWidth == 32 && a64.dstType == A64_OP_MEM &&
                a64.srcType == A64_OP_REG && true)) {
    xa_->orr(W_TMP_0, W_TMP_0, xa::WReg(a64.srcIdx));
  }
  /* Col=AL103*/
  if (false || (a64.dstWidth == 64 && a64.dstType == A64_OP_MEM &&
                a64.srcType == A64_OP_REG && true)) {
    xa_->orr(X_TMP_0, X_TMP_0, xa::XReg(a64.srcIdx));
  }
