...
void Xbyak::CodeGenerator::translateVDIVPS(xed_decoded_inst_t *p) {
  ...
  if (false ||
      ...
      (a64_opt.operands[0].opName == XED_OPERAND_REG0 &&
       ...
       a64_opt.operands[0].opWidth == 256 && isAvailAll1Preg0_7() == true &&
       true)) {
    xa_->fdiv(xa::ZRegS(dstTmpIdx), P_ALL_ONE_0_7, xa::ZRegS(srcTmpIdx));
  }
  /* Col=BI119*/
  if (false ||
      (a64_opt.operands[0].opName == XED_OPERAND_REG0 &&
      ...
      (a64_opt.operands[0].opName == XED_OPERAND_REG0 &&
       ...
       true)) {
    if (dstIdx != srcIdx) {
      xa_->mov(xa::ZRegD(dstIdx), xa::ZRegD(dstTmpIdx));
      xt_pop_zreg();
    }
  }
  /* Col=BL119*/
  ...
  if (false || (a64.operands[0].opName == XED_OPERAND_REG0 &&
                ...
                a64.operands[0].opWidth == 128 && a64.predType == A64_PRED_NO &&
                a64.EVEXb == 0 && true)) {
    xa_->ld1(xa::VReg(zTmpIdx).s4, xa::ptr(X_TMP_ADDR));
  }
  /* Col=AH119*/
  if (false ||
      (a64.operands[0].opName == XED_OPERAND_REG0 &&
      ...
      (a64.operands[0].opName == XED_OPERAND_REG0 &&
       ...
       a64.operands[0].opWidth == 512 && a64.predType == A64_PRED_NO &&
       a64.EVEXb == 1 && true)) {
    xa_->ld1r(xa::VReg(zTmpIdx).s4, xa::ptr(X_TMP_ADDR));
  }
  /* Col=AI119*/
  if (false ||
      (a64.operands[0].opName == XED_OPERAND_REG0 &&
  ...
  if (false ||
      ...
      (a64.operands[0].opName == XED_OPERAND_REG0 &&
       ...
       a64.operands[0].opWidth == 512 && a64.predType == A64_PRED_NO &&
       a64.EVEXb == 1 && true)) {
    xa_->mov(xa::PRegB(pTmpIdx), P_ALL_ONE, P_ALL_ONE.b);
  }
  /* Col=AL119*/
  if (false ||
      (a64.operands[0].opName == XED_OPERAND_REG0 &&
  ...
  if (false ||
      ...
      (a64.operands[0].opName == XED_OPERAND_REG0 &&
       ...
       a64.operands[0].opWidth == 512 && a64.predType == A64_PRED_MERG &&
       a64.EVEXb == 0 && true)) {
    xa_->fdiv(xa::VReg(dstIdx).s4, xa::VReg(srcIdx).s4, xa::VReg(src2Idx).s4);
  }
  /* Col=AP119*/
  if (false ||
      (a64.operands[0].opName == XED_OPERAND_REG0 &&
      ...
      (a64.operands[0].opName == XED_OPERAND_REG0 &&
       ...
       a64.operands[0].opWidth == 128 && a64.predType == A64_PRED_NO &&
       a64.EVEXb == 1 && true)) {
    xa_->fdiv(xa::VReg(dstIdx).s4, xa::VReg(srcIdx).s4, xa::VReg(zTmpIdx).s4);
  }
  /* Col=AQ119*/
  if (false ||
      (a64.operands[0].opName == XED_OPERAND_REG0 &&
      ...
      (a64.operands[0].opName == XED_OPERAND_REG0 &&
       ...
       a64.operands[0].opWidth == 512 && a64.predType == A64_PRED_MERG &&
       a64.EVEXb == 1 && true)) {
    xa_->fdiv(xa::ZRegS(dstTmpIdx), xa::PReg(pTmpIdx), xa::ZRegS(srcTmpIdx));
  }
  /* Col=AU119*/
  if (false ||
      (a64.operands[0].opName == XED_OPERAND_REG0 &&
