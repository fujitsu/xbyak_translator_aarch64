...
void Xbyak::CodeGenerator::translateVFMADD213PS(xed_decoded_inst_t *p) {
  ...
  if (false ||
      ...
      (a64_opt.operands[2].opName == XED_OPERAND_REG2 &&
       ...
       a64_opt.predType == A64_PRED_ZERO && a64_opt.EVEXb == 0 &&
       isAvailAll1Preg0_7() == true && true)) {
    xa_->fmad(xa::ZRegS(dstIdx), P_ALL_ONE_0_7 / xa::T_m, xa::ZRegS(srcIdx),
              xa::ZRegS(src2Idx));
  }
  /* Col=BG119*/
  if (false ||
  ...
  if (false ||
      ...
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
       ...
       a64.operands[0].opWidth == 512 && a64.predType == A64_PRED_MERG &&
       a64.EVEXb == 0 && true)) {
    xa_->fmad(xa::ZRegS(dstIdx), xa::PReg(pTmpIdx) / xa::T_m, xa::ZRegS(srcIdx),
              xa::ZRegS(src2Idx));
  }
  /* Col=AY119*/
  if (false ||
