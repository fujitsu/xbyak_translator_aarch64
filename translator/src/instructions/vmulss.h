...
void Xbyak::CodeGenerator::translateVMULSS(xed_decoded_inst_t *p) {
  ...
  if (false ||
      ...
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
       a64.operands[3].opName == XED_OPERAND_MEM0 &&
       a64.predType == A64_PRED_NO && true)) {
    xa_->mov(xa::ZRegD(zTmp2Idx), xa::ZRegD(srcIdx));
  }
  /* Col=AM119*/
  if (false ||
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
  ...
  if (false ||
      ...
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
       a64.operands[3].opName == XED_OPERAND_MEM0 &&
       a64.predType == A64_PRED_NO && true)) {
    xa_->fmul(xa::ZRegS(zTmp2Idx), xa::PReg(pTmpIdx), xa::ZRegS(src2Idx));
  }
  /* Col=AU119*/
  if (false ||
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
      ...
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
       a64.operands[3].opName == XED_OPERAND_MEM0 &&
       a64.predType == A64_PRED_NO && true)) {
    xa_->mov(xa::ZRegD(dstIdx), xa::ZRegD(zTmp2Idx));
  }
  /* Col=AV119*/
  if (false ||
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
