 ...
 *******************************************************************************/
void Xbyak::CodeGenerator::translateVADDSS(xed_decoded_inst_t *p) {
  ...
  if (false ||
      ...
      (a64.dstWidth == 128 && a64.PredType == A64_PRED_NO && a64.EVEXb == 0 &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_REG &&
       a64.src2Type == A64_OP_REG && true)) {
    xa_->mov(xa::ZReg(a64.zTmpIdx).d, xa::ZReg(a64.srcIdx).d);
  }
  /* Col=X103*/
  if (false ||
      (a64.dstWidth == 128 && a64.PredType == A64_PRED_NO && a64.EVEXb == 0 &&
      ...
      (a64.dstWidth == 128 && a64.PredType == A64_PRED_MERG && a64.EVEXb == 0 &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_REG &&
       a64.src2Type == A64_OP_MEM && true)) {
    xa_->mov(xa::ZReg(a64.dstIdx).d, xa::ZReg(a64.srcIdx).d);
  }
  /* Col=Y103*/
  if (false ||
      (a64.dstWidth == 128 && a64.PredType == A64_PRED_NO && a64.EVEXb == 0 &&
  ...
  if (false ||
      ...
      (a64.dstWidth == 128 && a64.PredType == A64_PRED_NO && a64.EVEXb == 0 &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_REG &&
       a64.src2Type == A64_OP_REG && true)) {
    xa_->fadd(xa::ZReg(a64.zTmpIdx).s, xa::PReg(a64.pTmpIdx).s,
              xa::ZReg(a64.src2Idx).s);
  }
  /* Col=AD103*/
  if (false ||
  ...
  if (false ||
      ...
      (a64.dstWidth == 128 && a64.PredType == A64_PRED_ZERO && a64.EVEXb == 0 &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_REG &&
       a64.src2Type == A64_OP_MEM && true)) {
    xa_->mov(xa::ZRegS(a64.zTmpIdx), xa::PReg(a64.pTmpIdx) / xa::T_m, 0);
  }
  /* Col=AG103*/
  if (false ||
      (a64.dstWidth == 128 && a64.PredType == A64_PRED_NO && a64.EVEXb == 0 &&
  ...
  if (false ||
      ...
      (a64.dstWidth == 128 && a64.PredType == A64_PRED_MERG && a64.EVEXb == 0 &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_REG &&
       a64.src2Type == A64_OP_MEM && true)) {
    xa_->mov(xa::ZRegS(a64.zTmpIdx), xa::PReg(a64.pTmpIdx) / xa::T_m,
             xa::ZRegS(a64.dstIdx));
  }
  /* Col=AI103*/
  if (false ||
