...
void Xbyak::CodeGenerator::translateVUNPCKHPS(xed_decoded_inst_t *p) {
  ...
  if (false ||
      ...
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
       ...
       a64.operands[0].opWidth == 128 && a64.predType == A64_PRED_NO &&
       a64.EVEXb == 0 && true)) {
    xa_->ldr(xa::QReg(zTmp2Idx), xa::ptr(X_TMP_ADDR));
  }
  /* Col=AT119*/
  if (false ||
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
      ...
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
       ...
       a64.operands[0].opWidth == 128 && a64.predType == A64_PRED_NO &&
       a64.EVEXb == 0 && true)) {
    xa_->trn2(xa::VReg4S(zTmpIdx), xa::VReg4S(srcIdx), xa::VReg4S(src2Idx));
  }
  /* Col=AU119*/
  if (false ||
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
      ...
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
       ...
       a64.operands[0].opWidth == 128 && a64.predType == A64_PRED_NO &&
       a64.EVEXb == 0 && true)) {
    xa_->trn1(xa::VReg4S(zTmp2Idx), xa::VReg4S(srcIdx), xa::VReg4S(src2Idx));
  }
  /* Col=AV119*/
  if (false ||
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
      ...
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
       ...
       a64.operands[0].opWidth == 512 && a64.predType == A64_PRED_NO &&
       a64.EVEXb == 0 && true)) {
    xa_->trn2(xa::ZRegS(zTmpIdx), xa::ZRegS(srcIdx), xa::ZRegS(src2Idx));
  }
  /* Col=AW119*/
  if (false ||
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
      ...
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
       ...
       a64.operands[0].opWidth == 512 && a64.predType == A64_PRED_NO &&
       a64.EVEXb == 0 && true)) {
    xa_->trn1(xa::ZRegS(zTmp2Idx), xa::ZRegS(srcIdx), xa::ZRegS(src2Idx));
  }
  ...
  if (false ||
      ...
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
       ...
       a64.operands[0].opWidth == 128 && a64.predType == A64_PRED_NO &&
       a64.EVEXb == 0 && true)) {
    xa_->trn2(xa::VReg2D(dstIdx), xa::VReg2D(zTmp2Idx), xa::VReg2D(zTmpIdx));
  }
  /* Col=BB119*/
  if (false ||
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
      ...
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
       ...
       a64.operands[0].opWidth == 512 && a64.predType == A64_PRED_NO &&
       a64.EVEXb == 0 && true)) {
    xa_->trn2(xa::ZRegD(dstIdx), xa::ZRegD(zTmp2Idx), xa::ZRegD(zTmpIdx));
  }
