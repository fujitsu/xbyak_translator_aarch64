 ...
 *******************************************************************************/
void Xbyak::CodeGenerator::translateVPMAXSD(xed_decoded_inst_t *p) {
  ...
  if (false ||
      ...
      (a64.operands[0].opName == XED_OPERAND_REG0 &&
       ...
       a64.operands[0].opWidth == 512 && a64.predType == A64_PRED_MERG &&
       a64.EVEXb == 1 && true)) {
    xa_->cmple(P_TMP_0.s, xa::PReg(pTmpIdx) / xa::T_z, xa::ZReg(srcIdx).s,
               xa::ZReg(src2Idx).s);
  }
  /* Col=AO119*/
  if (false ||
      ...
      (a64.operands[0].opName == XED_OPERAND_REG0 &&
       ...
       a64.operands[3].opName == XED_OPERAND_REG3 &&
       a64.operands[0].opWidth == 512 && a64.predType == A64_PRED_NO && true)) {
    xa_->cmpgt(P_TMP_1.s, xa::PReg(pTmpIdx) / xa::T_z, xa::ZReg(srcIdx).s,
               xa::ZReg(src2Idx).s);
  }
  /* Col=AP119*/
  if (false ||
  ...
  if (false ||
      ...
      (a64.operands[0].opName == XED_OPERAND_REG0 &&
       ...
       a64.operands[0].opWidth == 512 && a64.predType == A64_PRED_MERG &&
       a64.EVEXb == 1 && true)) {
    xa_->mov(xa::ZReg(dstIdx).s, xa::PReg(pTmpIdx) / xa::T_m,
             xa::ZReg(src2Idx).s);
  }
  /* Col=AT119*/
  if (false ||
  ...
  if (false ||
      ...
      (a64.operands[0].opName == XED_OPERAND_REG0 &&
       ...
       a64.operands[0].opWidth == 512 && a64.predType == A64_PRED_ZERO &&
       a64.EVEXb == 1 && true)) {
    xa_->mov(xa::ZReg(dstIdx).s, P_TMP_0 / xa::T_m, xa::ZReg(src2Idx).s);
  }
  ...
  if (false ||
      ...
      (a64.operands[0].opName == XED_OPERAND_REG0 &&
       ...
       a64.operands[3].opName == XED_OPERAND_REG3 &&
       a64.operands[0].opWidth == 512 && a64.predType == A64_PRED_NO && true)) {
    xa_->mov(xa::ZReg(dstIdx).s, P_TMP_1 / xa::T_m, xa::ZReg(srcIdx).s);
  }
  /* Col=AZ119*/
  if (false ||
      (a64.operands[0].opName == XED_OPERAND_REG0 &&
  ...
  if (false ||
      ...
      (a64.operands[0].opName == XED_OPERAND_REG0 &&
       ...
       a64.operands[0].opWidth == 512 && a64.predType == A64_PRED_MERG &&
       true)) {
    xa_->mov(xa::ZReg(zTmpIdx).s, xa::PReg(pTmpIdx) / xa::T_m,
             xa::ZReg(srcIdx).s);
  }
  /* Col=BB119*/
  if (false ||
