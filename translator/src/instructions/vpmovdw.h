...
void Xbyak::CodeGenerator::translateVPMOVDW(xed_decoded_inst_t *p) {
  ...
  if (false ||
      (a64.operands[0].opName == XED_OPERAND_MEM0 &&
       ...
       a64.operands[2].regClass == XED_REG_CLASS_ZMM &&
       a64.operands[0].opWidth == 256 && a64.predType == A64_PRED_NO && true)) {
    xa_->ptrue(xa::PReg(pTmpIdx).b, xa::VL64);
  }
  /* Col=AF119*/
  if (false ||
      (a64.operands[0].opName == XED_OPERAND_MEM0 &&
       ...
       a64.operands[2].regClass == XED_REG_CLASS_YMM &&
       a64.operands[0].opWidth == 128 && a64.predType == A64_PRED_NO && true)) {
    xa_->ptrue(xa::PReg(pTmpIdx).b, xa::VL32);
  }
  /* Col=AG119*/
  if (false ||
      (a64.operands[0].opName == XED_OPERAND_MEM0 &&
       ...
       a64.operands[2].regClass == XED_REG_CLASS_XMM &&
       a64.operands[0].opWidth == 64 && a64.predType == A64_PRED_NO && true)) {
    xa_->ptrue(xa::PReg(pTmpIdx).b, xa::VL16);
  }
  /* Col=AH119*/
  if (false ||
      (a64.operands[0].opName == XED_OPERAND_REG0 &&
  ...
  if (false ||
      ...
      (a64.operands[0].opName == XED_OPERAND_REG0 &&
       ...
       a64.operands[0].opWidth == 256 && a64.predType == A64_PRED_MERG &&
       true)) {
    xa_->uzp1(P_TMP_0.b, xa::PReg(maskIdx).b, P_ALL_ZERO.b);
  }
  /* Col=AO119*/
  if (false ||
      (a64.operands[0].opName == XED_OPERAND_REG0 &&
  ...
  if (false ||
      ...
      (a64.operands[0].opName == XED_OPERAND_REG0 &&
       ...
       a64.operands[0].opWidth == 256 && a64.predType == A64_PRED_ZERO &&
       true)) {
    xa_->uzp1(xa::ZRegH(dstIdx), xa::ZRegH(zTmpIdx), xa::ZRegH(dstIdx));
  }
  /* Col=AU119*/
  if (false ||
      (a64.operands[0].opName == XED_OPERAND_REG0 &&
  ...
  if (false ||
      ...
      (a64.operands[0].opName == XED_OPERAND_REG0 &&
       ...
       a64.operands[0].opWidth == 256 && a64.predType == A64_PRED_MERG &&
       true)) {
    xa_->uzp1(xa::ZRegH(zTmpIdx), xa::ZRegH(zTmpIdx), xa::ZRegH(zTmpIdx));
  }
  /* Col=AW119*/
  if (false ||
      (a64.operands[0].opName == XED_OPERAND_REG0 &&
  ...
  if (false ||
      ...
      (a64.operands[0].opName == XED_OPERAND_REG0 &&
       ...
       a64.operands[0].opWidth == 128 && a64.predType == A64_PRED_MERG &&
       true)) {
    xa_->mov(xa::ZRegS(dstIdx), P_TMP_1 / xa::T_m, 0);
  }
  /* Col=BA119*/
  if (false ||
      (a64.operands[0].opName == XED_OPERAND_REG0 &&
  ...
  if (false ||
      ...
      (a64.operands[0].opName == XED_OPERAND_MEM0 &&
       ...
       a64.operands[2].regClass == XED_REG_CLASS_ZMM &&
       a64.operands[0].opWidth == 256 && a64.predType == A64_PRED_NO && true)) {
    xa_->st1h(xa::ZReg(srcIdx).s, xa::PReg(pTmpIdx), xa::ptr(X_TMP_ADDR));
  }
  /* Col=BF119*/
  if (false || (a64.operands[0].opName == XED_OPERAND_MEM0 &&
                a64.operands[1].opName == XED_OPERAND_REG0 &&
                ...
                a64.predType == A64_PRED_MERG && true)) {
    xa_->st1h(xa::ZReg(srcIdx).s, xa::PReg(maskIdx), xa::ptr(X_TMP_ADDR));
  }
  /* Col=BH119*/
  if (false ||
      (a64.operands[0].opName == XED_OPERAND_REG0 &&
