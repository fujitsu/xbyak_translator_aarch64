 ...
 *******************************************************************************/
void Xbyak::CodeGenerator::translateSHUFPS(xed_decoded_inst_t *p) {
  ...
  if (false || (a64.dstWidth == 128 && a64.PredType == A64_PRED_NO &&
                a64.EVEXb == 0 && a64.srcType == A64_OP_REG && true)) {
    xa_->mov(xa::ZReg(a64.zTmpIdx).s, P_ALL_ONE, xa::ZReg(a64.dstIdx).s);
    if ((a64.uimm & 0x3) == 1) {
  ...
  if (false || (a64.dstWidth == 128 && a64.PredType == A64_PRED_NO &&
    ...
    if (((a64.uimm & 0xc) / 4) == 0) {
      xa_->ext(xa::ZRegB(a64.zTmpIdx), xa::ZRegB(a64.zTmpIdx), 4);
      xa_->ext(xa::ZRegB(a64.zTmpIdx), xa::ZRegB(a64.dstIdx), 60);
    }
    if (((a64.uimm & 0xc) / 4) == 1) {
      xa_->not_(P_TMP_0.b, P_ALL_ONE, P_ALL_ONE.b);
      xa_->zip1(P_TMP_0.s, P_TMP_0.s, P_ALL_ONE.s);
      xa_->mov(xa::ZReg(a64.zTmpIdx).s, P_TMP_0, xa::ZReg(a64.dstIdx).s);
    }
    if (((a64.uimm & 0xc) / 4) == 2) {
      xa_->not_(P_TMP_0.b, P_ALL_ONE, P_ALL_ONE.b);
      xa_->zip1(P_TMP_0.s, P_TMP_0.s, P_ALL_ONE.s);
  ...
  if (false || (a64.dstWidth == 128 && a64.PredType == A64_PRED_NO &&
    ...
    if (((a64.uimm & 0x30) / 16) == 0) {
      xa_->ext(xa::ZRegB(a64.zTmpIdx), xa::ZRegB(a64.zTmpIdx), 8);
      xa_->ext(xa::ZRegB(a64.zTmpIdx), xa::ZRegB(a64.srcIdx), 56);
    }
  ...
  if (false || (a64.dstWidth == 128 && a64.PredType == A64_PRED_NO &&
    ...
    if (((a64.uimm & 0xc0) / 64) == 0) {
      xa_->ext(xa::ZRegB(a64.zTmpIdx), xa::ZRegB(a64.zTmpIdx), 12);
      xa_->ext(xa::ZRegB(a64.zTmpIdx), xa::ZRegB(a64.srcIdx), 52);
    }
