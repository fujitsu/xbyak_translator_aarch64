...
void Xbyak::CodeGenerator::translateVFMADD231SS(xed_decoded_inst_t *p) {
  ...
  if (false ||
      ...
      (a64_opt.operands[2].opName == XED_OPERAND_REG2 &&
       ...
       a64_opt.predType == A64_PRED_ZERO && a64_opt.EVEXb == 0 &&
       isAvailAll1Preg0_7() == true && true)) {
    orn(P_TMP_0.b, P_ALL_ONE / xa::T_z, P_MSB_256.b, P_TMP_0.b);
  }
  /* Col=AR119*/
  if (false ||
      (a64_opt.operands[2].opName == XED_OPERAND_REG2 &&
  ...
  if (false ||
      (a64_opt.operands[2].opName == XED_OPERAND_REG2 &&
       ...
       a64_opt.operands[0].opWidth == 512 && a64_opt.predType == A64_PRED_NO &&
       a64_opt.EVEXb == 1 && isAvailAll1Preg0_7() == true && true)) {
    ld1rw(xa::ZReg(zTmpIdx).s, P_ALL_ONE_0_7 / xa::T_z, xa::ptr(X_TMP_ADDR));
  }
  /* Col=BL119*/
  if (false ||
      (a64_opt.operands[2].opName == XED_OPERAND_REG2 &&
      ...
      (a64_opt.operands[2].opName == XED_OPERAND_REG2 &&
       ...
       a64_opt.predType == A64_PRED_ZERO && a64_opt.EVEXb == 0 &&
       isAvailAll1Preg0_7() == true && true)) {
    xa_->fmla(xa::ZRegS(dstIdx), P_ALL_ONE_0_7 / xa::T_m, xa::ZRegS(srcIdx),
              xa::ZRegS(src2Idx));
  }
  /* Col=BM119*/
  if (false ||
  ...
  if (false ||
      ...
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
       ...
       a64.operands[0].opWidth == 128 && a64.predType == A64_PRED_NO &&
       a64.EVEXb == 0 && true)) {
    xa_->ptrue(xa::PRegS(pTmpIdx), xa::VL1);
  }
  /* Col=AE119*/
  if (false ||
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
  ...
  if (false ||
      ...
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
       ...
       a64.operands[0].opWidth == 128 && a64.predType == A64_PRED_ZERO &&
       a64.EVEXb == 0 && true)) {
    orn(P_TMP_0.b, P_ALL_ONE / xa::T_z, P_MSB_384.b, P_TMP_0.b);
  }
  /* Col=AJ119*/
  if (false ||
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
  ...
  if (false || (a64.operands[2].opName == XED_OPERAND_REG2 &&
                ...
                a64.operands[0].opWidth == 512 && a64.predType == A64_PRED_NO &&
                a64.EVEXb == 1 && true)) {
    ld1rw(xa::ZReg(zTmpIdx).s, xa::PReg(pTmpIdx) / xa::T_z,
          xa::ptr(X_TMP_ADDR));
  }
  /* Col=BB119*/
  if (false || (a64.operands[2].opName == XED_OPERAND_REG2 &&
    ...
    xa_->fmla(xa::VReg4S(dstIdx), xa::VReg4S(srcIdx), xa::VReg4S(src2Idx));
  }
  /* Col=BC119*/
  if (false ||
      (a64.operands[2].opName == XED_OPERAND_MEM0 &&
      ...
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
       ...
       a64.operands[0].opWidth == 128 && a64.predType == A64_PRED_ZERO &&
       a64.EVEXb == 0 && true)) {
    xa_->fmla(xa::VReg4S(dstIdx), xa::VReg4S(srcIdx), xa::VReg4S(zTmpIdx));
  }
  /* Col=BD119*/
  if (false ||
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
      ...
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
       ...
       a64.operands[0].opWidth == 512 && a64.predType == A64_PRED_MERG &&
       a64.EVEXb == 0 && true)) {
    xa_->fmla(xa::ZRegS(dstIdx), xa::PReg(pTmpIdx) / xa::T_m, xa::ZRegS(srcIdx),
              xa::ZRegS(src2Idx));
  }
  /* Col=BE119*/
  if (false ||
