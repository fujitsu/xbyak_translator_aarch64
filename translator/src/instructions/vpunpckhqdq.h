...
void Xbyak::CodeGenerator::translateVPUNPCKHQDQ(xed_decoded_inst_t *p) {
  ...
  if (false ||
      ...
      (a64.operands[0].opName == XED_OPERAND_REG0 &&
       ...
       a64.operands[0].opWidth == 512 && a64.predType == A64_PRED_MERG &&
       a64.EVEXb == 1 && true)) {
    xa_->dup(xa::ZRegD(zTmp4Idx), xa::ZReg(zTmp4Idx).d[0]);
  }
  /* Col=AI119*/
  if (false || (a64.operands[0].opName == XED_OPERAND_REG0 &&
                ...
                a64.operands[3].opName == XED_OPERAND_INVALID &&
                a64.operands[0].opWidth == 128 && true)) {
    xa_->mov(xa::VReg(zTmpIdx).d[0], xa::VReg(srcIdx).d[1]);
  }
  /* Col=AJ119*/
  if (false || (a64.operands[0].opName == XED_OPERAND_REG0 &&
                a64.operands[1].opName == XED_OPERAND_REG1 &&
                ...
                a64.operands[3].opName == XED_OPERAND_INVALID &&
                a64.operands[0].opWidth == 128 && true)) {
    xa_->mov(xa::VReg(zTmp2Idx).d[0], xa::VReg(srcIdx).d[1]);
  }
  /* Col=AK119*/
  if (false || (a64.operands[0].opName == XED_OPERAND_REG0 &&
                a64.operands[1].opName == XED_OPERAND_REG1 &&
                ...
                a64.operands[3].opName == XED_OPERAND_INVALID &&
                a64.operands[0].opWidth == 128 && true)) {
    xa_->mov(xa::VReg(zTmpIdx).d[1], xa::VReg(src2Idx).d[1]);
  }
  /* Col=AL119*/
  if (false || (a64.operands[0].opName == XED_OPERAND_REG0 &&
                a64.operands[1].opName == XED_OPERAND_REG1 &&
                ...
                a64.operands[3].opName == XED_OPERAND_INVALID &&
                a64.operands[0].opWidth == 128 && true)) {
    xa_->mov(xa::VReg(zTmp2Idx).d[1], xa::VReg(zTmpIdx).d[1]);
  }
  ...
  if (false || (a64.operands[0].opName == XED_OPERAND_REG0 &&
                ...
                a64.operands[3].opName == XED_OPERAND_INVALID &&
                a64.operands[0].opWidth == 128 && true)) {
    xa_->mov(xa::ZRegD(dstIdx), P_TMP_0 / xa::T_m, xa::ZRegD(zTmpIdx));
  }
  /* Col=AO119*/
  if (false || (a64.operands[0].opName == XED_OPERAND_REG0 &&
                a64.operands[1].opName == XED_OPERAND_REG1 &&
                ...
                a64.operands[3].opName == XED_OPERAND_INVALID &&
                a64.operands[0].opWidth == 128 && true)) {
    xa_->mov(xa::ZRegD(dstIdx), P_TMP_0 / xa::T_m, xa::ZRegD(zTmp2Idx));
  }
  /* Col=AP119*/
  if (false ||
      (a64.operands[0].opName == XED_OPERAND_REG0 &&
      ...
      (a64.operands[0].opName == XED_OPERAND_REG0 &&
       ...
       a64.operands[0].opWidth == 512 && a64.predType == A64_PRED_MERG &&
       a64.EVEXb == 1 && true)) {
    xa_->index(xa::ZRegD(zTmpIdx), 0, 1);
  }
  /* Col=AQ119*/
  if (false ||
      (a64.operands[0].opName == XED_OPERAND_REG0 &&
