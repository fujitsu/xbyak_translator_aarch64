...
void Xbyak::CodeGenerator::translateVPUNPCKLDQ(xed_decoded_inst_t *p) {
  ...
  if (false || (a64.operands[0].opName == XED_OPERAND_REG0 &&
                ...
                a64.operands[0].opWidth == 128 && true)) {
    for (int i = 0; i < 2; i++) {
      xa_->mov(xa::VReg(zTmpIdx).s[2 * i], xa::VReg(srcIdx).s[i]);
    }
  }
  /* Col=AI119*/
  if (false || (a64.operands[0].opName == XED_OPERAND_REG0 &&
                ...
                a64.operands[0].opWidth == 128 && true)) {
    for (int i = 0; i < 2; i++) {
      xa_->mov(xa::VReg(zTmp2Idx).s[2 * i], xa::VReg(srcIdx).s[i]);
    }
  }
  /* Col=AJ119*/
  if (false || (a64.operands[0].opName == XED_OPERAND_REG0 &&
                ...
                a64.operands[0].opWidth == 128 && true)) {
    for (int i = 0; i < 2; i++) {
      xa_->mov(xa::VReg(zTmpIdx).s[2 * i + 1], xa::VReg(src2Idx).s[i]);
    }
  }
  /* Col=AK119*/
  if (false || (a64.operands[0].opName == XED_OPERAND_REG0 &&
                ...
                a64.operands[0].opWidth == 128 && true)) {
    for (int i = 0; i < 2; i++) {
      xa_->mov(xa::VReg(zTmp2Idx).s[2 * i + 1], xa::VReg(zTmpIdx).s[i]);
    }
  }
  /* Col=AL119*/
  if (false ||
  ...
  if (false || (a64.operands[0].opName == XED_OPERAND_REG0 &&
                ...
                a64.operands[3].opName == XED_OPERAND_INVALID &&
                a64.operands[0].opWidth == 128 && true)) {
    xa_->mov(xa::ZRegS(dstIdx), P_TMP_0 / xa::T_m, xa::ZRegS(zTmp2Idx));
  }
  /* Col=AO119*/
  if (false ||
      (a64.operands[0].opName == XED_OPERAND_REG0 &&
