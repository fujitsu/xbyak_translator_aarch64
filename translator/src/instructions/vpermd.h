...
void Xbyak::CodeGenerator::translateVPERMD(xed_decoded_inst_t *p) {
  ...
  if (false || (a64.operands[2].opName == XED_OPERAND_REG2 &&
    ...
    xa_->orn(P_TMP_0.b, P_ALL_ONE, P_MSB_256.b, xa::PRegB(maskIdx));
  }
  /* Col=AV103*/
  if (false || (a64.operands[2].opName == XED_OPERAND_REG2 &&
                a64.operands[3].opName == XED_OPERAND_MEM0 &&
                ...
                a64.predType == A64_PRED_ZERO && a64.EVEXb == 1 && true)) {
    xa_->not_(P_TMP_0.b, P_ALL_ONE / xa::T_z, xa::PReg(maskIdx).b);
  }
  /* Col=AW103*/
  if (false ||
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
