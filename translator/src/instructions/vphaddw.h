 ...
 *******************************************************************************/
void Xbyak::CodeGenerator::translateVPHADDW(xed_decoded_inst_t *p) {
  ...
  if (false ||
      ...
      (a64.dstWidth == 256 && a64.PredType == A64_PRED_NO && a64.EVEXb == 0 &&
       a64.srcType == A64_OP_REG && true)) {
    xa_->mov(xa::PRegB(a64.pTmpIdx), P_ALL_ONE, P_ALL_ONE.b);
  }
  /* Col=AB143*/
  if (false ||
      (a64.dstWidth == 128 && a64.PredType == A64_PRED_NO && a64.EVEXb == 0 &&
      ...
      (a64.dstWidth == 256 && a64.PredType == A64_PRED_NO && a64.EVEXb == 0 &&
       a64.srcType == A64_OP_REG && true)) {
    xa_->ext(xa::ZRegB(a64.zTmpIdx), xa::ZRegB(a64.zTmpIdx), 2);
  }
  ...
  if (false ||
      ...
      (a64.dstWidth == 256 && a64.PredType == A64_PRED_NO && a64.EVEXb == 0 &&
       a64.srcType == A64_OP_REG && true)) {
    xa_->add(xa::ZRegH(a64.zTmpIdx), xa::PReg(a64.pTmpIdx),
             xa::ZRegH(a64.srcIdx));
  }
  /* Col=AE143*/
  if (false ||
      ...
      (a64.dstWidth == 256 && a64.PredType == A64_PRED_NO && a64.EVEXb == 0 &&
       a64.srcType == A64_OP_REG && true)) {
    xa_->mov(xa::ZReg(zTmp2Idx).s, P_ALL_ONE, xa::ZReg(a64.src2Idx).s);
  }
  /* Col=AF143*/
  if (false ||
      (a64.dstWidth == 128 && a64.PredType == A64_PRED_NO && a64.EVEXb == 0 &&
      ...
      (a64.dstWidth == 256 && a64.PredType == A64_PRED_NO && a64.EVEXb == 0 &&
       a64.srcType == A64_OP_REG && true)) {
    xa_->ext(xa::ZRegB(zTmp2Idx), xa::ZRegB(zTmp2Idx), 2);
  }
  /* Col=AG143*/
  if (false ||
      (a64.dstWidth == 128 && a64.PredType == A64_PRED_NO && a64.EVEXb == 0 &&
      ...
      (a64.dstWidth == 256 && a64.PredType == A64_PRED_NO && a64.EVEXb == 0 &&
       a64.srcType == A64_OP_REG && true)) {
    xa_->add(xa::ZRegH(zTmp2Idx), xa::PReg(a64.pTmpIdx),
  ...
  if (false ||
      ...
      (a64.dstWidth == 256 && a64.PredType == A64_PRED_NO && a64.EVEXb == 0 &&
       a64.srcType == A64_OP_REG && true)) {
    xa_->uzp1(xa::ZRegH(a64.zTmpIdx), xa::ZRegH(a64.zTmpIdx),
  ...
  if (false ||
      ...
      (a64.dstWidth == 256 && a64.PredType == A64_PRED_NO && a64.EVEXb == 0 &&
       a64.srcType == A64_OP_REG && true)) {
    xa_->uzp1(xa::ZRegH(zTmp2Idx), xa::ZRegH(zTmp2Idx), xa::ZRegH(zTmp2Idx));
  }
  /* Col=AN143*/
  if (false ||
      (a64.dstWidth == 128 && a64.PredType == A64_PRED_NO && a64.EVEXb == 0 &&
      ...
      (a64.dstWidth == 256 && a64.PredType == A64_PRED_NO && a64.EVEXb == 0 &&
       a64.srcType == A64_OP_REG && true)) {
    xa_->zip1(xa::ZRegD(a64.dstIdx), xa::ZRegD(a64.zTmpIdx),
              xa::ZRegD(zTmp2Idx));
  }
  /* Col=AR143*/
