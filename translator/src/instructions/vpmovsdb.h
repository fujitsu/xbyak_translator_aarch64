...
void Xbyak::CodeGenerator::translateVPMOVSDB(xed_decoded_inst_t *p) {
  ...
  if (false ||
      ...
      (a64.operands[0].opName == XED_OPERAND_REG0 &&
       ...
       a64.operands[0].opWidth == 128 && a64.predType == A64_PRED_ZERO &&
       true)) {
    xa_->mov(xa::ZRegS(zTmpIdx), P_TMP_0 / xa::T_m, 0);
  }
  /* Col=AM119*/
  if (false ||
      (a64.operands[0].opName == XED_OPERAND_REG0 &&
  ...
  if (false ||
      ...
      (a64.operands[0].opName == XED_OPERAND_REG0 &&
       ...
       a64.operands[0].opWidth == 128 && a64.predType == A64_PRED_MERG &&
       true)) {
    xa_->uzp1(P_TMP_0.h, xa::PRegH(maskIdx), xa::PRegH(maskIdx));
  }
  /* Col=AV119*/
  if (false ||
      (a64.operands[0].opName == XED_OPERAND_REG0 &&
      ...
      (a64.operands[0].opName == XED_OPERAND_REG0 &&
       ...
       a64.operands[0].opWidth == 128 && a64.predType == A64_PRED_MERG &&
       true)) {
    xa_->uzp1(P_TMP_0.b, P_TMP_0.b, P_TMP_0.b);
  }
  /* Col=AW119*/
  if (false ||
      (a64.operands[0].opName == XED_OPERAND_REG0 &&
