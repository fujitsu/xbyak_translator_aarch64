 ...
 *******************************************************************************/
void Xbyak::CodeGenerator::translateVPMOVZXBD(xed_decoded_inst_t *p) {
  ...
  if (false ||
      ...
      (a64.dstWidth == 512 && a64.PredType == A64_PRED_ZERO && a64.EVEXb == 0 &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_MEM && true)) {
    xa_->uxtb(xa::ZReg(a64.dstIdx).s, xa::PReg(a64.pTmpIdx) / xa::T_m,
  ...
  if (false ||
      ...
      (a64.dstWidth == 512 && a64.PredType == A64_PRED_MERG && a64.EVEXb == 0 &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_MEM && true)) {
    xa_->uxtb(xa::ZReg(a64.dstIdx).s, xa::PReg(a64.maskIdx) / xa::T_m,
              xa::ZReg(a64.zTmpIdx).s);
  }
