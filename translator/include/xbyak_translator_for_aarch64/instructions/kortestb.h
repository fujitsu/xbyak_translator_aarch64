void translateKORTESTB(xed_decoded_inst_t *p) {
    ...
    Xbyak_aarch64::CodeGeneratorAArch64::AND_(
            ptmp1.b, condR/Xbyak::Xbyak_aarch64::T_z, src1.b, ptmp1.b); // get src1[7:0]
    Xbyak_aarch64::CodeGeneratorAArch64::AND_(
            ptmp2.b, condR/Xbyak::Xbyak_aarch64::T_z, src2.b, ptmp2.b); // get src2[7:0]
    ...
    ccmn(presult, comp, cflag, condEQ); // if presult == 0xFF(255) the  C flag = 1 (0x0 means EQ)
}
