...
void translateVPUNPCKLDQ(xed_decoded_inst_t *p) {
  ...
  if (false || (a64.operands[0].opName == XED_OPERAND_REG0 &&
                ...
                a64.operands[0].opWidth == 128 && true)) {
    for (int i = 0; i < 2; i++) {
      CG64::mov(xa::VReg(zTmpIdx).s[2 * i], xa::VReg(srcIdx).s[i]);
    }
  }
  /* Col=AI119*/
  if (false || (a64.operands[0].opName == XED_OPERAND_REG0 &&
                ...
                a64.operands[0].opWidth == 128 && true)) {
    for (int i = 0; i < 2; i++) {
      CG64::mov(xa::VReg(zTmp2Idx).s[2 * i], xa::VReg(srcIdx).s[i]);
    }
  }
  /* Col=AJ119*/
  if (false || (a64.operands[0].opName == XED_OPERAND_REG0 &&
                ...
                a64.operands[0].opWidth == 128 && true)) {
    for (int i = 0; i < 2; i++) {
      CG64::mov(xa::VReg(zTmpIdx).s[2 * i + 1], xa::VReg(src2Idx).s[i]);
    }
  }
  /* Col=AK119*/
  if (false || (a64.operands[0].opName == XED_OPERAND_REG0 &&
                ...
                a64.operands[0].opWidth == 128 && true)) {
    for (int i = 0; i < 2; i++) {
      CG64::mov(xa::VReg(zTmp2Idx).s[2 * i + 1], xa::VReg(zTmpIdx).s[i]);
    }
  }
  /* Col=AL119*/
  if (false ||
  ...
  if (false || (a64.operands[0].opName == XED_OPERAND_REG0 &&
                ...
                a64.operands[3].opName == XED_OPERAND_INVALID &&
                a64.operands[0].opWidth == 128 && true)) {
    CG64::mov(xa::ZRegS(dstIdx), P_TMP_0 / xa::T_m, xa::ZRegS(zTmp2Idx));
  }
  /* Col=AO119*/
  if (false ||
      (a64.operands[0].opName == XED_OPERAND_REG0 &&
  ...
  if (false ||
      ...
      (a64.operands[0].opName == XED_OPERAND_REG0 &&
       ...
       a64.operands[0].opWidth == 512 && a64.predType == A64_PRED_MERG &&
       true)) {
    int index[4] = {0, 4, 8, 12};
    for (int i = 0; i < 4; i++) {
      int idx = index[i];
      CG64::dup(xa::ZRegS(zTmp2Idx), xa::ZReg(srcIdx).s[idx]);
      CG64::cmphs(P_TMP_0.s, xa::PReg(pTmpIdx), xa::ZRegS(zTmpIdx),
                  uint32_t(i * 4));
      CG64::mov(xa::ZRegS(zTmp3Idx), P_TMP_0 / xa::T_m, xa::ZRegS(zTmp2Idx));
      CG64::dup(xa::ZRegS(zTmp2Idx), xa::ZReg(src2Idx).s[idx]);
      CG64::cmphs(P_TMP_0.s, xa::PReg(pTmpIdx), xa::ZRegS(zTmpIdx),
                  uint32_t(i * 4 + 1));
      CG64::mov(xa::ZRegS(zTmp3Idx), P_TMP_0 / xa::T_m, xa::ZRegS(zTmp2Idx));
      CG64::dup(xa::ZRegS(zTmp2Idx), xa::ZReg(srcIdx).s[idx + 1]);
      CG64::cmphs(P_TMP_0.s, xa::PReg(pTmpIdx), xa::ZRegS(zTmpIdx),
                  uint32_t(i * 4 + 2));
      CG64::mov(xa::ZRegS(zTmp3Idx), P_TMP_0 / xa::T_m, xa::ZRegS(zTmp2Idx));
      CG64::dup(xa::ZRegS(zTmp2Idx), xa::ZReg(src2Idx).s[idx + 1]);
      CG64::cmphs(P_TMP_0.s, xa::PReg(pTmpIdx), xa::ZRegS(zTmpIdx),
                  uint32_t(i * 4 + 3));
      CG64::mov(xa::ZRegS(zTmp3Idx), P_TMP_0 / xa::T_m, xa::ZRegS(zTmp2Idx));
    }
  ...
  if (false ||
    ...
    for (int i = 0; i < 4; i++) {
      ...
      CG64::cmphs(P_TMP_0.s, xa::PReg(pTmpIdx), xa::ZRegS(zTmpIdx),
                  uint32_t(i * 4));
      CG64::mov(xa::ZRegS(zTmp3Idx), P_TMP_0 / xa::T_m, xa::ZRegS(zTmp2Idx));
      CG64::dup(xa::ZRegS(zTmp2Idx), xa::ZReg(zTmp4Idx).s[idx]);
      CG64::cmphs(P_TMP_0.s, xa::PReg(pTmpIdx), xa::ZRegS(zTmpIdx),
                  uint32_t(i * 4 + 1));
      CG64::mov(xa::ZRegS(zTmp3Idx), P_TMP_0 / xa::T_m, xa::ZRegS(zTmp2Idx));
      CG64::dup(xa::ZRegS(zTmp2Idx), xa::ZReg(srcIdx).s[idx + 1]);
      CG64::cmphs(P_TMP_0.s, xa::PReg(pTmpIdx), xa::ZRegS(zTmpIdx),
                  uint32_t(i * 4 + 2));
      CG64::mov(xa::ZRegS(zTmp3Idx), P_TMP_0 / xa::T_m, xa::ZRegS(zTmp2Idx));
      CG64::dup(xa::ZRegS(zTmp2Idx), xa::ZReg(zTmp4Idx).s[idx + 1]);
      CG64::cmphs(P_TMP_0.s, xa::PReg(pTmpIdx), xa::ZRegS(zTmpIdx),
                  uint32_t(i * 4 + 3));
      CG64::mov(xa::ZRegS(zTmp3Idx), P_TMP_0 / xa::T_m, xa::ZRegS(zTmp2Idx));
    }
