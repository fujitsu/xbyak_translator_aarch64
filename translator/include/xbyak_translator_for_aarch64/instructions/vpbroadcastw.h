...
#define CG64 CodeGeneratorAArch64
  ...
  if (false || (a64.dstWidth == 128 && a64.PredType == A64_PRED_NO &&
      ...
      (a64.dstWidth == 128 && a64.PredType == A64_PRED_ZERO &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_MEM &&
       a64.srcRegClass == XED_REG_CLASS_INVALID && true)) {
    CG64::ld1r(xa::VReg8H(a64.dstIdx), xa::ptr(X_TMP_ADDR));
  }
  /* Col=AD103*/
  if (false || (a64.dstWidth == 256 && a64.PredType == A64_PRED_ZERO &&
                a64.dstType == A64_OP_REG && a64.srcType == A64_OP_MEM &&
      ...
      (a64.dstWidth == 512 && a64.PredType == A64_PRED_ZERO &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_MEM &&
       a64.srcRegClass == XED_REG_CLASS_INVALID && true)) {
    CG64::ld1rh(xa::ZRegH(a64.dstIdx), xa::PReg(a64.maskIdx) / xa::T_z,
                xa::ptr(X_TMP_ADDR));
  }
  /* Col=AE103*/
  if (false || (a64.dstWidth == 128 && a64.PredType == A64_PRED_MERG &&
      ...
      (a64.dstWidth == 512 && a64.PredType == A64_PRED_MERG &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_MEM &&
       a64.srcRegClass == XED_REG_CLASS_INVALID && true)) {
    CG64::ld1rh(xa::ZRegH(a64.zTmpIdx), xa::PReg(a64.maskIdx) / xa::T_z,
                xa::ptr(X_TMP_ADDR));
  }
  /* Col=AF103*/
  if (false || (a64.dstWidth == 128 && a64.PredType == A64_PRED_NO &&
                a64.dstType == A64_OP_REG && a64.srcType == A64_OP_REG &&
                a64.srcRegClass == XED_REG_CLASS_GPR && true)) {
    CG64::dup(xa::VReg8H(a64.dstIdx), xa::WReg(a64.srcIdx));
  }
  /* Col=AG103*/
  if (false || (a64.dstWidth == 128 && a64.PredType == A64_PRED_ZERO &&
                a64.dstType == A64_OP_REG && a64.srcType == A64_OP_REG &&
      ...
      (a64.dstWidth == 512 && a64.PredType == A64_PRED_ZERO &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_REG &&
       a64.srcRegClass == XED_REG_CLASS_GPR && true)) {
    CG64::dup(xa::ZRegH(a64.dstIdx), xa::WReg(a64.srcIdx));
  }
  ...
  if (false || (a64.dstWidth == 128 && a64.PredType == A64_PRED_MERG &&
      ...
      (a64.dstWidth == 512 && a64.PredType == A64_PRED_MERG &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_REG &&
       a64.srcRegClass == XED_REG_CLASS_GPR && true)) {
    CG64::dup(xa::ZRegH(a64.zTmpIdx), xa::WReg(a64.srcIdx));
  }
  /* Col=AJ103*/
  if (false || (a64.dstWidth == 128 && a64.PredType == A64_PRED_NO &&
                a64.dstType == A64_OP_REG && a64.srcType == A64_OP_REG &&
      ...
      (a64.dstWidth == 128 && a64.PredType == A64_PRED_ZERO &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_REG &&
       a64.srcRegClass == XED_REG_CLASS_XMM && true)) {
    CG64::dup(xa::VReg8H(a64.dstIdx), xa::VReg8H(a64.srcIdx)[a64.uimm]);
  }
  /* Col=AK103*/
  if (false || (a64.dstWidth == 256 && a64.PredType == A64_PRED_NO &&
                a64.dstType == A64_OP_REG && a64.srcType == A64_OP_REG &&
      ...
      (a64.dstWidth == 512 && a64.PredType == A64_PRED_ZERO &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_REG &&
       a64.srcRegClass == XED_REG_CLASS_XMM && true)) {
    CG64::dup(xa::ZRegH(a64.dstIdx), xa::ZRegH(a64.srcIdx)[a64.uimm]);
  }
  ...
  if (false || (a64.dstWidth == 128 && a64.PredType == A64_PRED_MERG &&
      ...
      (a64.dstWidth == 512 && a64.PredType == A64_PRED_MERG &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_REG &&
       a64.srcRegClass == XED_REG_CLASS_XMM && true)) {
    CG64::dup(xa::ZRegH(a64.zTmpIdx), xa::ZRegH(a64.srcIdx)[a64.uimm]);
  }
  /* Col=AN103*/
  if (false || (a64.dstWidth == 256 && a64.PredType == A64_PRED_NO &&
                a64.dstType == A64_OP_REG && a64.srcType == A64_OP_MEM &&
      ...
      (a64.dstWidth == 512 && a64.PredType == A64_PRED_NO &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_MEM &&
       a64.srcRegClass == XED_REG_CLASS_INVALID && true)) {
    CG64::dup(xa::ZRegH(a64.dstIdx), W_TMP_0);
  }
  ...
  if (false || (a64.dstWidth == 128 && a64.PredType == A64_PRED_ZERO &&
      ...
      (a64.dstWidth == 512 && a64.PredType == A64_PRED_ZERO &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_REG &&
       a64.srcRegClass == XED_REG_CLASS_XMM && true)) {
    CG64::mov(xa::ZRegH(a64.dstIdx), xa::PReg(a64.pTmpIdx) / xa::T_m, 0);
  }
  /* Col=AS103*/
  if (false || (a64.dstWidth == 128 && a64.PredType == A64_PRED_MERG &&
                a64.dstType == A64_OP_REG && a64.srcType == A64_OP_REG &&
      ...
      (a64.dstWidth == 512 && a64.PredType == A64_PRED_MERG &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_MEM &&
       a64.srcRegClass == XED_REG_CLASS_INVALID && true)) {
    CG64::mov(xa::ZRegH(a64.dstIdx), xa::PReg(a64.maskIdx) / xa::T_m,
  ...
  if (false || (a64.dstWidth == 256 && a64.PredType == A64_PRED_NO &&
      ...
      (a64.dstWidth == 256 && a64.PredType == A64_PRED_MERG &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_REG &&
       a64.srcRegClass == XED_REG_CLASS_XMM && true)) {
    CG64::mov(xa::ZRegH(a64.dstIdx), P_MSB_256 / xa::T_m, 0);
  }
