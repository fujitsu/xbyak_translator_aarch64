...
/* Col=AE119*/
if(false ||(a64_opt.operands[1].regClass==XED_REG_CLASS_XMM&&isAvailAll1Preg0_7()==true &&true)||(a64_opt.operands[1].regClass==XED_REG_CLASS_YMM&&isAvailAll1Preg0_7()==true &&true)) {
...
/* Col=AV119*/
if(false ||(a64_opt.operands[1].regClass==XED_REG_CLASS_XMM&&isAvailAll1Preg0_7()==true &&true)||(a64_opt.operands[1].regClass==XED_REG_CLASS_YMM&&isAvailAll1Preg0_7()==true &&true)) {
  CG64::cmplt(P_TMP_0.s, P_ALL_ONE_0_7/xa::T_z, xa::ZReg(srcIdx).s, xa::ZReg(zTmpIdx).s);
}
/* Col=AX119*/
if(false ||(a64_opt.operands[1].regClass==XED_REG_CLASS_XMM&&isAvailAll1Preg0_7()==true &&true)||(a64_opt.operands[1].regClass==XED_REG_CLASS_YMM&&isAvailAll1Preg0_7()==true &&true)) {
...
/* Col=BD119*/
if(false ||(a64_opt.operands[1].regClass==XED_REG_CLASS_XMM&&isAvailAll1Preg0_7()==true &&true)) {
  for(int i = 0; i < 4; i++){
...
/* Col=BE119*/
if(false ||(a64_opt.operands[1].regClass==XED_REG_CLASS_YMM&&isAvailAll1Preg0_7()==true &&true)) {
  for(int i = 0; i < 8; i++){
  CG64::and_(X_TMP_1, X_TMP_0, uint64_t(1)<<(4*i));
  CG64::lsr(X_TMP_1, X_TMP_1, 3*i);
  CG64::orr(xa::XReg(dstIdx), xa::XReg(dstIdx), X_TMP_1);
...
/* Col=U119*/
if(false ||(a64.operands[1].regClass==XED_REG_CLASS_XMM&&true)||(a64.operands[1].regClass==XED_REG_CLASS_YMM&&true)) {
...
/* Col=AN119*/
if(false ||(a64.operands[1].regClass==XED_REG_CLASS_XMM&&true)||(a64.operands[1].regClass==XED_REG_CLASS_YMM&&true)) {
  CG64::cmplt(P_TMP_0.s, xa::PReg(pTmpIdx)/xa::T_z, xa::ZReg(srcIdx).s, xa::ZReg(zTmpIdx).s);
}
/* Col=AP119*/
if(false ||(a64.operands[1].regClass==XED_REG_CLASS_XMM&&true)||(a64.operands[1].regClass==XED_REG_CLASS_YMM&&true)) {
  CG64::sub(X_TRANSLATOR_STACK, X_TRANSLATOR_STACK, 8); 
