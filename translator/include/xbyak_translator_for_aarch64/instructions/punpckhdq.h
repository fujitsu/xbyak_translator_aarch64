...
void translatePUNPCKHDQ(xed_decoded_inst_t *p) {
  ...
  if (false || (a64.operands[0].opName == XED_OPERAND_REG0 &&
                ...
                a64.operands[0].opWidth == 128 && true)) {
    for (int i = 0; i < 2; i++) {
      CG64::mov(xa::VReg(zTmpIdx).s[2 * i], xa::VReg(dstIdx).s[i + 2]);
    }
  }
  /* Col=AC119*/
  if (false || (a64.operands[0].opName == XED_OPERAND_REG0 &&
                ...
                a64.operands[0].opWidth == 128 && true)) {
    for (int i = 0; i < 2; i++) {
      CG64::mov(xa::VReg(zTmp2Idx).s[2 * i], xa::VReg(dstIdx).s[i + 2]);
    }
  }
  ...
  if (false || (a64.operands[0].opName == XED_OPERAND_REG0 &&
                ...
                a64.operands[0].opWidth == 128 && true)) {
    for (int i = 0; i < 2; i++) {
      CG64::mov(xa::VReg(zTmpIdx).s[2 * i + 1], xa::VReg(srcIdx).s[i + 2]);
    }
  }
  /* Col=AE119*/
  if (false || (a64.operands[0].opName == XED_OPERAND_REG0 &&
                ...
                a64.operands[0].opWidth == 128 && true)) {
    for (int i = 0; i < 2; i++) {
      CG64::mov(xa::VReg(zTmp2Idx).s[2 * i + 1], xa::VReg(zTmpIdx).s[i + 2]);
    }
  }
  /* Col=AF119*/
  if (false ||
