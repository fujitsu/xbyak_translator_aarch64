...
#define CG64 CodeGeneratorAArch64
  ...
  if (false ||
      (a64.dstWidth == 512 && a64.PredType == A64_PRED_ZERO &&
       a64.dstType == A64_OP_MEM && a64.srcType == A64_OP_REG && true)) {
    CG64::mov(xa::ZRegH(a64.zTmpIdx), xa::PReg(a64.maskIdx) / xa::T_m,
              xa::ZRegH(a64.srcIdx));
  }
  /* Col=AR103*/
  if (false ||
  ...
  if (false ||
      ...
      (a64.dstWidth == 256 && a64.PredType == A64_PRED_ZERO &&
       a64.dstType == A64_OP_MEM && a64.srcType == A64_OP_REG && true)) {
    CG64::mov(xa::ZRegH(a64.zTmpIdx), xa::PReg(a64.pTmpIdx) / xa::T_m,
              xa::ZRegH(a64.srcIdx));
  }
  /* Col=AV103*/
  if (false ||
  ...
  if (false ||
      ...
      (a64.dstWidth == 256 && a64.PredType == A64_PRED_ZERO &&
       a64.dstType == A64_OP_MEM && a64.srcType == A64_OP_REG && true)) {
    CG64::st1h(xa::ZRegH(a64.zTmpIdx), xa::PReg(a64.pTmpIdx),
               xa::ptr(X_TMP_ADDR));
  }
  /* Col=AZ103*/
  if (false ||
