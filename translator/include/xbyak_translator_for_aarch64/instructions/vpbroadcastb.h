void translateVPBROADCASTB(xed_decoded_inst_t *p) {
  ...
  if (false ||
      ...
      (a64.dstWidth == 512 && a64.PredType == A64_PRED_ZERO &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_MEM &&
       a64.srcRegClass == XED_REG_CLASS_INVALID && true)) {
    CodeGeneratorAArch64::ld1rb(xa::ZRegB(a64.dstIdx),
  ...
  if (false ||
      ...
      (a64.dstWidth == 512 && a64.PredType == A64_PRED_MERG &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_MEM &&
       a64.srcRegClass == XED_REG_CLASS_INVALID && true)) {
    CodeGeneratorAArch64::ld1rb(xa::ZRegB(a64.zTmpIdx),
                                xa::PReg(a64.maskIdx) / xa::T_z,
                                xa::ptr(X_TMP_ADDR));
  }
  /* Col=AF103*/
  ...
  if (false ||
      ...
      (a64.dstWidth == 128 && a64.PredType == A64_PRED_ZERO &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_REG &&
       a64.srcRegClass == XED_REG_CLASS_XMM && true)) {
    CodeGeneratorAArch64::dup(xa::VReg16B(a64.dstIdx),
                              xa::VReg16B(a64.srcIdx)[a64.uimm]);
  }
  /* Col=AK103*/
  if (false ||
      (a64.dstWidth == 256 && a64.PredType == A64_PRED_NO &&
      ...
      (a64.dstWidth == 512 && a64.PredType == A64_PRED_ZERO &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_REG &&
       a64.srcRegClass == XED_REG_CLASS_XMM && true)) {
    CodeGeneratorAArch64::dup(xa::ZRegB(a64.dstIdx),
                              xa::ZRegB(a64.srcIdx)[a64.uimm]);
  }
  ...
  if (false ||
      ...
      (a64.dstWidth == 512 && a64.PredType == A64_PRED_MERG &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_REG &&
       a64.srcRegClass == XED_REG_CLASS_XMM && true)) {
    CodeGeneratorAArch64::dup(xa::ZRegB(a64.zTmpIdx),
                              xa::ZRegB(a64.srcIdx)[a64.uimm]);
  }
  /* Col=AN103*/
  if (false ||
  ...
  if (false ||
      ...
      (a64.dstWidth == 512 && a64.PredType == A64_PRED_ZERO &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_REG &&
       a64.srcRegClass == XED_REG_CLASS_XMM && true)) {
    CodeGeneratorAArch64::mov(xa::ZRegB(a64.dstIdx),
