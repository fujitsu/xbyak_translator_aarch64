void translateXOR(xed_decoded_inst_t *p) {
  ...
  if (false || (a64.dstWidth == 32 && a64.dstType == A64_OP_REG &&
    ...
    CodeGeneratorAArch64::eor(Xbyak_aarch64::WReg(a64.dstIdx),
  ...
  if (false || (a64.dstWidth == 64 && a64.dstType == A64_OP_REG &&
    ...
    CodeGeneratorAArch64::eor(Xbyak_aarch64::XReg(a64.dstIdx),
  ...
  if (false || (a64.dstWidth == 32 && a64.dstType == A64_OP_MEM &&
    ...
    CodeGeneratorAArch64::eor(W_TMP_0, W_TMP_0,
                              static_cast<uint32_t>(a64.uimm));
  }
  /* Col=AC103*/
  ...
  if (false || (a64.dstWidth == 32 && a64.dstType == A64_OP_REG &&
                a64.srcType == A64_OP_REG && true)) {
    CodeGeneratorAArch64::eor(xa::WReg(a64.dstIdx), xa::WReg(a64.dstIdx),
                              xa::WReg(a64.srcIdx));
  }
  /* Col=AG103*/
  if (false || (a64.dstWidth == 64 && a64.dstType == A64_OP_REG &&
