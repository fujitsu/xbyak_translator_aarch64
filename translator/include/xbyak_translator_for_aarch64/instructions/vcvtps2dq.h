...
#define CG64 CodeGeneratorAArch64
  ...
  if (false ||
      ...
      (a64.dstWidth == 128 && a64.PredType == A64_PRED_NO && a64.EVEXb == 0 &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_MEM && true)) {
    CodeGeneratorAArch64::ld1(xa::VReg(vTmpIdx).s4, xa::ptr(X_TMP_ADDR));
  }
  /* Col=W103*/
  if (false ||
      (a64.dstWidth == 128 && a64.PredType == A64_PRED_NO && a64.EVEXb == 1 &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_MEM && true)) {
    CodeGeneratorAArch64::ld1r(xa::VReg(vTmpIdx).s4, xa::ptr(X_TMP_ADDR));
  }
  /* Col=X103*/
  if (false ||
      (a64.dstWidth == 256 && a64.PredType == A64_PRED_NO && a64.EVEXb == 0 &&
      ...
      (a64.dstWidth == 512 && a64.PredType == A64_PRED_MERG && a64.EVEXb == 0 &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_MEM && true)) {
    CodeGeneratorAArch64::ldr(xa::ZReg(zTmpIdx), xa::ptr(X_TMP_ADDR));
  }
  /* Col=Y103*/
  if (false ||
      (a64.dstWidth == 128 && a64.PredType == A64_PRED_ZERO && a64.EVEXb == 1 &&
      ...
      (a64.dstWidth == 512 && a64.PredType == A64_PRED_MERG && a64.EVEXb == 1 &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_MEM && true)) {
    CodeGeneratorAArch64::ld1rw(xa::ZReg(zTmpIdx).s,
  ...
  if (false ||
      ...
      (a64.dstWidth == 512 && a64.PredType == A64_PRED_NO && a64.EVEXb == 1 &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_MEM && true)) {
    CodeGeneratorAArch64::dup(xa::ZRegS(zTmpIdx), W_TMP_0);
  }
  /* Col=AB103*/
  if (false ||
      (a64.dstWidth == 256 && a64.PredType == A64_PRED_NO && a64.EVEXb == 0 &&
  ...
  if (false ||
      ...
      (a64.dstWidth == 512 && a64.PredType == A64_PRED_ZERO && a64.EVEXb == 1 &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_MEM && true)) {
    CodeGeneratorAArch64::mov(xa::PRegB(pTmpIdx), P_ALL_ONE.b);
  }
  ...
  if (false ||
      ...
      (a64.dstWidth == 512 && a64.PredType == A64_PRED_NO && a64.EVEXb == 0 &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_REG && true)) {
    CodeGeneratorAArch64::mov(xa::ZRegD(zTmpIdx), xa::ZRegD(a64.srcIdx));
  }
  /* Col=AH103*/
  if (false ||
      (a64.dstWidth == 512 && a64.PredType == A64_PRED_NO && a64.EVEXb == 0 &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_REG && true)) {
    CodeGeneratorAArch64::cmpgt(xa::PReg(pTmp2Idx).s, xa::PReg(pTmpIdx),
                                xa::ZReg(zTmpIdx).s, 0);
  }
  /* Col=AI103*/
  if (false ||
      ...
      (a64.dstWidth == 512 && a64.PredType == A64_PRED_NO && a64.EVEXb == 0 &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_REG && true)) {
    CodeGeneratorAArch64::fadd(xa::ZReg(zTmpIdx).s,
                               xa::PReg(pTmp2Idx) / xa::T_m, 0.5);
  }
  /* Col=AJ103*/
  if (false ||
      (a64.dstWidth == 512 && a64.PredType == A64_PRED_NO && a64.EVEXb == 0 &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_REG && true)) {
    CodeGeneratorAArch64::cmplt(xa::PReg(pTmp2Idx).s, xa::PReg(pTmpIdx),
                                xa::ZReg(zTmpIdx).s, 0);
  }
  /* Col=AK103*/
  if (false ||
      (a64.dstWidth == 512 && a64.PredType == A64_PRED_NO && a64.EVEXb == 0 &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_REG && true)) {
    CodeGeneratorAArch64::fsub(xa::ZReg(zTmpIdx).s,
                               xa::PReg(pTmp2Idx) / xa::T_m, 0.5);
  }
  /* Col=AL103*/
  if (false ||
      ...
      (a64.dstWidth == 128 && a64.PredType == A64_PRED_NO && a64.EVEXb == 1 &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_REG && true)) {
    CodeGeneratorAArch64::fcvtzs(xa::VReg(a64.dstIdx).s4,
  ...
  if (false ||
      ...
      (a64.dstWidth == 128 && a64.PredType == A64_PRED_NO && a64.EVEXb == 1 &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_MEM && true)) {
    CodeGeneratorAArch64::fcvtzs(xa::VReg(a64.dstIdx).s4, xa::VReg(vTmpIdx).s4);
  }
  /* Col=AN103*/
  if (false ||
      (a64.dstWidth == 128 && a64.PredType == A64_PRED_ZERO && a64.EVEXb == 0 &&
      ...
      (a64.dstWidth == 512 && a64.PredType == A64_PRED_ZERO && a64.EVEXb == 1 &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_REG && true)) {
    CodeGeneratorAArch64::fcvtzs(xa::ZReg(a64.dstIdx).s,
                                 xa::PReg(pTmpIdx) / xa::T_m,
  ...
  if (false ||
      ...
      (a64.dstWidth == 512 && a64.PredType == A64_PRED_ZERO && a64.EVEXb == 1 &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_MEM && true)) {
    CodeGeneratorAArch64::not_(xa::PRegB(pTmpIdx), P_ALL_ONE.b,
  ...
  if (false ||
      ...
      (a64.dstWidth == 256 && a64.PredType == A64_PRED_ZERO && a64.EVEXb == 1 &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_MEM && true)) {
    CodeGeneratorAArch64::orn(xa::PRegB(pTmpIdx), P_ALL_ONE / xa::T_z,
