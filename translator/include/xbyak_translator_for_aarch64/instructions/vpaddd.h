...
void translateVPADDD(xed_decoded_inst_t *p) {
  ...
  if (false ||
      ...
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
       ...
       a64.operands[0].opWidth == 512 && a64.predType == A64_PRED_ZERO &&
       a64.EVEXb == 1 && true)) {
    CG64::not_(xa::PRegB(pTmpIdx), P_ALL_ONE.b, P_TMP_0.b);
  }
  /* Col=AM119*/
  if (false ||
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
      ...
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
       ...
       a64.operands[0].opWidth == 256 && a64.predType == A64_PRED_ZERO &&
       a64.EVEXb == 1 && true)) {
    CG64::orn(xa::PRegB(pTmpIdx), P_ALL_ONE / xa::T_z, P_MSB_256.b, P_TMP_0.b);
  }
  ...
  if (false ||
      ...
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
       ...
       a64.operands[0].opWidth == 128 && a64.predType == A64_PRED_ZERO &&
       a64.EVEXb == 1 && true)) {
    CG64::orn(xa::PRegB(pTmpIdx), P_ALL_ONE / xa::T_z, P_MSB_384.b, P_TMP_0.b);
  }
  /* Col=AO119*/
  if (false ||
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
