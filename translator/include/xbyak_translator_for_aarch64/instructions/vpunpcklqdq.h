...
void translateVPUNPCKLQDQ(xed_decoded_inst_t *p) {
  ...
  if (false || (a64.operands[0].opName == XED_OPERAND_REG0 &&
                ...
                a64.operands[3].opName == XED_OPERAND_INVALID &&
                a64.operands[0].opWidth == 128 && true)) {
    CG64::mov(xa::VReg(zTmpIdx).d[0], xa::VReg(srcIdx).d[0]);
  }
  /* Col=AJ119*/
  if (false || (a64.operands[0].opName == XED_OPERAND_REG0 &&
                a64.operands[1].opName == XED_OPERAND_REG1 &&
                ...
                a64.operands[3].opName == XED_OPERAND_INVALID &&
                a64.operands[0].opWidth == 128 && true)) {
    CG64::mov(xa::VReg(zTmp2Idx).d[0], xa::VReg(srcIdx).d[0]);
  }
  /* Col=AK119*/
  if (false || (a64.operands[0].opName == XED_OPERAND_REG0 &&
                a64.operands[1].opName == XED_OPERAND_REG1 &&
                ...
                a64.operands[3].opName == XED_OPERAND_INVALID &&
                a64.operands[0].opWidth == 128 && true)) {
    CG64::mov(xa::VReg(zTmpIdx).d[1], xa::VReg(src2Idx).d[0]);
  }
  /* Col=AL119*/
  if (false || (a64.operands[0].opName == XED_OPERAND_REG0 &&
                a64.operands[1].opName == XED_OPERAND_REG1 &&
                ...
                a64.operands[3].opName == XED_OPERAND_INVALID &&
                a64.operands[0].opWidth == 128 && true)) {
    CG64::mov(xa::VReg(zTmp2Idx).d[1], xa::VReg(zTmpIdx).d[0]);
  }
