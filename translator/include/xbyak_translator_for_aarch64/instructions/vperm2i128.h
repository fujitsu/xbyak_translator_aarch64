...
#define CG64 CodeGeneratorAArch64
  ...
  if (false || (a64.operands[0].opName == XED_OPERAND_REG0 &&
                ...
                a64.operands[3].opName == XED_OPERAND_IMM0 &&
                a64.operands[0].opWidth == 256 && true)) {
    CG64::and_(xa::PRegB(pTmp2Idx), xa::PReg(pTmpIdx), xa::PRegB(pTmp2Idx),
               P_TMP_0.b);
  }
  /* Col=AM103*/
  if (false || (a64.operands[0].opName == XED_OPERAND_REG0 &&
                ...
                a64.operands[3].opName == XED_OPERAND_IMM0 &&
                a64.operands[0].opWidth == 256 && true)) {
    CG64::sel(xa::ZRegD(dstIdx), xa::PReg(pTmp2Idx), xa::ZRegD(zTmp2Idx),
              xa::ZRegD(dstIdx));
  }
  /* Col=AN103*/
  if (false || (a64.operands[0].opName == XED_OPERAND_REG0 &&
  ...
  if (false || (a64.operands[0].opName == XED_OPERAND_REG0 &&
                ...
                a64.operands[3].opName == XED_OPERAND_IMM0 &&
                a64.operands[0].opWidth == 256 && true)) {
    CG64::sel(xa::ZRegD(dstIdx), xa::PReg(pTmp2Idx), xa::ZRegD(src2Idx),
              xa::ZRegD(dstIdx));
  }
  ...
  if (false || (a64.operands[0].opName == XED_OPERAND_REG0 &&
                ...
                a64.operands[3].opName == XED_OPERAND_IMM0 &&
                a64.operands[0].opWidth == 256 && true)) {
    CG64::sel(xa::ZRegD(dstIdx), xa::PReg(pTmp2Idx), xa::ZRegD(srcIdx),
              xa::ZRegD(dstIdx));
  }
  /* Col=BH103*/
  if (false || (a64.operands[0].opName == XED_OPERAND_REG0 &&
