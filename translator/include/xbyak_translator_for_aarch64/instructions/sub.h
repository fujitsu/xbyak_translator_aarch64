...
CG64::sub_imm(Xbyak_aarch64::WReg(a64.dstIdx), Xbyak_aarch64::WReg(a64.dstIdx), static_cast<uint32_t>(a64.uimm), W_TMP_0, W_TMP_1);
}
/* Col=T103*/
if(false ||(a64.dstWidth==64&&a64.dstType==A64_OP_REG&&a64.srcType==A64_OP_IMM&&true)) {
  CG64::sub_imm(Xbyak_aarch64::XReg(a64.dstIdx), Xbyak_aarch64::XReg(a64.dstIdx), a64.uimm, X_TMP_0, X_TMP_1);
}
...
CG64::sub_imm(W_TMP_0, W_TMP_0, static_cast<uint32_t>(a64.uimm), W_TMP_1, W_TMP_2);
}
/* Col=AB103*/
if(false ||(a64.dstWidth==64&&a64.dstType==A64_OP_MEM&&a64.srcType==A64_OP_IMM&&true)) {
  CG64::sub_imm(X_TMP_0, X_TMP_0, a64.uimm, X_TMP_1, X_TMP_2);
...
if(false ||(a64.dstWidth==32&&a64.dstType==A64_OP_REG&&a64.srcType==A64_OP_REG&&true)) {
  CG64::sub(xa::WReg(a64.dstIdx), xa::WReg(a64.dstIdx), xa::WReg(a64.srcIdx));
}
/* Col=AF103*/
if(false ||(a64.dstWidth==64&&a64.dstType==A64_OP_REG&&a64.srcType==A64_OP_REG&&true)) {
  CG64::sub(xa::XReg(a64.dstIdx), xa::XReg(a64.dstIdx), xa::XReg(a64.srcIdx));
}
...
if(false ||(a64.dstWidth==32&&a64.dstType==A64_OP_MEM&&a64.srcType==A64_OP_REG&&true)) {
  CG64::sub(W_TMP_0, W_TMP_0, xa::WReg(a64.srcIdx));
}
/* Col=AK103*/
if(false ||(a64.dstWidth==64&&a64.dstType==A64_OP_MEM&&a64.srcType==A64_OP_REG&&true)) {
  CG64::sub(X_TMP_0, X_TMP_0, xa::XReg(a64.srcIdx));
}
...
if(false ||(a64.dstWidth==32&&a64.dstType==A64_OP_REG&&a64.srcType==A64_OP_MEM&&true)) {
  CG64::sub(xa::WReg(a64.dstIdx), xa::WReg(a64.dstIdx), W_TMP_0);
}
/* Col=AR103*/
if(false ||(a64.dstWidth==64&&a64.dstType==A64_OP_REG&&a64.srcType==A64_OP_MEM&&true)) {
  CG64::sub(xa::XReg(a64.dstIdx), xa::XReg(a64.dstIdx), X_TMP_0);
}
