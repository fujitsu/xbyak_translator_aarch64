void translateAND(xed_decoded_inst_t *p) {
  ...
  if(false ||(a64.dstWidth==32&&a64.dstType==A64_OP_REG&&a64.srcType==A64_OP_IMM&&true)) {
    ...
    CodeGeneratorAArch64::and_(Xbyak_aarch64::WReg(a64.dstIdx), Xbyak_aarch64::WReg(a64.dstIdx), static_cast<uint32_t>(a64.uimm));
  }
  /* Col=U103*/
  if(false ||(a64.dstWidth==64&&a64.dstType==A64_OP_REG&&a64.srcType==A64_OP_IMM&&true)) {
    ...
    CodeGeneratorAArch64::and_(Xbyak_aarch64::XReg(a64.dstIdx), Xbyak_aarch64::XReg(a64.dstIdx), X_TMP_1);
  }
  ...
  if(false ||(a64.dstWidth==32&&a64.dstType==A64_OP_MEM&&a64.srcType==A64_OP_IMM&&true)) {
    ...
    CodeGeneratorAArch64::and_(W_TMP_0, W_TMP_0, static_cast<uint32_t>(a64.uimm));
  }
  /* Col=AC103*/
  ...
  if(false ||(a64.dstWidth==32&&a64.dstType==A64_OP_REG&&a64.srcType==A64_OP_REG&&true)) {
    CodeGeneratorAArch64::and_(xa::WReg(a64.dstIdx), xa::WReg(a64.dstIdx), xa::WReg(a64.srcIdx));
  }
  /* Col=AG103*/
  if(false ||(a64.dstWidth==64&&a64.dstType==A64_OP_REG&&a64.srcType==A64_OP_REG&&true)) {
    CodeGeneratorAArch64::and_(xa::XReg(a64.dstIdx), xa::XReg(a64.dstIdx), xa::XReg(a64.srcIdx));
  }
  ...
  if(false ||(a64.dstWidth==32&&a64.dstType==A64_OP_REG&&a64.srcType==A64_OP_MEM&&true)) {
    CodeGeneratorAArch64::and_(xa::WReg(a64.dstIdx), xa::WReg(a64.dstIdx), W_TMP_0);
  }
  /* Col=AS103*/
  if(false ||(a64.dstWidth==64&&a64.dstType==A64_OP_REG&&a64.srcType==A64_OP_MEM&&true)) {
    CodeGeneratorAArch64::and_(xa::XReg(a64.dstIdx), xa::XReg(a64.dstIdx), X_TMP_0);
  }
