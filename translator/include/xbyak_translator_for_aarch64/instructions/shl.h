...
#define CG64 CodeGeneratorAArch64
  ...
  if (false || (a64.operands[0].opName == XED_OPERAND_REG0 &&
    ...
    CG64::lsl(xa::XReg(a64.operands[0].regIdx),
              xa::XReg(a64.operands[0].regIdx), a64.operands[1].uimm % 64);
  }
  /* Col=AA103*/
  if (false || (a64.operands[0].opName == XED_OPERAND_REG0 &&
                a64.operands[1].opName == XED_OPERAND_IMM0 &&
                a64.operands[0].opWidth == 32 && true)) {
    CG64::lsl(xa::WReg(a64.operands[0].regIdx),
              xa::WReg(a64.operands[0].regIdx), a64.operands[1].uimm % 32);
  }
