...
void translateVPMOVUSDB(xed_decoded_inst_t *p) {
  ...
  /* Col=AD119*/
  if(false ||(a64_opt.operands[0].opName==XED_OPERAND_REG0&&a64_opt.operands[1].opName==XED_OPERAND_REG1&&a64_opt.operands[2].regClass==XED_REG_CLASS_XMM&&a64_opt.operands[0].opWidth==128&&a64_opt.predType==A64_PRED_NO&&isAvailAll1Preg0_7()==true &&true)||(a64_opt.operands[0].opName==XED_OPERAND_REG0&&a64_opt.operands[1].opName==XED_OPERAND_REG1&&a64_opt.operands[2].regClass==XED_REG_CLASS_ZMM&&a64_opt.operands[0].opWidth==128&&a64_opt.predType==A64_PRED_NO&&isAvailAll1Preg0_7()==true &&true)||(a64_opt.operands[0].opName==XED_OPERAND_MEM0&&a64_opt.operands[1].opName==XED_OPERAND_REG0&&a64_opt.operands[2].regClass==XED_REG_CLASS_ZMM&&a64_opt.operands[0].opWidth==128&&a64_opt.predType==A64_PRED_NO&&isAvailAll1Preg0_7()==true &&true)) {
    zTmpIdx = xt_push_zreg(&a64);
  }
  /* Col=AF119*/
  if(false ||(a64_opt.operands[0].opName==XED_OPERAND_REG0&&a64_opt.operands[1].opName==XED_OPERAND_REG1&&a64_opt.operands[2].regClass==XED_REG_CLASS_XMM&&a64_opt.operands[0].opWidth==128&&a64_opt.predType==A64_PRED_NO&&isAvailAll1Preg0_7()==true &&true)||(a64_opt.operands[0].opName==XED_OPERAND_REG0&&a64_opt.operands[1].opName==XED_OPERAND_REG1&&a64_opt.operands[2].regClass==XED_REG_CLASS_ZMM&&a64_opt.operands[0].opWidth==128&&a64_opt.predType==A64_PRED_NO&&isAvailAll1Preg0_7()==true &&true)) {
  ...
  /* Col=AO119*/
  if(false ||(a64_opt.operands[0].opName==XED_OPERAND_REG0&&a64_opt.operands[1].opName==XED_OPERAND_REG1&&a64_opt.operands[2].regClass==XED_REG_CLASS_XMM&&a64_opt.operands[0].opWidth==128&&a64_opt.predType==A64_PRED_NO&&isAvailAll1Preg0_7()==true &&true)||(a64_opt.operands[0].opName==XED_OPERAND_REG0&&a64_opt.operands[1].opName==XED_OPERAND_REG1&&a64_opt.operands[2].regClass==XED_REG_CLASS_ZMM&&a64_opt.operands[0].opWidth==128&&a64_opt.predType==A64_PRED_NO&&isAvailAll1Preg0_7()==true &&true)) {
    CG64::cmphi(P_TMP_0.s, P_ALL_ONE_0_7, xa::ZRegS(srcIdx), xa::ZRegS(zTmpIdx));
  }
  /* Col=AR119*/
  if(false ||(a64_opt.operands[0].opName==XED_OPERAND_REG0&&a64_opt.operands[1].opName==XED_OPERAND_REG1&&a64_opt.operands[2].regClass==XED_REG_CLASS_XMM&&a64_opt.operands[0].opWidth==128&&a64_opt.predType==A64_PRED_NO&&isAvailAll1Preg0_7()==true &&true)||(a64_opt.operands[0].opName==XED_OPERAND_REG0&&a64_opt.operands[1].opName==XED_OPERAND_REG1&&a64_opt.operands[2].regClass==XED_REG_CLASS_ZMM&&a64_opt.operands[0].opWidth==128&&a64_opt.predType==A64_PRED_NO&&isAvailAll1Preg0_7()==true &&true)) {
  ...
  /* Col=AS119*/
  if(false ||(a64_opt.operands[0].opName==XED_OPERAND_MEM0&&a64_opt.operands[1].opName==XED_OPERAND_REG0&&a64_opt.operands[2].regClass==XED_REG_CLASS_ZMM&&a64_opt.operands[0].opWidth==128&&a64_opt.predType==A64_PRED_NO&&isAvailAll1Preg0_7()==true &&true)) {
  ...
  /* Col=BA119*/
  if(false ||(a64_opt.operands[0].opName==XED_OPERAND_REG0&&a64_opt.operands[1].opName==XED_OPERAND_REG1&&a64_opt.operands[2].regClass==XED_REG_CLASS_XMM&&a64_opt.operands[0].opWidth==128&&a64_opt.predType==A64_PRED_NO&&isAvailAll1Preg0_7()==true &&true)) {
  ...
  /* Col=BC119*/
  if(false ||(a64_opt.operands[0].opName==XED_OPERAND_REG0&&a64_opt.operands[1].opName==XED_OPERAND_REG1&&a64_opt.operands[2].regClass==XED_REG_CLASS_ZMM&&a64_opt.operands[0].opWidth==128&&a64_opt.predType==A64_PRED_NO&&isAvailAll1Preg0_7()==true &&true)) {
  ...
  /* Col=BE119*/
  if(false ||(a64_opt.operands[0].opName==XED_OPERAND_MEM0&&a64_opt.operands[1].opName==XED_OPERAND_REG0&&a64_opt.operands[2].regClass==XED_REG_CLASS_ZMM&&a64_opt.operands[0].opWidth==128&&a64_opt.predType==A64_PRED_NO&&isAvailAll1Preg0_7()==true &&true)) {
    CG64::umin(xa::ZRegS(zTmpIdx), 255);
  }
  /* Col=BJ119*/
  if(false ||(a64_opt.operands[0].opName==XED_OPERAND_MEM0&&a64_opt.operands[1].opName==XED_OPERAND_REG0&&a64_opt.operands[2].regClass==XED_REG_CLASS_ZMM&&a64_opt.operands[0].opWidth==128&&a64_opt.predType==A64_PRED_NO&&isAvailAll1Preg0_7()==true &&true)) {
    CG64::st1b(xa::ZRegS(zTmpIdx), P_ALL_ONE_0_7, xa::ptr(X_TMP_ADDR));
  }
  /* Col=BQ119*/
  if(false ||(a64_opt.operands[0].opName==XED_OPERAND_REG0&&a64_opt.operands[1].opName==XED_OPERAND_REG1&&a64_opt.operands[2].regClass==XED_REG_CLASS_XMM&&a64_opt.operands[0].opWidth==128&&a64_opt.predType==A64_PRED_NO&&isAvailAll1Preg0_7()==true &&true)||(a64_opt.operands[0].opName==XED_OPERAND_REG0&&a64_opt.operands[1].opName==XED_OPERAND_REG1&&a64_opt.operands[2].regClass==XED_REG_CLASS_ZMM&&a64_opt.operands[0].opWidth==128&&a64_opt.predType==A64_PRED_NO&&isAvailAll1Preg0_7()==true &&true)||(a64_opt.operands[0].opName==XED_OPERAND_MEM0&&a64_opt.operands[1].opName==XED_OPERAND_REG0&&a64_opt.operands[2].regClass==XED_REG_CLASS_ZMM&&a64_opt.operands[0].opWidth==128&&a64_opt.predType==A64_PRED_NO&&isAvailAll1Preg0_7()==true &&true)) {
    xt_pop_zreg();
  ...
  /* Col=U119*/
  if(false ||(a64.operands[0].opName==XED_OPERAND_REG0&&a64.operands[1].opName==XED_OPERAND_REG1&&a64.operands[2].regClass==XED_REG_CLASS_XMM&&a64.operands[0].opWidth==128&&a64.predType==A64_PRED_NO&&true)||(a64.operands[0].opName==XED_OPERAND_REG0&&a64.operands[1].opName==XED_OPERAND_REG1&&a64.operands[2].regClass==XED_REG_CLASS_ZMM&&a64.operands[0].opWidth==128&&a64.predType==A64_PRED_NO&&true)||(a64.operands[0].opName==XED_OPERAND_MEM0&&a64.operands[1].opName==XED_OPERAND_REG0&&a64.operands[2].regClass==XED_REG_CLASS_ZMM&&a64.operands[0].opWidth==128&&a64.predType==A64_PRED_NO&&true)) {
  ...
  /* Col=BQ119*/
  if(false ||(a64.operands[0].opName==XED_OPERAND_REG0&&a64.operands[1].opName==XED_OPERAND_REG1&&a64.operands[2].regClass==XED_REG_CLASS_XMM&&a64.operands[0].opWidth==128&&a64.predType==A64_PRED_NO&&true)||(a64.operands[0].opName==XED_OPERAND_MEM0&&a64.operands[1].opName==XED_OPERAND_REG0&&a64.operands[2].regClass==XED_REG_CLASS_XMM&&a64.operands[0].opWidth==128&&a64.predType==A64_PRED_NO&&true)||(a64.operands[0].opName==XED_OPERAND_REG0&&a64.operands[1].opName==XED_OPERAND_REG1&&a64.operands[2].regClass==XED_REG_CLASS_XMM&&a64.operands[0].opWidth==128&&a64.predType==A64_PRED_ZERO&&true)||(a64.operands[0].opName==XED_OPERAND_MEM0&&a64.operands[1].opName==XED_OPERAND_REG0&&a64.operands[2].regClass==XED_REG_CLASS_XMM&&a64.operands[0].opWidth==32&&a64.predType==A64_PRED_ZERO&&true)||(a64.operands[0].opName==XED_OPERAND_REG0&&a64.operands[1].opName==XED_OPERAND_REG1&&a64.operands[2].regClass==XED_REG_CLASS_XMM&&a64.operands[0].opWidth==128&&a64.predType==A64_PRED_MERG&&true)||(a64.operands[0].opName==XED_OPERAND_MEM0&&a64.operands[1].opName==XED_OPERAND_REG0&&a64.operands[2].regClass==XED_REG_CLASS_XMM&&a64.operands[0].opWidth==32&&a64.predType==A64_PRED_MERG&&true)||(a64.operands[0].opName==XED_OPERAND_REG0&&a64.operands[1].opName==XED_OPERAND_REG1&&a64.operands[2].regClass==XED_REG_CLASS_YMM&&a64.operands[0].opWidth==128&&a64.predType==A64_PRED_NO&&true)||(a64.operands[0].opName==XED_OPERAND_MEM0&&a64.operands[1].opName==XED_OPERAND_REG0&&a64.operands[2].regClass==XED_REG_CLASS_YMM&&a64.operands[0].opWidth==64&&a64.predType==A64_PRED_NO&&true)||(a64.operands[0].opName==XED_OPERAND_REG0&&a64.operands[1].opName==XED_OPERAND_REG1&&a64.operands[2].regClass==XED_REG_CLASS_YMM&&a64.operands[0].opWidth==128&&a64.predType==A64_PRED_ZERO&&true)||(a64.operands[0].opName==XED_OPERAND_MEM0&&a64.operands[1].opName==XED_OPERAND_REG0&&a64.operands[2].regClass==XED_REG_CLASS_YMM&&a64.operands[0].opWidth==64&&a64.predType==A64_PRED_ZERO&&true)||(a64.operands[0].opName==XED_OPERAND_REG0&&a64.operands[1].opName==XED_OPERAND_REG1&&a64.operands[2].regClass==XED_REG_CLASS_YMM&&a64.operands[0].opWidth==128&&a64.predType==A64_PRED_MERG&&true)||(a64.operands[0].opName==XED_OPERAND_MEM0&&a64.operands[1].opName==XED_OPERAND_REG0&&a64.operands[2].regClass==XED_REG_CLASS_YMM&&a64.operands[0].opWidth==64&&a64.predType==A64_PRED_MERG&&true)||(a64.operands[0].opName==XED_OPERAND_REG0&&a64.operands[1].opName==XED_OPERAND_REG1&&a64.operands[2].regClass==XED_REG_CLASS_ZMM&&a64.operands[0].opWidth==128&&a64.predType==A64_PRED_NO&&true)||(a64.operands[0].opName==XED_OPERAND_MEM0&&a64.operands[1].opName==XED_OPERAND_REG0&&a64.operands[2].regClass==XED_REG_CLASS_ZMM&&a64.operands[0].opWidth==128&&a64.predType==A64_PRED_NO&&true)||(a64.operands[0].opName==XED_OPERAND_REG0&&a64.operands[1].opName==XED_OPERAND_REG1&&a64.operands[2].regClass==XED_REG_CLASS_ZMM&&a64.operands[0].opWidth==128&&a64.predType==A64_PRED_ZERO&&true)||(a64.operands[0].opName==XED_OPERAND_MEM0&&a64.operands[1].opName==XED_OPERAND_REG0&&a64.operands[2].regClass==XED_REG_CLASS_ZMM&&a64.operands[0].opWidth==128&&a64.predType==A64_PRED_ZERO&&true)||(a64.operands[0].opName==XED_OPERAND_REG0&&a64.operands[1].opName==XED_OPERAND_REG1&&a64.operands[2].regClass==XED_REG_CLASS_ZMM&&a64.operands[0].opWidth==128&&a64.predType==A64_PRED_MERG&&true)||(a64.operands[0].opName==XED_OPERAND_MEM0&&a64.operands[1].opName==XED_OPERAND_REG0&&a64.operands[2].regClass==XED_REG_CLASS_ZMM&&a64.operands[0].opWidth==128&&a64.predType==A64_PRED_MERG&&true)) {
    XT_VALID_CHECK;
  }
  XT_VALID_CHECK_IF;
}
