void translateKORTESTD(xed_decoded_inst_t *p) {
    ...
    mov__(addrtmp, ALL1_BIT32_ADDRESS); //アドレスはいったん適当な値
    Xbyak_aarch64::AdrNoOfs adr_reg(addrtmp);
    ldr(ptmp1, adr_reg);
    ldr(ptmp2, adr_reg);
    ldr(condR, adr_reg);
    Xbyak_aarch64::CodeGeneratorAArch64::AND_(
            ptmp1.b, condR/Xbyak::Xbyak_aarch64::T_z, src1.b, ptmp1.b); // get src1[31:0]
    Xbyak_aarch64::CodeGeneratorAArch64::AND_(
            ptmp2.b, condR/Xbyak::Xbyak_aarch64::T_z, src2.b, ptmp2.b); // get src2[31:0]
