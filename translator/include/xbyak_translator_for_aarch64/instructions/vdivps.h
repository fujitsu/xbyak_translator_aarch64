...
void translateVDIVPS(xed_decoded_inst_t *p) {
  ...
  /* 2020/02/28 14:16 */
  xt_reg_idx_t dstIdx = XED_REG_INVALID;
  xt_reg_idx_t srcIdx = XED_REG_INVALID;
#define CG64 CodeGeneratorAArch64
  ...
  if (false ||
    ...
    if (a64.dstIdx == a64.srcIdx) {
      ...
      dstIdx = a64.zTmpIdx;
      srcIdx = a64.src2Idx;
      CG64::mov(xa::ZRegD(a64.zTmpIdx), xa::ZRegD(a64.srcIdx));
    }
  }
  ...
  if (false ||
      ...
      (a64.dstWidth == 512 && a64.PredType == A64_PRED_NO && a64.EVEXb == 0 &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_REG &&
       a64.src2Type == A64_OP_REG && true)) {
    CG64::mov(xa::PRegB(a64.pTmpIdx), P_ALL_ONE, P_ALL_ONE.b);
  }
  /* Col=AC103*/
  if (false ||
      (a64.dstWidth == 512 && a64.PredType == A64_PRED_ZERO && a64.EVEXb == 0 &&
  ...
  if (false ||
      ...
      (a64.dstWidth == 512 && a64.PredType == A64_PRED_ZERO && a64.EVEXb == 0 &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_REG &&
       a64.src2Type == A64_OP_REG && true)) {
    CG64::fdiv(xa::VReg(a64.dstIdx).s4, xa::VReg(a64.srcIdx).s4,
  ...
  if (false ||
      ...
      (a64.dstWidth == 512 && a64.PredType == A64_PRED_MERG && a64.EVEXb == 1 &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_REG &&
       a64.src2Type == A64_OP_MEM && true)) {
    CG64::fdiv(xa::ZRegS(dstIdx), xa::PReg(a64.pTmpIdx), xa::ZRegS(srcIdx));
  }
  ...
  if (false ||
      ...
      (a64.dstWidth == 512 && a64.PredType == A64_PRED_NO && a64.EVEXb == 0 &&
       ...
       a64.src2Type == A64_OP_REG && true)) {
    if (a64.dstIdx != a64.srcIdx) {
      CG64::mov(xa::ZRegD(a64.dstIdx), xa::ZRegD(dstIdx));
      xt_pop_zreg();
    }
  }
