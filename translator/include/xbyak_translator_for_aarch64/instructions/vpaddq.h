...
void translateVPADDQ(xed_decoded_inst_t *p) {
  ...
  if (false ||
      ...
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
       ...
       a64.operands[0].opWidth == 128 && a64.predType == A64_PRED_NO &&
       a64.EVEXb == 0 && true)) {
    CG64::ld1(xa::VReg(zTmpIdx).d2, xa::ptr(X_TMP_ADDR));
  }
  ...
  if (false || (a64.operands[2].opName == XED_OPERAND_REG2 &&
                ...
                a64.operands[0].opWidth == 128 && a64.predType == A64_PRED_NO &&
                a64.EVEXb == 1 && true)) {
    CG64::ld1r(xa::VReg(zTmpIdx).d2, xa::ptr(X_TMP_ADDR));
  }
  /* Col=AE119*/
  if (false ||
      (a64.operands[2].opName == XED_OPERAND_MEM0 &&
  ...
  if (false ||
      ...
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
       ...
       a64.operands[0].opWidth == 512 && a64.predType == A64_PRED_MERG &&
       a64.EVEXb == 1 && true)) {
    CG64::ld1rw(xa::ZReg(zTmpIdx).d, P_ALL_ONE / xa::T_z, xa::ptr(X_TMP_ADDR));
  }
  /* Col=AK119*/
  if (false ||
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
  ...
  if (false ||
      ...
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
       ...
       a64.operands[0].opWidth == 128 && a64.predType == A64_PRED_NO &&
       a64.EVEXb == 0 && true)) {
    CG64::add(xa::VReg(dstIdx).d2, xa::VReg(srcIdx).d2, xa::VReg(src2Idx).d2);
  }
  /* Col=AP119*/
  if (false ||
      (a64.operands[2].opName == XED_OPERAND_MEM0 &&
      ...
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
       ...
       a64.operands[0].opWidth == 128 && a64.predType == A64_PRED_NO &&
       a64.EVEXb == 1 && true)) {
    CG64::add(xa::VReg(dstIdx).d2, xa::VReg(srcIdx).d2, xa::VReg(zTmpIdx).d2);
  }
  /* Col=AQ119*/
  if (false ||
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
      ...
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
       ...
       a64.operands[0].opWidth == 512 && a64.predType == A64_PRED_ZERO &&
       a64.EVEXb == 0 && true)) {
    CG64::add(xa::ZReg(dstIdx).d, xa::ZReg(srcIdx).d, xa::ZReg(src2Idx).d);
  }
  /* Col=AR119*/
  if (false ||
      (a64.operands[2].opName == XED_OPERAND_MEM0 &&
      ...
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
       ...
       a64.operands[0].opWidth == 512 && a64.predType == A64_PRED_ZERO &&
       a64.EVEXb == 1 && true)) {
    CG64::add(xa::ZReg(dstIdx).d, xa::ZReg(srcIdx).d, xa::ZReg(zTmpIdx).d);
  }
  /* Col=AS119*/
  if (false ||
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
      ...
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
       ...
       a64.operands[0].opWidth == 512 && a64.predType == A64_PRED_MERG &&
       a64.EVEXb == 0 && true)) {
    CG64::add(xa::ZReg(zTmpIdx).d, xa::ZReg(srcIdx).d, xa::ZReg(src2Idx).d);
  }
  /* Col=AT119*/
  if (false ||
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
      ...
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
       ...
       a64.operands[0].opWidth == 512 && a64.predType == A64_PRED_MERG &&
       a64.EVEXb == 1 && true)) {
    CG64::add(xa::ZReg(zTmpIdx).d, xa::ZReg(srcIdx).d, xa::ZReg(zTmpIdx).d);
  }
  /* Col=AV119*/
  if (false ||
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
      ...
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
       ...
       a64.operands[0].opWidth == 512 && a64.predType == A64_PRED_MERG &&
       a64.EVEXb == 1 && true)) {
    CG64::mov(xa::ZReg(dstIdx).d, xa::PReg(maskIdx) / xa::T_m,
              xa::ZReg(zTmpIdx).d);
  }
  /* Col=AW119*/
  if (false ||
      ...
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
       ...
       a64.operands[0].opWidth == 256 && a64.predType == A64_PRED_MERG &&
       a64.EVEXb == 1 && true)) {
    CG64::mov(xa::ZReg(dstIdx).d, P_MSB_256 / xa::T_m, 0);
  }
  ...
  if (false ||
      ...
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
       ...
       a64.operands[0].opWidth == 128 && a64.predType == A64_PRED_MERG &&
       a64.EVEXb == 1 && true)) {
    CG64::mov(xa::ZReg(dstIdx).d, P_MSB_384 / xa::T_m, 0);
  }
  /* Col=AY119*/
  if (false ||
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
      ...
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
       ...
       a64.operands[0].opWidth == 512 && a64.predType == A64_PRED_ZERO &&
       a64.EVEXb == 1 && true)) {
    CG64::mov(xa::ZReg(dstIdx).d, xa::PReg(pTmpIdx) / xa::T_m, 0);
  }
  /* Col=BB119*/
  if (false ||
      (a64.operands[2].opName == XED_OPERAND_REG2 &&
...
#define CG64 CodeGeneratorAArch64
  ...
  if (false || (a64.dstWidth == 128 && a64.PredType == A64_PRED_NO &&
                a64.EVEXb == 0 && a64.dstType == A64_OP_REG &&
                a64.srcType == A64_OP_REG && a64.src2Type == A64_OP_MEM)) {
    CG64::ld1(xa::VReg(a64.vTmpIdx).d2, xa::ptr(X_TMP_ADDR));
  }
  /* Col=S103*/
  if (false || (a64.dstWidth == 128 && a64.PredType == A64_PRED_NO &&
                a64.EVEXb == 1 && a64.dstType == A64_OP_REG &&
                a64.srcType == A64_OP_REG && a64.src2Type == A64_OP_MEM)) {
    CG64::ld1r(xa::VReg(a64.vTmpIdx).d2, xa::ptr(X_TMP_ADDR));
  }
  /* Col=T103*/
  if (false || (a64.dstWidth == 128 && a64.PredType == A64_PRED_ZERO &&
                a64.EVEXb == 0 && a64.dstType == A64_OP_REG &&
  ...
  if (false || (a64.dstWidth == 128 && a64.PredType == A64_PRED_ZERO &&
      ...
      (a64.dstWidth == 512 && a64.PredType == A64_PRED_MERG && a64.EVEXb == 1 &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_REG &&
       a64.src2Type == A64_OP_MEM)) {
    CG64::ld1rw(xa::ZReg(a64.zTmpIdx).d, xa::PReg(a64.maskIdx) / xa::T_z,
                xa::ptr(X_TMP_ADDR));
  }
  ...
  if (false || (a64.dstWidth == 128 && a64.PredType == A64_PRED_NO &&
                a64.EVEXb == 0 && a64.dstType == A64_OP_REG &&
                a64.srcType == A64_OP_REG && a64.src2Type == A64_OP_REG)) {
    CG64::add(xa::VReg(a64.dstIdx).d2, xa::VReg(a64.srcIdx).d2,
              xa::VReg(a64.src2Idx).d2);
  }
  /* Col=AB103*/
  if (false || (a64.dstWidth == 128 && a64.PredType == A64_PRED_NO &&
                a64.EVEXb == 0 && a64.dstType == A64_OP_REG &&
  ...
  if (false || (a64.dstWidth == 128 && a64.PredType == A64_PRED_ZERO &&
      ...
      (a64.dstWidth == 512 && a64.PredType == A64_PRED_ZERO && a64.EVEXb == 0 &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_REG &&
       a64.src2Type == A64_OP_REG)) {
    CG64::add(xa::ZReg(a64.dstIdx).d, xa::ZReg(a64.srcIdx).d,
  ...
  if (false || (a64.dstWidth == 128 && a64.PredType == A64_PRED_MERG &&
      ...
      (a64.dstWidth == 512 && a64.PredType == A64_PRED_MERG && a64.EVEXb == 0 &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_REG &&
       a64.src2Type == A64_OP_REG)) {
    CG64::add(xa::ZReg(a64.zTmpIdx).d, xa::ZReg(a64.srcIdx).d,
              xa::ZReg(a64.src2Idx).d);
  }
  /* Col=AF103*/
  if (false || (a64.dstWidth == 128 && a64.PredType == A64_PRED_MERG &&
  ...
  if (false || (a64.dstWidth == 128 && a64.PredType == A64_PRED_MERG &&
      ...
      (a64.dstWidth == 128 && a64.PredType == A64_PRED_MERG && a64.EVEXb == 1 &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_REG &&
       a64.src2Type == A64_OP_MEM)) {
    CG64::mov(xa::ZReg(a64.dstIdx).d, P_MSB_384 / xa::T_m, 0);
  }
  /* Col=AK103*/
  if (false || (a64.dstWidth == 128 && a64.PredType == A64_PRED_ZERO &&
                a64.EVEXb == 0 && a64.dstType == A64_OP_REG &&
      ...
      (a64.dstWidth == 512 && a64.PredType == A64_PRED_ZERO && a64.EVEXb == 1 &&
       a64.dstType == A64_OP_REG && a64.srcType == A64_OP_REG &&
       a64.src2Type == A64_OP_MEM)) {
    CG64::mov(xa::ZReg(a64.dstIdx).d, xa::PReg(a64.pTmpIdx) / xa::T_m, 0);
  }
  /* Col=AL103*/
  if (false || (a64.dstWidth == 128 && a64.PredType == A64_PRED_NO &&
                a64.EVEXb == 0 && a64.dstType == A64_OP_REG &&
