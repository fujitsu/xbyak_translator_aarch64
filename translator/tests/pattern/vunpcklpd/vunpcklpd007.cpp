...
public:
  ...
  void genJitTestCode() {
    ...
    vunpcklpd(Zmm(1) | k1, Zmm(1), Zmm(2));
    vunpcklpd(Zmm(2) | k2, Zmm(1), Zmm(2));
    vunpcklpd(Zmm(3) | k3, Zmm(1), Zmm(2));
    vunpcklpd(Zmm(4) | k4, Zmm(1), Zmm(2));
    vunpcklpd(Zmm(5) | k5, Zmm(1), Zmm(2));
    vunpcklpd(Zmm(6) | k6, Zmm(1), Zmm(2));
    vunpcklpd(Zmm(7) | k7, Zmm(1), Zmm(2));
  }
};
