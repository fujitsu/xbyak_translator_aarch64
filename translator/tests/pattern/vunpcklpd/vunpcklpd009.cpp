...
public:
  ...
  void genJitTestCode() {
    ...
    vunpcklpd(Xmm(0) | k1, Xmm(1), ptr[rax]);
    vunpcklpd(Xmm(2) | k2, Xmm(2), ptr[rax]);

    vunpcklpd(Ymm(3) | k3, Ymm(4), ptr[rax]);
    vunpcklpd(Ymm(5) | k4, Ymm(5), ptr[rax]);

    vunpcklpd(Zmm(6) | k5, Zmm(7), ptr[rax]);
    vunpcklpd(Zmm(8) | k6, Zmm(8), ptr[rax]);
