...
public:
  ...
  void genJitTestCode() {
    ...
    vunpcklpd(Xmm(0) | k1 | T_z, Xmm(1), ptr[rax]);
    vunpcklpd(Xmm(2) | k2 | T_z, Xmm(2), ptr[rax]);

    vunpcklpd(Ymm(3) | k3 | T_z, Ymm(4), ptr[rax]);
    vunpcklpd(Ymm(5) | k4 | T_z, Ymm(5), ptr[rax]);

    vunpcklpd(Zmm(6) | k5 | T_z, Zmm(7), ptr[rax]);
    vunpcklpd(Zmm(8) | k6 | T_z, Zmm(8), ptr[rax]);
