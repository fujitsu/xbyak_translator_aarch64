...
public:
  ...
  void genJitTestCode() {
    ...
    vunpcklpd(Xmm(1) | k1, Xmm(1), Xmm(2));
    vunpcklpd(Xmm(2) | k2, Xmm(1), Xmm(2));
    vunpcklpd(Xmm(3) | k3, Xmm(1), Xmm(2));
    vunpcklpd(Xmm(4) | k4, Xmm(1), Xmm(2));
    vunpcklpd(Xmm(5) | k5, Xmm(1), Xmm(2));
    vunpcklpd(Xmm(6) | k6, Xmm(1), Xmm(2));
    vunpcklpd(Xmm(7) | k7, Xmm(1), Xmm(2));
  }
};
