...
public:
  ...
  void genJitTestCode() {
    ...
    vunpcklpd(Xmm(0), Xmm(1), ptr_b[rax]);
    vunpcklpd(Xmm(2), Xmm(2), ptr_b[rax]);

    vunpcklpd(Ymm(3), Ymm(4), ptr_b[rax]);
    vunpcklpd(Ymm(5), Ymm(5), ptr_b[rax]);

    vunpcklpd(Zmm(6), Zmm(7), ptr_b[rax]);
    vunpcklpd(Zmm(8), Zmm(8), ptr_b[rax]);
