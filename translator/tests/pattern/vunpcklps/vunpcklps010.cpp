...
public:
  ...
  void genJitTestCode() {
    ...
    vunpcklps(Xmm(0), Xmm(1), ptr_b[rax]);
    vunpcklps(Xmm(2), Xmm(2), ptr_b[rax]);

    vunpcklps(Ymm(3), Ymm(4), ptr_b[rax]);
    vunpcklps(Ymm(5), Ymm(5), ptr_b[rax]);

    vunpcklps(Zmm(6), Zmm(7), ptr_b[rax]);
    vunpcklps(Zmm(8), Zmm(8), ptr_b[rax]);
