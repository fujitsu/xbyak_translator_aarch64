...
public:
  ...
  void genJitTestCode() {
    ...
    vunpcklps(Xmm(1) | k1, Xmm(1), Xmm(2));
    vunpcklps(Xmm(2) | k2, Xmm(1), Xmm(2));
    vunpcklps(Xmm(3) | k3, Xmm(1), Xmm(2));
    vunpcklps(Xmm(4) | k4, Xmm(1), Xmm(2));
    vunpcklps(Xmm(5) | k5, Xmm(1), Xmm(2));
    vunpcklps(Xmm(6) | k6, Xmm(1), Xmm(2));
    vunpcklps(Xmm(7) | k7, Xmm(1), Xmm(2));
  }
};
