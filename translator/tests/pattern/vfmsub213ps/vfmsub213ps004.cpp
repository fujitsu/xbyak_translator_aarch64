...
/* Address is aligned */
    ...
    mov(rax, addr);
    vfmsub213ps(Zmm(0), Zmm(1), ptr[rax]);
    vmovdqu8(Zmm(10), ptr[rax]);
    mov(rax, addr1);
    vfmsub213ps(Zmm(3), Zmm(3), ptr[rax]);
    vmovdqu8(Zmm(11), ptr[rax]);
    mov(rax, addr2);
    vfmsub213ps(Zmm(5), Zmm(6), ptr[rax]);
    vmovdqu8(Zmm(12), ptr[rax]);
    mov(rax, addr3);
    vfmsub213ps(Zmm(7), Zmm(8), ptr[rax]);
    vmovdqu8(Zmm(13), ptr[rax]);
    mov(rax, addr4);
    vfmsub213ps(Zmm(9), Zmm(9), ptr[rax]);
    ...
    mov(rax, addr5);
    vfmsub213ps(Zmm(16), Zmm(17), ptr[rax]);
    vmovdqu8(Zmm(25), ptr[rax]);
    mov(rax, addr6);
    vfmsub213ps(Zmm(19), Zmm(19), ptr[rax]);
    vmovdqu8(Zmm(26), ptr[rax]);
    mov(rax, addr7);
    vfmsub213ps(Zmm(21), Zmm(22), ptr[rax]);
    vmovdqu8(Zmm(27), ptr[rax]);
    mov(rax, addr8);
    vfmsub213ps(Zmm(22), Zmm(23), ptr[rax]);
    vmovdqu8(Zmm(28), ptr[rax]);
    mov(rax, addr9);
    vfmsub213ps(Zmm(24), Zmm(24), ptr[rax]);
