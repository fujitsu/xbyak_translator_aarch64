...
public:
  ...
  void genJitTestCode() {
    ...
    vpunpckhqdq(Ymm(2) | k2 | T_z, Ymm(30), Ymm(31));
    vpunpckhqdq(Ymm(3) | k3 | T_z, Ymm(30), Ymm(31));
    vpunpckhqdq(Ymm(4) | k4 | T_z, Ymm(30), Ymm(31));
    vpunpckhqdq(Ymm(5) | k5 | T_z, Ymm(30), Ymm(31));
    ...
    */
    vpunpckhqdq(Ymm(22) | k1 | T_z, Ymm(22), Ymm(22));
    vpunpckhqdq(Ymm(23) | k2 | T_z, Ymm(23), Ymm(23));
    vpunpckhqdq(Ymm(24) | k3 | T_z, Ymm(24), Ymm(24));
    vpunpckhqdq(Ymm(25) | k4 | T_z, Ymm(25), Ymm(25));
