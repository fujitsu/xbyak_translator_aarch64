...
public:
  ...
  void genJitTestCode() {
    ...
    vpunpckhqdq(Zmm(2) | k2, Zmm(30), Zmm(30));
    vpunpckhqdq(Zmm(3) | k3, Zmm(3), Zmm(31));
    vpunpckhqdq(Zmm(4) | k4, Zmm(30), Zmm(4));
    vpunpckhqdq(Zmm(5) | k5, Zmm(5), Zmm(5));
    ...
    */
    vpunpckhqdq(Zmm(22) | k1, Zmm(20), Zmm(20));
    vpunpckhqdq(Zmm(23) | k2, Zmm(23), Zmm(20));
    vpunpckhqdq(Zmm(24) | k3, Zmm(20), Zmm(24));
    vpunpckhqdq(Zmm(25) | k4, Zmm(20), Zmm(21));
