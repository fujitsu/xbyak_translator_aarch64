...
public:
  ...
  void genJitTestCode() {
    ...
    vpunpckhqdq(Xmm(0) | k1 | T_z, Xmm(1), ptr[rax]);
    vpunpckhqdq(Xmm(2) | k2 | T_z, Xmm(2), ptr[rax]);

    vpunpckhqdq(Ymm(3) | k3 | T_z, Ymm(4), ptr[rax]);
    vpunpckhqdq(Ymm(5) | k4 | T_z, Ymm(5), ptr[rax]);
