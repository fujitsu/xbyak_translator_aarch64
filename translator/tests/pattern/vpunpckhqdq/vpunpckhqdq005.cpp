...
public:
  ...
  void genJitTestCode() {
    ...
    vpunpckhqdq(Xmm(2) | k2, Xmm(30), Xmm(31));
    vpunpckhqdq(Xmm(3) | k3, Xmm(30), Xmm(31));
    vpunpckhqdq(Xmm(4) | k4, Xmm(30), Xmm(31));
    vpunpckhqdq(Xmm(5) | k5, Xmm(30), Xmm(31));
    ...
    */
    vpunpckhqdq(Xmm(22) | k1, Xmm(22), Xmm(22));
    vpunpckhqdq(Xmm(23) | k2, Xmm(23), Xmm(23));
    vpunpckhqdq(Xmm(24) | k3, Xmm(24), Xmm(24));
    vpunpckhqdq(Xmm(25) | k4, Xmm(25), Xmm(25));
