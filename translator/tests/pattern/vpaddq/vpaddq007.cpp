...
public:
  ...
  void genJitTestCode() {
    ...
    mov(rax, addr1);
    vpaddq(Xmm(1) | k1, Xmm(10), ptr[rax]);
    vpaddq(Xmm(2) | k2, Xmm(10), ptr[rax]);
    vpaddq(Xmm(3) | k3, Xmm(10), ptr[rax]);
    vpaddq(Xmm(4) | k4, Xmm(10), ptr[rax]);
    vpaddq(Xmm(5) | k5, Xmm(10), ptr[rax]);
    vpaddq(Xmm(26) | k6, Xmm(30), ptr[rax]);
    vpaddq(Xmm(27) | k7, Xmm(0), ptr[rax]);
    vpaddq(Xmm(28) | k5, Xmm(28), ptr[rax]);
    vpaddq(Xmm(0) | k6, Xmm(30), ptr[rax]);
    mov(rax, addr2);
    vpaddq(Xmm(16) | k7, Xmm(16), ptr[rax]);

    vpaddq(Ymm(21) | k1, Ymm(30), ptr[rax]);
    vpaddq(Ymm(22) | k2, Ymm(30), ptr[rax]);
    vpaddq(Ymm(23) | k3, Ymm(30), ptr[rax]);
    vpaddq(Ymm(24) | k4, Ymm(30), ptr[rax]);
    vpaddq(Ymm(25) | k5, Ymm(30), ptr[rax]);
    vpaddq(Ymm(6) | k6, Ymm(10), ptr[rax]);
    vpaddq(Ymm(7) | k7, Ymm(16), ptr[rax]);
    vpaddq(Ymm(8) | k5, Ymm(8), ptr[rax]);
    mov(rax, addr3);
    vpaddq(Ymm(17) | k6, Ymm(10), ptr[rax]);
    mov(rax, addr4);
    vpaddq(Ymm(18) | k7, Ymm(18), ptr[rax]);

    vpaddq(Zmm(12) | k1, Zmm(10), ptr[rax]);
    vpaddq(Zmm(13) | k2, Zmm(13), ptr[rax]);
    vpaddq(Zmm(14) | k3, Zmm(18), ptr[rax]);
    mov(rax, addr5);
    vpaddq(Zmm(19) | k4, Zmm(10), ptr[rax]);
    mov(rax, addr6);
    vpaddq(Zmm(20) | k5, Zmm(20), ptr[rax]);
