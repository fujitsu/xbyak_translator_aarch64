...
public:
  ...
  void genJitTestCode() {
    ...
    vgatherqps(Ymm(1) | k1, ptr[rax + Zmm(21)]);
    vgatherqps(Ymm(2) | k2, ptr[rax + Zmm(21)]);
    vgatherqps(Ymm(3) | k3, ptr[rax + Zmm(21)]);
    vgatherqps(Ymm(4) | k4, ptr[rax + Zmm(21)]);
    vgatherqps(Ymm(5) | k5, ptr[rax + Zmm(21)]);
    vgatherqps(Ymm(6) | k6, ptr[rax + Zmm(21)]);
    vgatherqps(Ymm(7) | k7, ptr[rax + Zmm(21)]);
