...
public:
  ...
  void genJitTestCode() {
    ...
    /* VEX encode */
    vfmadd231ps(Ymm(0) | k1, Ymm(1), ptr[rax]);
    vfmadd231ps(Ymm(3) | k2, Ymm(3), ptr[rax]);
    vfmadd231ps(Ymm(5) | k3, Ymm(6), ptr[rax]);
    vfmadd231ps(Ymm(7) | k4, Ymm(8), ptr[rax]);
    vfmadd231ps(Ymm(9) | k5, Ymm(9), ptr[rax]);

    /* EVEX encode */
    vfmadd231ps(Ymm(10) | k1, Ymm(11), ptr[rax]);
    vfmadd231ps(Ymm(13) | k2, Ymm(13), ptr[rax]);
    vfmadd231ps(Ymm(15) | k3, Ymm(16), ptr[rax]);
    vfmadd231ps(Ymm(17) | k4, Ymm(18), ptr[rax]);
    vfmadd231ps(Ymm(19) | k5, Ymm(19), ptr[rax]);
