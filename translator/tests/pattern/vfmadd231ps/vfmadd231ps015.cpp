...
public:
  ...
  void genJitTestCode() {
    ...
    /* VEX encode */
    vfmadd231ps(Zmm(0) | k1 | T_z, Zmm(1), ptr[rax]);
    vfmadd231ps(Zmm(3) | k2 | T_z, Zmm(3), ptr[rax]);
    vfmadd231ps(Zmm(5) | k3 | T_z, Zmm(6), ptr[rax]);
    vfmadd231ps(Zmm(7) | k4 | T_z, Zmm(8), ptr[rax]);
    vfmadd231ps(Zmm(9) | k5 | T_z, Zmm(9), ptr[rax]);

    /* EVEX encode */
    vfmadd231ps(Zmm(10) | k1 | T_z, Zmm(11), ptr[rax]);
    vfmadd231ps(Zmm(13) | k2 | T_z, Zmm(13), ptr[rax]);
    vfmadd231ps(Zmm(15) | k3 | T_z, Zmm(16), ptr[rax]);
    vfmadd231ps(Zmm(17) | k4 | T_z, Zmm(18), ptr[rax]);
    vfmadd231ps(Zmm(19) | k5 | T_z, Zmm(19), ptr[rax]);
