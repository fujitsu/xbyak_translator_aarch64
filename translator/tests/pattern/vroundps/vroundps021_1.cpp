...
public:
  ...
  void genJitTestCode() {
    ...
    vroundps(Ymm(0), Ymm(0), rounding_direction);
    vroundps(Ymm(1), Ymm(1), rounding_direction);
    vroundps(Ymm(2), Ymm(2), rounding_direction);
    vroundps(Ymm(3), Ymm(3), rounding_direction);
    vroundps(Ymm(4), Ymm(4), rounding_direction);
    vroundps(Ymm(5), Ymm(5), rounding_direction);
    vroundps(Ymm(6), Ymm(6), rounding_direction);
    vroundps(Ymm(7), Ymm(7), rounding_direction);
  }
};
