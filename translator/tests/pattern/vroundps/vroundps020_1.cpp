...
public:
  ...
  void genJitTestCode() {
    ...
    vroundps(Ymm(8), Ymm(0), rounding_direction);
    vroundps(Ymm(9), Ymm(1), rounding_direction);
    vroundps(Ymm(10), Ymm(2), rounding_direction);
    vroundps(Ymm(11), Ymm(3), rounding_direction);
    vroundps(Ymm(12), Ymm(4), rounding_direction);
    vroundps(Ymm(13), Ymm(5), rounding_direction);
    vroundps(Ymm(14), Ymm(6), rounding_direction);
    vroundps(Ymm(15), Ymm(7), rounding_direction);
  }
};
