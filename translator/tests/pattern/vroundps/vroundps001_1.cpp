...
public:
  ...
  void genJitTestCode() {
    ...
    vroundps(Xmm(0), Xmm(0), rounding_direction);
    vroundps(Xmm(1), Xmm(1), rounding_direction);
    vroundps(Xmm(2), Xmm(2), rounding_direction);
    vroundps(Xmm(3), Xmm(3), rounding_direction);
    vroundps(Xmm(4), Xmm(4), rounding_direction);
    vroundps(Xmm(5), Xmm(5), rounding_direction);
    vroundps(Xmm(6), Xmm(6), rounding_direction);
    vroundps(Xmm(7), Xmm(7), rounding_direction);
  }
};
