...
public:
  ...
  void genJitTestCode() {
    ...
    mov(rax, addr);
    vroundps(Ymm(8), ptr[rax + 64 * 0], rounding_direction);
    vroundps(Ymm(9), ptr[rax + 64 * 1], rounding_direction);
    vroundps(Ymm(10), ptr[rax + 64 * 2], rounding_direction);
    vroundps(Ymm(11), ptr[rax + 64 * 3], rounding_direction);
    vroundps(Ymm(12), ptr[rax + 64 * 4], rounding_direction);
    vroundps(Ymm(13), ptr[rax + 64 * 5], rounding_direction);
    vroundps(Ymm(14), ptr[rax + 64 * 6], rounding_direction);
    vroundps(Ymm(15), ptr[rax + 64 * 7], rounding_direction);
