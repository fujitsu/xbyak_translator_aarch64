...
public:
  ...
  void genJitTestCode() {
    ...
    /* z31 - z29 are used as zTmpIdx - zTmp3Idx */
    vpermw(Zmm(1) | k1 | T_z, Zmm(30), Zmm(31));
    vpermw(Zmm(2) | k2 | T_z, Zmm(30), Zmm(30));
    vpermw(Zmm(3) | k3 | T_z, Zmm(3), Zmm(31));
    vpermw(Zmm(4) | k4 | T_z, Zmm(30), Zmm(4));
    vpermw(Zmm(5) | k5 | T_z, Zmm(5), Zmm(5));
    vpermw(Zmm(6) | k6 | T_z, Zmm(30), Zmm(31));
    vpermw(Zmm(7) | k7 | T_z, Zmm(30), Zmm(31));
  }
};
