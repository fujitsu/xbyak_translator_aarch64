...
public:
  ...
  void genJitTestCode() {
    ...
    /* z31 - z29 are used as zTmpIdx - zTmp3Idx */
    vpermw(Xmm(1) | k1 | T_z, Xmm(30), Xmm(31));
    vpermw(Xmm(2) | k2 | T_z, Xmm(30), Xmm(30));
    vpermw(Xmm(3) | k3 | T_z, Xmm(3), Xmm(31));
    vpermw(Xmm(4) | k4 | T_z, Xmm(30), Xmm(4));
    vpermw(Xmm(5) | k5 | T_z, Xmm(5), Xmm(5));
    vpermw(Xmm(6) | k6 | T_z, Xmm(30), Xmm(31));
    vpermw(Xmm(7) | k7 | T_z, Xmm(30), Xmm(31));
  }
};
