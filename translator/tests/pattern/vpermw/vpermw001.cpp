...
public:
  ...
  void genJitTestCode() {
    ...
    /* z31 - z29 are used as zTmpIdx - zTmp3Idx */
    vpermw(Zmm(0), Zmm(8), ptr[rcx]);
    vpermw(Zmm(1), Zmm(9), ptr[rcx]);
    vpermw(Zmm(2), Zmm(10), ptr[rcx]);
    vpermw(Zmm(3), Zmm(11), ptr[rcx]);

    vpermw(Zmm(29), Zmm(8), ptr[rcx]);
    vpermw(Zmm(30), Zmm(9), ptr[rcx]);
    vpermw(Zmm(31), Zmm(10), ptr[rcx]);
