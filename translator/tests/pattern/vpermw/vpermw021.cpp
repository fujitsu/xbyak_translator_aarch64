...
public:
  ...
  void genJitTestCode() {
    ...
    /* z31 - z29 are used as zTmpIdx - zTmp3Idx */
    vpermw(Ymm(0), Ymm(8), ptr[rcx]);
    vpermw(Ymm(1), Ymm(9), ptr[rcx]);
    vpermw(Ymm(2), Ymm(10), ptr[rcx]);
    vpermw(Ymm(3), Ymm(11), ptr[rcx]);

    vpermw(Ymm(29), Ymm(8), ptr[rcx]);
    vpermw(Ymm(30), Ymm(9), ptr[rcx]);
    vpermw(Ymm(31), Ymm(10), ptr[rcx]);
