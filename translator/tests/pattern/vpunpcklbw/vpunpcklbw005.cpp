...
public:
  ...
  void genJitTestCode() {
    ...
    vpunpcklbw(Xmm(2) | k2, Xmm(30), Xmm(31));
    vpunpcklbw(Xmm(3) | k3, Xmm(30), Xmm(31));
    vpunpcklbw(Xmm(4) | k4, Xmm(30), Xmm(31));
    vpunpcklbw(Xmm(5) | k5, Xmm(30), Xmm(31));
    ...
    */
    vpunpcklbw(Xmm(22) | k1, Xmm(22), Xmm(22));
    vpunpcklbw(Xmm(23) | k2, Xmm(23), Xmm(23));
    vpunpcklbw(Xmm(24) | k3, Xmm(24), Xmm(24));
    vpunpcklbw(Xmm(25) | k4, Xmm(25), Xmm(25));
