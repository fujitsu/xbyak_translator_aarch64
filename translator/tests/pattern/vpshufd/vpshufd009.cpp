...
public:
  ...
  void genJitTestCode() {
    ...
    vpshufd(Ymm(1) | k1 | T_z, ptr[rax], sel);
    sel = 0 + (int)(rand() * (255 - 0 + 1.0) / (1.0 + RAND_MAX));
    vpshufd(Ymm(2) | k2 | T_z, ptr[rax], sel);
    sel = 0 + (int)(rand() * (255 - 0 + 1.0) / (1.0 + RAND_MAX));
    vpshufd(Ymm(3) | k3 | T_z, ptr[rax], sel);
    sel = 0 + (int)(rand() * (255 - 0 + 1.0) / (1.0 + RAND_MAX));
    vpshufd(Ymm(4) | k4 | T_z, ptr[rax], sel);
    sel = 0 + (int)(rand() * (255 - 0 + 1.0) / (1.0 + RAND_MAX));
    vpshufd(Ymm(5) | k5 | T_z, ptr[rax], sel);
    sel = 0 + (int)(rand() * (255 - 0 + 1.0) / (1.0 + RAND_MAX));
    vpshufd(Ymm(6) | k6 | T_z, ptr[rax], sel);
    sel = 0 + (int)(rand() * (255 - 0 + 1.0) / (1.0 + RAND_MAX));
    vpshufd(Ymm(7) | k7 | T_z, ptr[rax], sel);

    sel = 0 + (int)(rand() * (255 - 0 + 1.0) / (1.0 + RAND_MAX));
    vpshufd(Ymm(22) | k1 | T_z, ptr[rax], sel);
    sel = 0 + (int)(rand() * (255 - 0 + 1.0) / (1.0 + RAND_MAX));
    vpshufd(Ymm(23) | k2 | T_z, ptr[rax], sel);
    sel = 0 + (int)(rand() * (255 - 0 + 1.0) / (1.0 + RAND_MAX));
    vpshufd(Ymm(24) | k3 | T_z, ptr[rax], sel);
    sel = 0 + (int)(rand() * (255 - 0 + 1.0) / (1.0 + RAND_MAX));
    vpshufd(Ymm(25) | k4 | T_z, ptr[rax], sel);
    sel = 0 + (int)(rand() * (255 - 0 + 1.0) / (1.0 + RAND_MAX));
    vpshufd(Ymm(26) | k5 | T_z, ptr[rax], sel);
    sel = 0 + (int)(rand() * (255 - 0 + 1.0) / (1.0 + RAND_MAX));
    vpshufd(Ymm(27) | k6 | T_z, ptr[rax], sel);
    sel = 0 + (int)(rand() * (255 - 0 + 1.0) / (1.0 + RAND_MAX));
    vpshufd(Ymm(28) | k7 | T_z, ptr[rax], sel);
