...
public:
  ...
  void genJitTestCode() {
    ...
    vpshufd(Zmm(1) | k1, ptr[rax], sel);
    sel = 0 + (int)(rand() * (255 - 0 + 1.0) / (1.0 + RAND_MAX));
    vpshufd(Zmm(2) | k2, ptr[rax], sel);
    sel = 0 + (int)(rand() * (255 - 0 + 1.0) / (1.0 + RAND_MAX));
    vpshufd(Zmm(3) | k3, ptr[rax], sel);
    sel = 0 + (int)(rand() * (255 - 0 + 1.0) / (1.0 + RAND_MAX));
    vpshufd(Zmm(4) | k4, ptr[rax], sel);
    sel = 0 + (int)(rand() * (255 - 0 + 1.0) / (1.0 + RAND_MAX));
    vpshufd(Zmm(5) | k5, ptr[rax], sel);
    sel = 0 + (int)(rand() * (255 - 0 + 1.0) / (1.0 + RAND_MAX));
    vpshufd(Zmm(6) | k6, ptr[rax], sel);
    sel = 0 + (int)(rand() * (255 - 0 + 1.0) / (1.0 + RAND_MAX));
    vpshufd(Zmm(7) | k7, ptr[rax], sel);

    sel = 0 + (int)(rand() * (255 - 0 + 1.0) / (1.0 + RAND_MAX));
    vpshufd(Zmm(22) | k1, ptr[rax], sel);
    sel = 0 + (int)(rand() * (255 - 0 + 1.0) / (1.0 + RAND_MAX));
    vpshufd(Zmm(23) | k2, ptr[rax], sel);
    sel = 0 + (int)(rand() * (255 - 0 + 1.0) / (1.0 + RAND_MAX));
    vpshufd(Zmm(24) | k3, ptr[rax], sel);
    sel = 0 + (int)(rand() * (255 - 0 + 1.0) / (1.0 + RAND_MAX));
    vpshufd(Zmm(25) | k4, ptr[rax], sel);
    sel = 0 + (int)(rand() * (255 - 0 + 1.0) / (1.0 + RAND_MAX));
    vpshufd(Zmm(26) | k5, ptr[rax], sel);
    sel = 0 + (int)(rand() * (255 - 0 + 1.0) / (1.0 + RAND_MAX));
    vpshufd(Zmm(27) | k6, ptr[rax], sel);
    sel = 0 + (int)(rand() * (255 - 0 + 1.0) / (1.0 + RAND_MAX));
    vpshufd(Zmm(28) | k7, ptr[rax], sel);
