...
public:
  ...
  void genJitTestCode() {
    ...
    vpshufd(Ymm(1) | k1 | T_z, Ymm(30), sel);
    sel = 0 + (int)(rand() * (255 - 0 + 1.0) / (1.0 + RAND_MAX));
    vpshufd(Ymm(2) | k2 | T_z, Ymm(30), sel);
    sel = 0 + (int)(rand() * (255 - 0 + 1.0) / (1.0 + RAND_MAX));
    ...
    sel = 0 + (int)(rand() * (255 - 0 + 1.0) / (1.0 + RAND_MAX));
    vpshufd(Ymm(26) | k5 | T_z, Ymm(26), sel);
    sel = 0 + (int)(rand() * (255 - 0 + 1.0) / (1.0 + RAND_MAX));
    vpshufd(Ymm(27) | k6 | T_z, Ymm(27), sel);
    sel = 0 + (int)(rand() * (255 - 0 + 1.0) / (1.0 + RAND_MAX));
    vpshufd(Ymm(28) | k7 | T_z, Ymm(28), sel);
  }
};
