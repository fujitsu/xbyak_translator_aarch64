...
public:
  ...
  void genJitTestCode() {
    ...
    /*
    vpunpckhbw(Zmm(8) | k1 | T_z, Zmm(8), Zmm(31));
    vpunpckhbw(Zmm(9) | k2 | T_z, Zmm(9), Zmm(31));
    vpunpckhbw(Zmm(10) | k3 | T_z, Zmm(10), Zmm(31));
    vpunpckhbw(Zmm(11) | k4 | T_z, Zmm(11), Zmm(31));
    vpunpckhbw(Zmm(12) | k5 | T_z, Zmm(12), Zmm(31));
    vpunpckhbw(Zmm(13) | k6 | T_z, Zmm(13), Zmm(31));
    vpunpckhbw(Zmm(14) | k7 | T_z, Zmm(14), Zmm(31));

    vpunpckhbw(Zmm(15) | k1 | T_z, Zmm(30), Zmm(15));
    vpunpckhbw(Zmm(16) | k2 | T_z, Zmm(30), Zmm(16));
    vpunpckhbw(Zmm(17) | k3 | T_z, Zmm(30), Zmm(17));
    vpunpckhbw(Zmm(18) | k4 | T_z, Zmm(30), Zmm(18));
    vpunpckhbw(Zmm(19) | k5 | T_z, Zmm(30), Zmm(19));
