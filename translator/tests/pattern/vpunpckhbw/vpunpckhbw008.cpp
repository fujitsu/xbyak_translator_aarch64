...
public:
  ...
  void genJitTestCode() {
    ...
    vpunpckhbw(Xmm(0) | k1 | T_z, Xmm(1), ptr[rax]);
    vpunpckhbw(Xmm(2) | k2 | T_z, Xmm(2), ptr[rax]);

    vpunpckhbw(Ymm(3) | k3 | T_z, Ymm(4), ptr[rax]);
    vpunpckhbw(Ymm(5) | k4 | T_z, Ymm(5), ptr[rax]);

    vpunpckhbw(Zmm(6) | k5 | T_z, Zmm(7), ptr[rax]);
    vpunpckhbw(Zmm(8) | k6 | T_z, Zmm(8), ptr[rax]);

    vpunpckhbw(Xmm(20) | k7 | T_z, Xmm(21), ptr[rax]);
    vpunpckhbw(Xmm(22) | k1 | T_z, Xmm(22), ptr[rax]);

    vpunpckhbw(Ymm(23) | k2 | T_z, Ymm(24), ptr[rax]);
    vpunpckhbw(Ymm(25) | k3 | T_z, Ymm(25), ptr[rax]);
