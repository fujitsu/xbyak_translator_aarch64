...
public:
  ...
  void genJitTestCode() {
    ...
    vpunpckhbw(Xmm(0) | k1, Xmm(1), ptr[rax]);
    vpunpckhbw(Xmm(2) | k2, Xmm(2), ptr[rax]);

    vpunpckhbw(Ymm(3) | k3, Ymm(4), ptr[rax]);
    vpunpckhbw(Ymm(5) | k4, Ymm(5), ptr[rax]);

    vpunpckhbw(Zmm(6) | k5, Zmm(7), ptr[rax]);
    vpunpckhbw(Zmm(8) | k6, Zmm(8), ptr[rax]);

    vpunpckhbw(Xmm(20) | k7, Xmm(21), ptr[rax]);
    vpunpckhbw(Xmm(22) | k1, Xmm(22), ptr[rax]);

    vpunpckhbw(Ymm(23) | k2, Ymm(24), ptr[rax]);
    vpunpckhbw(Ymm(25) | k3, Ymm(25), ptr[rax]);
