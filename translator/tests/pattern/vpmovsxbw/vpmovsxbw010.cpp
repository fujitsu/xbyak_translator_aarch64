...
public:
  ...
  void genJitTestCode() {
    ...
    vpmovsxbw(Xmm(1) | k1, Xmm(0));
    vpmovsxbw(Xmm(2) | k2, Xmm(0));
    vpmovsxbw(Xmm(3) | k3, Xmm(0));
    vpmovsxbw(Xmm(4) | k4, Xmm(0));
    vpmovsxbw(Xmm(5) | k5, Xmm(0));
    vpmovsxbw(Xmm(6) | k6, Xmm(0));
    vpmovsxbw(Xmm(7) | k7, Xmm(0));
    vpmovsxbw(Xmm(8) | k7, Xmm(8)); /* dstIdx = srcIdx */

    /* Register index is EVEX range. */
    vpmovsxbw(Xmm(21) | k1, Xmm(20));
    vpmovsxbw(Xmm(22) | k2, Xmm(20));
    vpmovsxbw(Xmm(23) | k3, Xmm(20));
    vpmovsxbw(Xmm(24) | k4, Xmm(20));
    vpmovsxbw(Xmm(25) | k5, Xmm(20));
    vpmovsxbw(Xmm(26) | k6, Xmm(20));
    vpmovsxbw(Xmm(27) | k7, Xmm(20));
    vpmovsxbw(Xmm(28) | k7, Xmm(28)); /* dstIdx = srcIdx */
  }
};
