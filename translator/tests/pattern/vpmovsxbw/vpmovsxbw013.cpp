...
public:
  ...
  void genJitTestCode() {
    ...
    vpmovsxbw(Xmm(1) | k1 | T_z, ptr[rax]);
    vpmovsxbw(Xmm(2) | k2 | T_z, ptr[rax]);
    vpmovsxbw(Xmm(3) | k3 | T_z, ptr[rax]);
    vpmovsxbw(Xmm(4) | k4 | T_z, ptr[rax]);
    vpmovsxbw(Xmm(5) | k5 | T_z, ptr[rax]);
    vpmovsxbw(Xmm(6) | k6 | T_z, ptr[rax]);
    vpmovsxbw(Xmm(7) | k7 | T_z, ptr[rax]);

    /* Register index is EVEX range. */
    vpmovsxbw(Xmm(21) | k1 | T_z, ptr[rcx]);
    vpmovsxbw(Xmm(22) | k2 | T_z, ptr[rcx]);
    vpmovsxbw(Xmm(23) | k3 | T_z, ptr[rcx]);
    vpmovsxbw(Xmm(24) | k4 | T_z, ptr[rcx]);
    vpmovsxbw(Xmm(25) | k5 | T_z, ptr[rcx]);
    vpmovsxbw(Xmm(26) | k6 | T_z, ptr[rcx]);
    vpmovsxbw(Xmm(27) | k7 | T_z, ptr[rcx]);
