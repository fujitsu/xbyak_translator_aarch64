...
public:
  ...
  void genJitTestCode() {
    ...
    vpmovsxbw(Zmm(1) | k1 | T_z, ptr[rax]);
    vpmovsxbw(Zmm(2) | k2 | T_z, ptr[rax]);
    vpmovsxbw(Zmm(3) | k3 | T_z, ptr[rax]);
    vpmovsxbw(Zmm(4) | k4 | T_z, ptr[rax]);
    vpmovsxbw(Zmm(5) | k5 | T_z, ptr[rax]);
    vpmovsxbw(Zmm(6) | k6 | T_z, ptr[rax]);
    vpmovsxbw(Zmm(7) | k7 | T_z, ptr[rax]);

    /* Register index is EVEX range. */
    vpmovsxbw(Zmm(21) | k1 | T_z, ptr[rcx]);
    vpmovsxbw(Zmm(22) | k2 | T_z, ptr[rcx]);
    vpmovsxbw(Zmm(23) | k3 | T_z, ptr[rcx]);
    vpmovsxbw(Zmm(24) | k4 | T_z, ptr[rcx]);
    vpmovsxbw(Zmm(25) | k5 | T_z, ptr[rcx]);
    vpmovsxbw(Zmm(26) | k6 | T_z, ptr[rcx]);
    vpmovsxbw(Zmm(27) | k7 | T_z, ptr[rcx]);
