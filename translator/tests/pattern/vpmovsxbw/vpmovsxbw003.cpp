...
public:
  ...
  void genJitTestCode() {
    ...
    vpmovsxbw(Zmm(1) | k1, ptr[rax]);
    vpmovsxbw(Zmm(2) | k2, ptr[rax]);
    vpmovsxbw(Zmm(3) | k3, ptr[rax]);
    vpmovsxbw(Zmm(4) | k4, ptr[rax]);
    vpmovsxbw(Zmm(5) | k5, ptr[rax]);
    vpmovsxbw(Zmm(6) | k6, ptr[rax]);
    vpmovsxbw(Zmm(7) | k7, ptr[rax]);

    /* Register index is EVEX range. */
    vpmovsxbw(Zmm(21) | k1, ptr[rcx]);
    vpmovsxbw(Zmm(22) | k2, ptr[rcx]);
    vpmovsxbw(Zmm(23) | k3, ptr[rcx]);
    vpmovsxbw(Zmm(24) | k4, ptr[rcx]);
    vpmovsxbw(Zmm(25) | k5, ptr[rcx]);
    vpmovsxbw(Zmm(26) | k6, ptr[rcx]);
    vpmovsxbw(Zmm(27) | k7, ptr[rcx]);
