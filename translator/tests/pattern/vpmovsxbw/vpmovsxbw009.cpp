...
public:
  ...
  void genJitTestCode() {
    ...
    vpmovsxbw(Ymm(1) | k1 | T_z, ptr[rax]);
    vpmovsxbw(Ymm(2) | k2 | T_z, ptr[rax]);
    vpmovsxbw(Ymm(3) | k3 | T_z, ptr[rax]);
    vpmovsxbw(Ymm(4) | k4 | T_z, ptr[rax]);
    vpmovsxbw(Ymm(5) | k5 | T_z, ptr[rax]);
    vpmovsxbw(Ymm(6) | k6 | T_z, ptr[rax]);
    vpmovsxbw(Ymm(7) | k7 | T_z, ptr[rax]);

    /* Register index is EVEX range. */
    vpmovsxbw(Ymm(21) | k1 | T_z, ptr[rcx]);
    vpmovsxbw(Ymm(22) | k2 | T_z, ptr[rcx]);
    vpmovsxbw(Ymm(23) | k3 | T_z, ptr[rcx]);
    vpmovsxbw(Ymm(24) | k4 | T_z, ptr[rcx]);
    vpmovsxbw(Ymm(25) | k5 | T_z, ptr[rcx]);
    vpmovsxbw(Ymm(26) | k6 | T_z, ptr[rcx]);
    vpmovsxbw(Ymm(27) | k7 | T_z, ptr[rcx]);
