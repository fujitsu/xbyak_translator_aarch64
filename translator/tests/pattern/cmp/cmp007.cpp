...
public:
  void setInitialRegValue() {
    ...
    inputZReg[31].sd_dt[0] = std::numeric_limits<int32_t>::max();
    inputZReg[31].sd_dt[1] = std::numeric_limits<int32_t>::min();
    inputZReg[31].sd_dt[2] = 0;
    inputZReg[31].ud_dt[3] = std::numeric_limits<uint32_t>::max();
    inputZReg[31].ud_dt[4] = std::numeric_limits<uint32_t>::min();
  }
