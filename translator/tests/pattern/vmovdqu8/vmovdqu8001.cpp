...
public:
  ...
  void genJitTestCode() {
    ...
    mov(rax, addr);
    mov(rbx, addr);
    vmovdqu8(Zmm(8), ptr[rax]);
    vmovdqu8(ptr[rbx], Zmm(8));
    ...
    vmovdqu8(ptr[rbx], Xmm(4));
    vmovdqu8(Xmm(5), ptr[rbx]);
#endif
    ...
    mov(rax, addr);
    mov(rbx, addr);
    vmovdqu8(Ymm(6), ptr[rax]);
    vmovdqu8(ptr[rbx], Ymm(6));
    vmovdqu8(Ymm(7), ptr[rbx]);
#endif
