...
public:
  ...
  void genJitTestCode() {
    ...
    vcmpps(k1 | k6, Ymm(0), Ymm(1), 0);   // EQ_OQ
    vcmpps(k2 | k6, Ymm(2), Ymm(3), 0);   // EQ_OQ
    vcmpps(k3 | k6, Ymm(4), Ymm(5), 0);   // EQ_OQ
    vcmpps(k7 | k6, Ymm(31), Ymm(31), 0); // EQ_OQ

    vcmpps(k6 | k6, Ymm(6), Ymm(7), 0); // EQ_OQ
    vcmpps(k5 | k5, Ymm(8), Ymm(8), 0); // EQ_OQ
  }
};
