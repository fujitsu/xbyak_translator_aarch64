...
public:
  ...
  void genJitTestCode() {
    ...
    vcmpps(k1 | k6, Ymm(0), ptr[rax], 0);  // EQ_OQ
    vcmpps(k2 | k6, Ymm(2), ptr[rcx], 0);  // EQ_OQ
    vcmpps(k3 | k6, Ymm(4), ptr[rdx], 0);  // EQ_OQ
    vcmpps(k7 | k6, Ymm(31), ptr[rbx], 0); // EQ_OQ

    vcmpps(k6 | k6, Ymm(6), ptr[rbp], 0); // EQ_OQ
    vcmpps(k5 | k5, Ymm(8), ptr[rsi], 0); // EQ_OQ
