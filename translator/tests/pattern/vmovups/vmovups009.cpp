...
public:
  ...
  void genJitTestCode() {
    ...
    vmovups(Ymm(1) | k1 | T_z, ptr[rax]);
    vmovups(Ymm(2) | k2 | T_z, ptr[rax]);
    vmovups(Ymm(3) | k3 | T_z, ptr[rax]);
    vmovups(Ymm(4) | k4 | T_z, ptr[rax]);
    vmovups(Ymm(5) | k5 | T_z, ptr[rax]);
    vmovups(Ymm(6) | k6 | T_z, ptr[rax]);
    vmovups(Ymm(7) | k7 | T_z, ptr[rax]);
