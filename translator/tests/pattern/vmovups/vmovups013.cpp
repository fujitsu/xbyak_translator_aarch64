...
public:
  ...
  void genJitTestCode() {
    ...
    vmovups(Zmm(1) |k1 , ptr[rax]);
    vmovups(Zmm(2) |k2 , ptr[rax]);
    vmovups(Zmm(3) |k3 , ptr[rax]);
    vmovups(Zmm(4) |k4 , ptr[rax]);
    vmovups(Zmm(5) |k5 , ptr[rax]);
    vmovups(Zmm(6) |k6 , ptr[rax]);
    vmovups(Zmm(7) |k7 , ptr[rax]);
