...
public:
  ...
  void genJitTestCode() {
    ...
    vmovups(Xmm(0), Xmm(31) | k1 | T_z);
    vmovups(Xmm(1), Xmm(31) | k2 | T_z);
    vmovups(Xmm(2), Xmm(31) | k3 | T_z);
    vmovups(Xmm(3), Xmm(31) | k4 | T_z);
    vmovups(Xmm(4), Xmm(31) | k5 | T_z);
    vmovups(Xmm(5), Xmm(31) | k6 | T_z);
    vmovups(Xmm(6), Xmm(31) | k7 | T_z);

    vmovups(Xmm(30) | k7 | T_z, Xmm(31));
    vmovups(Xmm(31), Xmm(31) | k7 | T_z);
  }
};
