...
public:
  ...
  void genJitTestCode() {
    ...
    vmovups(Xmm(1) | k1 | T_z, ptr[rax]);
    vmovups(Xmm(2) | k2 | T_z, ptr[rax]);
    vmovups(Xmm(3) | k3 | T_z, ptr[rax]);
    vmovups(Xmm(4) | k4 | T_z, ptr[rax]);
    vmovups(Xmm(5) | k5 | T_z, ptr[rax]);
    vmovups(Xmm(6) | k6 | T_z, ptr[rax]);
    vmovups(Xmm(7) | k7 | T_z, ptr[rax]);
