...
public:
  ...
  void genJitTestCode() {
    ...
    vmovups(Ymm(0), Ymm(27) | k1 | T_z);
    vmovups(Ymm(1), Ymm(27) | k2 | T_z);
    vmovups(Ymm(2), Ymm(27) | k3 | T_z);
    vmovups(Ymm(3), Ymm(27) | k4 | T_z);
    vmovups(Ymm(4), Ymm(27) | k5 | T_z);
    vmovups(Ymm(5), Ymm(27) | k6 | T_z);
    vmovups(Ymm(6), Ymm(27) | k7 | T_z);

    vmovups(Ymm(30) | k7 | T_z, Ymm(27));
    vmovups(Ymm(27), Ymm(27) | k7 | T_z);
  }
};
