...
public:
  ...
  void genJitTestCode() {
    ...
    vextractf64x4(Ymm(0), Zmm(31), 0);
    vextractf64x4(Ymm(1), Zmm(31), 1);
    vextractf64x4(Ymm(2), Zmm(31), 0);
    vextractf64x4(Ymm(3), Zmm(31), 1);
    vextractf64x4(Ymm(4), Zmm(4), 0);
    vextractf64x4(Ymm(5), Zmm(5), 1);

    // vextractf64x4(Ymm(6), Zmm(31), 0 + 256);
    vextractf64x4(Ymm(6), Zmm(31), uint8(0 + 256));
    // vextractf64x4(Ymm(7), Zmm(31), 1 + 256);
    vextractf64x4(Ymm(7), Zmm(31), uint8(1 + 256));
