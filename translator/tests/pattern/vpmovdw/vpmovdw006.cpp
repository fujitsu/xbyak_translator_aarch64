...
/* Address is aligned */
    ...
    mov(rbx, addr);
    vpmovdw(ptr[rbx], Ymm(1)); // truncate
    vmovdqu8(Zmm(0), ptr[rbx]);
    mov(rbx, addr1);
    vpmovdw(ptr[rbx], Ymm(3)); // no truncate
    vmovdqu8(Zmm(2), ptr[rbx]);
    mov(rbx, addr2);
    vpmovdw(ptr[rbx], Ymm(5)); // random
...
/* Address is unaligned */
    ...
    mov(rbx, addr);
    vpmovdw(ptr[rbx], Ymm(1));
    vmovdqu8(Zmm(7), ptr[rbx]);
    mov(rbx, addr1);
    vpmovdw(ptr[rbx], Ymm(3));
    vmovdqu8(Zmm(9), ptr[rbx]);
    mov(rbx, addr2);
    vpmovdw(ptr[rbx], Ymm(5));
