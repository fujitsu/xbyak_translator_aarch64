...
public:
  ...
  void genJitTestCode() {
    ...
    vpbroadcastq(Xmm(6) | k7, Xmm(25));
    vpbroadcastq(Ymm(7) | k7, Xmm(24));
    vpbroadcastq(Zmm(8) | k7, Xmm(23));
    vpbroadcastq(Xmm(9) | k1, r8);
    vpbroadcastq(Ymm(10) | k1, r9);
    vpbroadcastq(Zmm(11) | k1, r10);
    vpbroadcastq(Xmm(12) | k4, r8);
    vpbroadcastq(Ymm(13) | k2, r9);
    vpbroadcastq(Zmm(14) | k3, r10);
    vpbroadcastq(Xmm(15) | k7, r8);
    vpbroadcastq(Ymm(16) | k7, r9);
    vpbroadcastq(Zmm(17) | k7, r10);
