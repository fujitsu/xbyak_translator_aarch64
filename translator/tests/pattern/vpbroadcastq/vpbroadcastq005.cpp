...
public:
  ...
  void genJitTestCode() {
    ...
    vpbroadcastq(Xmm(0) | k1 | T_z, ptr[rax]);
    vpbroadcastq(Ymm(1) | k1 | T_z, ptr[rax]);
    vpbroadcastq(Zmm(2) | k1 | T_z, ptr[rax]);
    vpbroadcastq(Xmm(3) | k2 | T_z, ptr[rax]);
    vpbroadcastq(Ymm(4) | k3 | T_z, ptr[rax]);
    vpbroadcastq(Zmm(5) | k4 | T_z, ptr[rax]);
    vpbroadcastq(Xmm(6) | k3 | T_z, ptr[rax]);
    vpbroadcastq(Ymm(7) | k4 | T_z, ptr[rax]);
    vpbroadcastq(Zmm(8) | k2 | T_z, ptr[rax]);
    vpbroadcastq(Xmm(9) | k4 | T_z, ptr[rax]);
    vpbroadcastq(Ymm(10) | k2 | T_z, ptr[rax]);
    vpbroadcastq(Zmm(11) | k3 | T_z, ptr[rax]);
    vpbroadcastq(Xmm(12) | k7 | T_z, ptr[rax]);
    vpbroadcastq(Ymm(13) | k7 | T_z, ptr[rax]);
    vpbroadcastq(Zmm(14) | k7 | T_z, ptr[rax]);
