...
public:
  ...
  void genJitTestCode() {
    ...
    vpmovsxwd(Ymm(1) | k1, ptr[rax]);
    vpmovsxwd(Ymm(2) | k2, ptr[rax]);
    vpmovsxwd(Ymm(3) | k3, ptr[rax]);
    vpmovsxwd(Ymm(4) | k4, ptr[rax]);
    vpmovsxwd(Ymm(5) | k5, ptr[rax]);
    vpmovsxwd(Ymm(6) | k6, ptr[rax]);
    vpmovsxwd(Ymm(7) | k7, ptr[rax]);

    /* Register index is EVEX range. */
    vpmovsxwd(Ymm(21) | k1, ptr[rcx]);
    vpmovsxwd(Ymm(22) | k2, ptr[rcx]);
    vpmovsxwd(Ymm(23) | k3, ptr[rcx]);
    vpmovsxwd(Ymm(24) | k4, ptr[rcx]);
    vpmovsxwd(Ymm(25) | k5, ptr[rcx]);
    vpmovsxwd(Ymm(26) | k6, ptr[rcx]);
    vpmovsxwd(Ymm(27) | k7, ptr[rcx]);
