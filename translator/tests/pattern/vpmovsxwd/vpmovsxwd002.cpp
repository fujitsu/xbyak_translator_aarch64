...
public:
  ...
  void genJitTestCode() {
    ...
    vpmovsxwd(Zmm(1) | k1, Xmm(0));
    vpmovsxwd(Zmm(2) | k2, Xmm(0));
    vpmovsxwd(Zmm(3) | k3, Xmm(0));
    vpmovsxwd(Zmm(4) | k4, Xmm(0));
    vpmovsxwd(Zmm(5) | k5, Xmm(0));
    vpmovsxwd(Zmm(6) | k6, Xmm(0));
    vpmovsxwd(Zmm(7) | k7, Xmm(0));
    vpmovsxwd(Zmm(8) | k7, Xmm(8));

    /* Register index is EVEX range. */
    vpmovsxwd(Zmm(21) | k1, Xmm(20));
    vpmovsxwd(Zmm(22) | k2, Xmm(20));
    vpmovsxwd(Zmm(23) | k3, Xmm(20));
    vpmovsxwd(Zmm(24) | k4, Xmm(20));
    vpmovsxwd(Zmm(25) | k5, Xmm(20));
    vpmovsxwd(Zmm(26) | k6, Xmm(20));
    vpmovsxwd(Zmm(27) | k7, Xmm(20));
    vpmovsxwd(Zmm(28) | k7, Xmm(28));
  }
};
