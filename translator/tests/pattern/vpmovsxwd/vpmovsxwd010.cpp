...
public:
  ...
  void genJitTestCode() {
    ...
    vpmovsxwd(Xmm(1) | k1, Xmm(0));
    vpmovsxwd(Xmm(2) | k2, Xmm(0));
    vpmovsxwd(Xmm(3) | k3, Xmm(0));
    vpmovsxwd(Xmm(4) | k4, Xmm(0));
    vpmovsxwd(Xmm(5) | k5, Xmm(0));
    vpmovsxwd(Xmm(6) | k6, Xmm(0));
    vpmovsxwd(Xmm(7) | k7, Xmm(0));
    vpmovsxwd(Xmm(8) | k7, Xmm(8)); /* dstIdx = srcIdx */

    /* Register index is EVEX range. */
    vpmovsxwd(Xmm(21) | k1, Xmm(20));
    vpmovsxwd(Xmm(22) | k2, Xmm(20));
    vpmovsxwd(Xmm(23) | k3, Xmm(20));
    vpmovsxwd(Xmm(24) | k4, Xmm(20));
    vpmovsxwd(Xmm(25) | k5, Xmm(20));
    vpmovsxwd(Xmm(26) | k6, Xmm(20));
    vpmovsxwd(Xmm(27) | k7, Xmm(20));
    vpmovsxwd(Xmm(28) | k7, Xmm(28)); /* dstIdx = srcIdx */
  }
};
