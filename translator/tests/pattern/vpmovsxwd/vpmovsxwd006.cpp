...
public:
  ...
  void genJitTestCode() {
    ...
    vpmovsxwd(Ymm(1) | k1, Xmm(0));
    vpmovsxwd(Ymm(2) | k2, Xmm(0));
    vpmovsxwd(Ymm(3) | k3, Xmm(0));
    vpmovsxwd(Ymm(4) | k4, Xmm(0));
    vpmovsxwd(Ymm(5) | k5, Xmm(0));
    vpmovsxwd(Ymm(6) | k6, Xmm(0));
    vpmovsxwd(Ymm(7) | k7, Xmm(0));
    vpmovsxwd(Ymm(8) | k7, Xmm(8)); /* dstIdx = srcIdx */

    /* Register index is EVEX range. */
    vpmovsxwd(Ymm(21) | k1, Xmm(20));
    vpmovsxwd(Ymm(22) | k2, Xmm(20));
    vpmovsxwd(Ymm(23) | k3, Xmm(20));
    vpmovsxwd(Ymm(24) | k4, Xmm(20));
    vpmovsxwd(Ymm(25) | k5, Xmm(20));
    vpmovsxwd(Ymm(26) | k6, Xmm(20));
    vpmovsxwd(Ymm(27) | k7, Xmm(20));
    vpmovsxwd(Ymm(28) | k7, Xmm(28)); /* dstIdx = srcIdx */
  }
};
