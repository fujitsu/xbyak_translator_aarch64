...
public:
  ...
  void genJitTestCode() {
    ...
    vpmovsxwd(Ymm(1) | k1 | T_z, Xmm(0));
    vpmovsxwd(Ymm(2) | k2 | T_z, Xmm(0));
    vpmovsxwd(Ymm(3) | k3 | T_z, Xmm(0));
    vpmovsxwd(Ymm(4) | k4 | T_z, Xmm(0));
    ...
    vpmovsxwd(Ymm(22) | k2 | T_z, Xmm(20));
    vpmovsxwd(Ymm(23) | k3 | T_z, Xmm(20));
    vpmovsxwd(Ymm(24) | k4 | T_z, Xmm(20));
