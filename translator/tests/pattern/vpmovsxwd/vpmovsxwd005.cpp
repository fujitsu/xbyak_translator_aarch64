...
public:
  ...
  void genJitTestCode() {
    ...
    vpmovsxwd(Zmm(1) | k1 | T_z, ptr[rax]);
    vpmovsxwd(Zmm(2) | k2 | T_z, ptr[rax]);
    vpmovsxwd(Zmm(3) | k3 | T_z, ptr[rax]);
    vpmovsxwd(Zmm(4) | k4 | T_z, ptr[rax]);
    vpmovsxwd(Zmm(5) | k5 | T_z, ptr[rax]);
    vpmovsxwd(Zmm(6) | k6 | T_z, ptr[rax]);
    vpmovsxwd(Zmm(7) | k7 | T_z, ptr[rax]);

    /* Register index is EVEX range. */
    vpmovsxwd(Zmm(21) | k1 | T_z, ptr[rcx]);
    vpmovsxwd(Zmm(22) | k2 | T_z, ptr[rcx]);
    vpmovsxwd(Zmm(23) | k3 | T_z, ptr[rcx]);
    vpmovsxwd(Zmm(24) | k4 | T_z, ptr[rcx]);
    vpmovsxwd(Zmm(25) | k5 | T_z, ptr[rcx]);
    vpmovsxwd(Zmm(26) | k6 | T_z, ptr[rcx]);
    vpmovsxwd(Zmm(27) | k7 | T_z, ptr[rcx]);
