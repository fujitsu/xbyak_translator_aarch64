...
public:
  ...
  void genJitTestCode() {
    ...
    vpmovsxwd(Xmm(1) | k1, ptr[rax]);
    vpmovsxwd(Xmm(2) | k2, ptr[rax]);
    vpmovsxwd(Xmm(3) | k3, ptr[rax]);
    vpmovsxwd(Xmm(4) | k4, ptr[rax]);
    vpmovsxwd(Xmm(5) | k5, ptr[rax]);
    vpmovsxwd(Xmm(6) | k6, ptr[rax]);
    vpmovsxwd(Xmm(7) | k7, ptr[rax]);

    /* Register index is EVEX range. */
    vpmovsxwd(Xmm(21) | k1, ptr[rcx]);
    vpmovsxwd(Xmm(22) | k2, ptr[rcx]);
    vpmovsxwd(Xmm(23) | k3, ptr[rcx]);
    vpmovsxwd(Xmm(24) | k4, ptr[rcx]);
    vpmovsxwd(Xmm(25) | k5, ptr[rcx]);
    vpmovsxwd(Xmm(26) | k6, ptr[rcx]);
    vpmovsxwd(Xmm(27) | k7, ptr[rcx]);
