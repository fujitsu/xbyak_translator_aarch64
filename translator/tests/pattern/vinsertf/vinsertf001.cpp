...
//    inputPReg[31].ud_dt[2] = ~uint64_t(0);
  }
  ...
  void genJitTestCode() {
    ...
    mov(rax, addr);
    vinsertf128(Ymm(1), Ymm(0), ptr[rax], 0);
    vinsertf128(Ymm(3), Ymm(2), ptr[rax], 1);
//    vinsertf128(Ymm(2), Ymm(0), ptr[rax]);
//    vinsert1f28(Zmm(3), Zmm(0), ptr[rax]);
