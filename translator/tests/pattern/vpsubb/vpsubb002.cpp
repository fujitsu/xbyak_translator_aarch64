...
public:
  ...
  void genJitTestCode() {
    ...
    vpsubb(Ymm(0), Ymm(1), ptr[rax]);
    vpsubb(Ymm(2), Ymm(2), ptr[rax]);

    vpsubb(Ymm(20), Ymm(21), ptr[rax]);
    vpsubb(Ymm(22), Ymm(22), ptr[rax]);

    vpsubb(Zmm(3), Zmm(4), ptr[rax]);
    vpsubb(Zmm(5), Zmm(5), ptr[rax]);
