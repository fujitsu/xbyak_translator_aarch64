...
public:
  ...
  void genJitTestCode() {
    ...
    vpunpcklqdq(Zmm(2) | k2 | T_z, Zmm(30), Zmm(31));
    vpunpcklqdq(Zmm(3) | k3 | T_z, Zmm(30), Zmm(31));
    vpunpcklqdq(Zmm(4) | k4 | T_z, Zmm(30), Zmm(31));
    vpunpcklqdq(Zmm(5) | k5 | T_z, Zmm(30), Zmm(31));
    ...
    */
    vpunpcklqdq(Zmm(22) | k1 | T_z, Zmm(22), Zmm(22));
    vpunpcklqdq(Zmm(23) | k2 | T_z, Zmm(23), Zmm(23));
    vpunpcklqdq(Zmm(24) | k3 | T_z, Zmm(24), Zmm(24));
    vpunpcklqdq(Zmm(25) | k4 | T_z, Zmm(25), Zmm(25));
