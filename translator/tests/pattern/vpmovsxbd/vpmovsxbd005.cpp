...
public:
  ...
  void genJitTestCode() {
    ...
    vpmovsxbd(Zmm(1) | k1 | T_z, ptr[rax]);
    vpmovsxbd(Zmm(2) | k2 | T_z, ptr[rax]);
    vpmovsxbd(Zmm(3) | k3 | T_z, ptr[rax]);
    vpmovsxbd(Zmm(4) | k4 | T_z, ptr[rax]);
    vpmovsxbd(Zmm(5) | k5 | T_z, ptr[rax]);
    vpmovsxbd(Zmm(6) | k6 | T_z, ptr[rax]);
    vpmovsxbd(Zmm(7) | k7 | T_z, ptr[rax]);

    /* Register index is EVEX range. */
    vpmovsxbd(Zmm(21) | k1 | T_z, ptr[rcx]);
    vpmovsxbd(Zmm(22) | k2 | T_z, ptr[rcx]);
    vpmovsxbd(Zmm(23) | k3 | T_z, ptr[rcx]);
    vpmovsxbd(Zmm(24) | k4 | T_z, ptr[rcx]);
    vpmovsxbd(Zmm(25) | k5 | T_z, ptr[rcx]);
    vpmovsxbd(Zmm(26) | k6 | T_z, ptr[rcx]);
    vpmovsxbd(Zmm(27) | k7 | T_z, ptr[rcx]);
