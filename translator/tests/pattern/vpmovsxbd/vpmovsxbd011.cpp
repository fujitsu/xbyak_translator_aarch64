...
public:
  ...
  void genJitTestCode() {
    ...
    vpmovsxbd(Xmm(1) | k1, ptr[rax]);
    vpmovsxbd(Xmm(2) | k2, ptr[rax]);
    vpmovsxbd(Xmm(3) | k3, ptr[rax]);
    vpmovsxbd(Xmm(4) | k4, ptr[rax]);
    vpmovsxbd(Xmm(5) | k5, ptr[rax]);
    vpmovsxbd(Xmm(6) | k6, ptr[rax]);
    vpmovsxbd(Xmm(7) | k7, ptr[rax]);

    /* Register index is EVEX range. */
    vpmovsxbd(Xmm(21) | k1, ptr[rcx]);
    vpmovsxbd(Xmm(22) | k2, ptr[rcx]);
    vpmovsxbd(Xmm(23) | k3, ptr[rcx]);
    vpmovsxbd(Xmm(24) | k4, ptr[rcx]);
    vpmovsxbd(Xmm(25) | k5, ptr[rcx]);
    vpmovsxbd(Xmm(26) | k6, ptr[rcx]);
    vpmovsxbd(Xmm(27) | k7, ptr[rcx]);
