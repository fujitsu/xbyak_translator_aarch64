...
public:
  ...
  void genJitTestCode() {
    ...
    vpmovsxbd(Xmm(1) | k1, Xmm(0));
    vpmovsxbd(Xmm(2) | k2, Xmm(0));
    vpmovsxbd(Xmm(3) | k3, Xmm(0));
    vpmovsxbd(Xmm(4) | k4, Xmm(0));
    vpmovsxbd(Xmm(5) | k5, Xmm(0));
    vpmovsxbd(Xmm(6) | k6, Xmm(0));
    vpmovsxbd(Xmm(7) | k7, Xmm(0));
    vpmovsxbd(Xmm(8) | k7, Xmm(8)); /* dstIdx = srcIdx */

    /* Register index is EVEX range. */
    vpmovsxbd(Xmm(21) | k1, Xmm(20));
    vpmovsxbd(Xmm(22) | k2, Xmm(20));
    vpmovsxbd(Xmm(23) | k3, Xmm(20));
    vpmovsxbd(Xmm(24) | k4, Xmm(20));
    vpmovsxbd(Xmm(25) | k5, Xmm(20));
    vpmovsxbd(Xmm(26) | k6, Xmm(20));
    vpmovsxbd(Xmm(27) | k7, Xmm(20));
    vpmovsxbd(Xmm(28) | k7, Xmm(28)); /* dstIdx = srcIdx */
  }
};
