...
public:
  ...
  void genJitTestCode() {
    ...
    vpmovsxbd(Xmm(1) | k1 | T_z, ptr[rax]);
    vpmovsxbd(Xmm(2) | k2 | T_z, ptr[rax]);
    vpmovsxbd(Xmm(3) | k3 | T_z, ptr[rax]);
    vpmovsxbd(Xmm(4) | k4 | T_z, ptr[rax]);
    vpmovsxbd(Xmm(5) | k5 | T_z, ptr[rax]);
    vpmovsxbd(Xmm(6) | k6 | T_z, ptr[rax]);
    vpmovsxbd(Xmm(7) | k7 | T_z, ptr[rax]);

    /* Register index is EVEX range. */
    vpmovsxbd(Xmm(21) | k1 | T_z, ptr[rcx]);
    vpmovsxbd(Xmm(22) | k2 | T_z, ptr[rcx]);
    vpmovsxbd(Xmm(23) | k3 | T_z, ptr[rcx]);
    vpmovsxbd(Xmm(24) | k4 | T_z, ptr[rcx]);
    vpmovsxbd(Xmm(25) | k5 | T_z, ptr[rcx]);
    vpmovsxbd(Xmm(26) | k6 | T_z, ptr[rcx]);
    vpmovsxbd(Xmm(27) | k7 | T_z, ptr[rcx]);
