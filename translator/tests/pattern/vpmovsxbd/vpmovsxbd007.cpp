...
public:
  ...
  void genJitTestCode() {
    ...
    vpmovsxbd(Ymm(1) | k1, ptr[rax]);
    vpmovsxbd(Ymm(2) | k2, ptr[rax]);
    vpmovsxbd(Ymm(3) | k3, ptr[rax]);
    vpmovsxbd(Ymm(4) | k4, ptr[rax]);
    vpmovsxbd(Ymm(5) | k5, ptr[rax]);
    vpmovsxbd(Ymm(6) | k6, ptr[rax]);
    vpmovsxbd(Ymm(7) | k7, ptr[rax]);

    /* Register index is EVEX range. */
    vpmovsxbd(Ymm(21) | k1, ptr[rcx]);
    vpmovsxbd(Ymm(22) | k2, ptr[rcx]);
    vpmovsxbd(Ymm(23) | k3, ptr[rcx]);
    vpmovsxbd(Ymm(24) | k4, ptr[rcx]);
    vpmovsxbd(Ymm(25) | k5, ptr[rcx]);
    vpmovsxbd(Ymm(26) | k6, ptr[rcx]);
    vpmovsxbd(Ymm(27) | k7, ptr[rcx]);
