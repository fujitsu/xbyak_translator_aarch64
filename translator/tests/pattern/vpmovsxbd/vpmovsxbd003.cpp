...
public:
  ...
  void genJitTestCode() {
    ...
    vpmovsxbd(Zmm(1) | k1, ptr[rax]);
    vpmovsxbd(Zmm(2) | k2, ptr[rax]);
    vpmovsxbd(Zmm(3) | k3, ptr[rax]);
    vpmovsxbd(Zmm(4) | k4, ptr[rax]);
    vpmovsxbd(Zmm(5) | k5, ptr[rax]);
    vpmovsxbd(Zmm(6) | k6, ptr[rax]);
    vpmovsxbd(Zmm(7) | k7, ptr[rax]);

    /* Register index is EVEX range. */
    vpmovsxbd(Zmm(21) | k1, ptr[rcx]);
    vpmovsxbd(Zmm(22) | k2, ptr[rcx]);
    vpmovsxbd(Zmm(23) | k3, ptr[rcx]);
    vpmovsxbd(Zmm(24) | k4, ptr[rcx]);
    vpmovsxbd(Zmm(25) | k5, ptr[rcx]);
    vpmovsxbd(Zmm(26) | k6, ptr[rcx]);
    vpmovsxbd(Zmm(27) | k7, ptr[rcx]);
