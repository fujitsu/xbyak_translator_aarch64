...
public:
  ...
  void genJitTestCode() {
    ...
    /* z31 - z29 are used as zTmpIdx - zTmp3Idx */
    vptestmd(k4 | k1, Ymm(0), Ymm(1));
    vptestmd(k5 | k2, Ymm(2), Ymm(3));
    vptestmd(k6 | k3, Ymm(4), Ymm(5));

    vptestmd(k1 | k1, Ymm(6), Ymm(7));
    vptestmd(k2 | k2, Ymm(8), Ymm(9));
    vptestmd(k3 | k3, Ymm(10), Ymm(11));
  }
};
