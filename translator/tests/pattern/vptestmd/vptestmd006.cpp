...
public:
  ...
  void genJitTestCode() {
    ...
    /* z31 - z29 are used as zTmpIdx - zTmp3Idx */
    vptestmd(k4 | k1, Xmm(0), Xmm(1));
    vptestmd(k5 | k2, Xmm(2), Xmm(3));
    vptestmd(k6 | k3, Xmm(4), Xmm(5));

    vptestmd(k1 | k1, Xmm(6), Xmm(7));
    vptestmd(k2 | k2, Xmm(8), Xmm(9));
    vptestmd(k3 | k3, Xmm(10), Xmm(11));
  }
};
