...
public:
  ...
  void genJitTestCode() {
    ...
    /* z31 - z29 are used as zTmpIdx - zTmp3Idx */
    vptestmd(k4 | k1, Zmm(0), Zmm(0));
    vptestmd(k5 | k2, Zmm(2), Zmm(2));
    vptestmd(k6 | k3, Zmm(4), Zmm(4));

    vptestmd(k1 | k1, Zmm(6), Zmm(6));
    vptestmd(k2 | k2, Zmm(8), Zmm(8));
    vptestmd(k3 | k3, Zmm(10), Zmm(10));
  }
};
