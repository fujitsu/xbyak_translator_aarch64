...
public:
  ...
  void genJitTestCode() {
    ...
    /* z31 - z29 are used as zTmpIdx - zTmp3Idx */
    vptestmd(k4 | k1, Ymm(0), Ymm(0));
    vptestmd(k5 | k2, Ymm(2), Ymm(2));
    vptestmd(k6 | k3, Ymm(4), Ymm(4));

    vptestmd(k1 | k1, Ymm(6), Ymm(6));
    vptestmd(k2 | k2, Ymm(8), Ymm(8));
    vptestmd(k3 | k3, Ymm(10), Ymm(10));
  }
};
