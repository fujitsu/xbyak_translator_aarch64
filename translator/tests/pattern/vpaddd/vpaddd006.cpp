...
//    mov(rax, 5);
    ...
    /* VEX */
    vpaddd(Xmm(2) | k1, Xmm(0), ptr[rax]);
    vpaddd(Xmm(3) | k2, Xmm(0), ptr[rax]);
    vpaddd(Xmm(4) | k3, Xmm(0), ptr[rax]);
    vpaddd(Xmm(5) | k4, Xmm(0), ptr[rax]);
    vpaddd(Xmm(6) | k7, Xmm(0), ptr[rax]);

    vpaddd(Ymm(7) | k1, Ymm(0), ptr[rax]);
    vpaddd(Ymm(8) | k2, Ymm(0), ptr[rax]);
    vpaddd(Ymm(9) | k3, Ymm(0), ptr[rax]);
    vpaddd(Ymm(10) | k4, Ymm(0), ptr[rax]);
    vpaddd(Ymm(11) | k7, Ymm(0), ptr[rax]);

    /* EVEX */
    vpaddd(Xmm(16) | k1, Xmm(30), ptr[rax]);
    vpaddd(Xmm(17) | k2, Xmm(30), ptr[rax]);
    vpaddd(Xmm(18) | k3, Xmm(30), ptr[rax]);
    vpaddd(Xmm(19) | k4, Xmm(30), ptr[rax]);
    vpaddd(Xmm(20) | k7, Xmm(30), ptr[rax]);

    vpaddd(Ymm(21) | k1, Ymm(30), ptr[rax]);
    vpaddd(Ymm(22) | k2, Ymm(30), ptr[rax]);
    vpaddd(Ymm(23) | k3, Ymm(30), ptr[rax]);
    vpaddd(Ymm(24) | k4, Ymm(30), ptr[rax]);
    vpaddd(Ymm(25) | k7, Ymm(30), ptr[rax]);

    vpaddd(Zmm(26) | k1, Zmm(30), ptr[rax]);
    vpaddd(Zmm(27) | k2, Zmm(30), ptr[rax]);
    vpaddd(Zmm(28) | k3, Zmm(30), ptr[rax]);
    vpaddd(Zmm(29) | k4, Zmm(30), ptr[rax]);
    vpaddd(Zmm(30) | k7, Zmm(30), ptr[rax]);
