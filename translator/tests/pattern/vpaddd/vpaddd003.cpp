...
//    inputPredReg[6] = (1 << 1) | (1 << 7); /* Both x86_64 and aarch64 */
    ...
    inputPredReg[4] = (1 << 0) | (1 << 28) | (uint64_t(1) << 40) | (uint64_t(1) << 60);
#endif
...
//    vpaddd(Xmm(12) | k6 | T_z, Xmm(12), Xmm(13));
    /* VEX */
    vpaddd(Xmm(2) | k1 | T_z, Xmm(0), Xmm(1));
    vpaddd(Xmm(3) | k2 | T_z, Xmm(0), Xmm(1));
    vpaddd(Xmm(4) | k3 | T_z, Xmm(0), Xmm(1));
    vpaddd(Xmm(5) | k4 | T_z, Xmm(0), Xmm(1));
    vpaddd(Xmm(6) | k7 | T_z, Xmm(0), Xmm(1));

    vpaddd(Ymm(7) | k1 | T_z, Ymm(0), Ymm(1));
    vpaddd(Ymm(8) | k2 | T_z, Ymm(0), Ymm(1));
    vpaddd(Ymm(9) | k3 | T_z, Ymm(0), Ymm(1));
    vpaddd(Ymm(10) | k4 | T_z, Ymm(0), Ymm(1));
    vpaddd(Ymm(11) | k7 | T_z, Ymm(0), Ymm(1));

    /* EVEX */
    vpaddd(Xmm(16) | k1 | T_z, Xmm(30), Xmm(31));
    vpaddd(Xmm(17) | k2 | T_z, Xmm(30), Xmm(31));
    vpaddd(Xmm(18) | k3 | T_z, Xmm(30), Xmm(31));
    vpaddd(Xmm(19) | k4 | T_z, Xmm(30), Xmm(31));
    vpaddd(Xmm(20) | k7 | T_z, Xmm(30), Xmm(31));

    vpaddd(Ymm(21) | k1 | T_z, Ymm(30), Ymm(31));
    vpaddd(Ymm(22) | k2 | T_z, Ymm(30), Ymm(31));
    vpaddd(Ymm(23) | k3 | T_z, Ymm(30), Ymm(31));
    vpaddd(Ymm(24) | k4 | T_z, Ymm(30), Ymm(31));
    vpaddd(Ymm(25) | k7 | T_z, Ymm(30), Ymm(31));

    vpaddd(Zmm(26) | k1 | T_z, Zmm(30), Zmm(31));
    vpaddd(Zmm(27) | k2 | T_z, Zmm(30), Zmm(31));
    vpaddd(Zmm(28) | k3 | T_z, Zmm(30), Zmm(31));
    vpaddd(Zmm(29) | k4 | T_z, Zmm(30), Zmm(31));
    vpaddd(Zmm(30) | k7 | T_z, Zmm(30), Zmm(31));
