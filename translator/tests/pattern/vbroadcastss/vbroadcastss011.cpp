...
public:
  ...
  void genJitTestCode() {
    ...
    /* Address is aligned */
    vbroadcastss(Ymm(1) | k1 | T_z, ptr[rax]);
    vbroadcastss(Ymm(2) | k2 | T_z, ptr[rax]);
    vbroadcastss(Ymm(3) | k3 | T_z, ptr[rax]);
    vbroadcastss(Ymm(4) | k4 | T_z, ptr[rax]);
    vbroadcastss(Ymm(5) | k5 | T_z, ptr[rax]);
    vbroadcastss(Ymm(6) | k6 | T_z, ptr[rax]);
    vbroadcastss(Ymm(7) | k7 | T_z, ptr[rax]);
  }
};
