...
public:
  ...
  void genJitTestCode() {
    ...
    vbroadcastss(Zmm(1) | k1, ptr[rax]);
    vbroadcastss(Zmm(2) | k2, ptr[rax]);
    vbroadcastss(Zmm(3) | k3, ptr[rax]);
    vbroadcastss(Zmm(4) | k4, ptr[rax]);
    vbroadcastss(Zmm(5) | k5, ptr[rax]);
    vbroadcastss(Zmm(6) | k6, ptr[rax]);
    vbroadcastss(Zmm(7) | k7, ptr[rax]);
  }
};
