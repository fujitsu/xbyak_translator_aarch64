...
public:
  ...
  void genJitTestCode() {
    ...
    //    mulps(Zmm(2), Zmm(1)|k2, ptr[rax]);
    mulps(Zmm(3), Zmm(1) | k3, ptr[rax]);
    //    mulps(Zmm(4), Zmm(1)|k4, ptr[rax]);
    //    mulps(Zmm(5), Zmm(1)|k5, ptr[rax]);
    //    mulps(Zmm(6), Zmm(1)|k6, ptr[rax]);
    //    mulps(Zmm(7), Zmm(1)|k7, ptr[rax]);
