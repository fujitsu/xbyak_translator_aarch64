...
public:
  ...
  void genJitTestCode() {
    ...
    /* VEX */
    for (int i = 0; i < 4; i++) {
      vperm2f128(Ymm(i + 2), Ymm(0), Ymm(1), i);
    }

    vperm2f128(Ymm(6), Ymm(0), Ymm(1), 16);
    vperm2f128(Ymm(7), Ymm(0), Ymm(1), 32);
    vperm2f128(Ymm(8), Ymm(0), Ymm(1), 48);

    vperm2f128(Ymm(9), Ymm(0), Ymm(1), 8);
    vperm2f128(Ymm(10), Ymm(0), Ymm(1), 128);
  }
};
