...
public:
  ...
  void genJitTestCode() {
    ...
    vblendmps(Ymm(1) | k1, Ymm(30), ptr[rax]);
    vblendmps(Ymm(2) | k2, Ymm(30), ptr[rax]);
    vblendmps(Ymm(3) | k3, Ymm(30), ptr[rax]);
    vblendmps(Ymm(4) | k4, Ymm(30), ptr[rax]);
    vblendmps(Ymm(5) | k5, Ymm(30), ptr[rax]);
    vblendmps(Ymm(6) | k6, Ymm(30), ptr[rax]);
    vblendmps(Ymm(7) | k7, Ymm(30), ptr[rax]);
    vblendmps(Ymm(8) | k6, Ymm(8), ptr[rax]);
    vblendmps(Ymm(9) | k7, Ymm(9), ptr[rax]);
