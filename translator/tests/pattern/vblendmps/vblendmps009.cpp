...
public:
  ...
  void genJitTestCode() {
    ...
    vblendmps(Xmm(1) | k1 | T_z, Xmm(30), ptr_b[rax]);
    vblendmps(Xmm(2) | k2 | T_z, Xmm(30), ptr_b[rax]);
    vblendmps(Xmm(3) | k3 | T_z, Xmm(30), ptr_b[rax]);
    vblendmps(Xmm(4) | k4 | T_z, Xmm(30), ptr_b[rax]);
    vblendmps(Xmm(5) | k5 | T_z, Xmm(30), ptr_b[rax]);
    vblendmps(Xmm(6) | k6 | T_z, Xmm(30), ptr_b[rax]);
    vblendmps(Xmm(7) | k7 | T_z, Xmm(30), ptr_b[rax]);
