...
public:
  ...
  void genJitTestCode() {
    ...
    vblendmps(Ymm(1) | k1, Ymm(30), Ymm(31));
    vblendmps(Ymm(2) | k2, Ymm(30), Ymm(31));
    vblendmps(Ymm(3) | k3, Ymm(30), Ymm(31));
    vblendmps(Ymm(4) | k4, Ymm(30), Ymm(31));
    vblendmps(Ymm(5) | k5, Ymm(30), Ymm(31));
    vblendmps(Ymm(6) | k6, Ymm(30), Ymm(31));
  }
};
