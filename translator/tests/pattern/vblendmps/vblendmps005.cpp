...
public:
  ...
  void genJitTestCode() {
    ...
    vblendmps(Zmm(1) | k1 | T_z, Zmm(30), Zmm(31));
    vblendmps(Zmm(2) | k2 | T_z, Zmm(30), Zmm(31));
    vblendmps(Zmm(3) | k3 | T_z, Zmm(30), Zmm(31));
    vblendmps(Zmm(4) | k4 | T_z, Zmm(30), Zmm(31));
    vblendmps(Zmm(5) | k5 | T_z, Zmm(30), Zmm(31));
    vblendmps(Zmm(6) | k6 | T_z, Zmm(30), Zmm(31));
    vblendmps(Zmm(7) | k7 | T_z, Zmm(30), Zmm(31));
  }
};
