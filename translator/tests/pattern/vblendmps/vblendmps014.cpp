...
public:
  ...
  void genJitTestCode() {
    ...
    vblendmps(Zmm(1) | k1, Zmm(30), Zmm(31));
    vblendmps(Zmm(2) | k2, Zmm(30), Zmm(31));
    vblendmps(Zmm(3) | k3, Zmm(30), Zmm(31));
    vblendmps(Zmm(4) | k4, Zmm(30), Zmm(31));
    vblendmps(Zmm(5) | k5, Zmm(30), Zmm(31));
    vblendmps(Zmm(6) | k6, Zmm(30), Zmm(31));
    vblendmps(Zmm(7) | k7, Zmm(30), Zmm(31));
  }
};
