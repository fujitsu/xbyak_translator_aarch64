...
public:
  ...
  void genJitTestCode() {
    ...
    vblendmps(Zmm(1) | k1, Zmm(30), ptr_b[rax]);
    vblendmps(Zmm(2) | k2, Zmm(30), ptr_b[rax]);
    vblendmps(Zmm(3) | k3, Zmm(30), ptr_b[rax]);
    vblendmps(Zmm(4) | k4, Zmm(30), ptr_b[rax]);
    vblendmps(Zmm(5) | k5, Zmm(30), ptr_b[rax]);
    vblendmps(Zmm(6) | k6, Zmm(30), ptr_b[rax]);
    vblendmps(Zmm(7) | k7, Zmm(30), ptr_b[rax]);

    vblendmps(Zmm(8) | k6, Zmm(8), ptr_b[rax]);
    vblendmps(Zmm(9) | k7, Zmm(9), ptr_b[rax]);
