...
public:
  ...
  void genJitTestCode() {
    ...
    vblendmps(Xmm(1) | k1, Xmm(30), ptr[rax]);
    vblendmps(Xmm(2) | k2, Xmm(30), ptr[rax]);
    vblendmps(Xmm(3) | k3, Xmm(30), ptr[rax]);
    vblendmps(Xmm(4) | k4, Xmm(30), ptr[rax]);
    vblendmps(Xmm(5) | k5, Xmm(30), ptr[rax]);
    vblendmps(Xmm(6) | k6, Xmm(30), ptr[rax]);
    vblendmps(Xmm(7) | k7, Xmm(30), ptr[rax]);

    vblendmps(Xmm(8) | k6, Xmm(8), ptr[rax]);
    vblendmps(Xmm(9) | k7, Xmm(9), ptr[rax]);
