...
public:
  ...
  void genJitTestCode() {
    ...
    vblendmps(Ymm(1) | k1 | T_z, Ymm(30), ptr_b[rax]);
    vblendmps(Ymm(2) | k2 | T_z, Ymm(30), ptr_b[rax]);
    vblendmps(Ymm(3) | k3 | T_z, Ymm(30), ptr_b[rax]);
    vblendmps(Ymm(4) | k4 | T_z, Ymm(30), ptr_b[rax]);
    vblendmps(Ymm(5) | k5 | T_z, Ymm(30), ptr_b[rax]);
    vblendmps(Ymm(6) | k6 | T_z, Ymm(30), ptr_b[rax]);
    vblendmps(Ymm(7) | k7 | T_z, Ymm(30), ptr_b[rax]);
