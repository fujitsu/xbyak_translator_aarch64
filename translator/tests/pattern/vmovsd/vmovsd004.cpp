...
public:
  ...
  void genJitTestCode() {
    ...
    vmovsd(Xmm(1) | k1, Xmm(14), Xmm(15));
    vmovsd(Xmm(2) | k2, Xmm(14), Xmm(15));
    vmovsd(Xmm(3) | k3, Xmm(14), Xmm(15));
    vmovsd(Xmm(4) | k4, Xmm(14), Xmm(15));
    vmovsd(Xmm(5) | k5, Xmm(14), Xmm(15));
    vmovsd(Xmm(6) | k6, Xmm(14), Xmm(15));
    vmovsd(Xmm(7) | k7, Xmm(14), Xmm(15));

    vmovsd(Xmm(8) | k4, Xmm(14), Xmm(8));
    vmovsd(Xmm(9) | k4, Xmm(9), Xmm(15));
    vmovsd(Xmm(10) | k4, Xmm(14), Xmm(14));
    vmovsd(Xmm(1) | k4, Xmm(1), Xmm(11));
  }
};
