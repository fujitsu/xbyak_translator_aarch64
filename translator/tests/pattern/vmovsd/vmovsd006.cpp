...
public:
  ...
  void genJitTestCode() {
    ...
    vmovsd(Xmm(1) | k1, ptr[rax]);
    vmovsd(Xmm(2) | k2, ptr[rax]);
    vmovsd(Xmm(3) | k3, ptr[rax]);
    vmovsd(Xmm(4) | k4, ptr[rax]);
    vmovsd(Xmm(5) | k5, ptr[rax]);
    vmovsd(Xmm(6) | k6, ptr[rax]);
    vmovsd(Xmm(7) | k7, ptr[rax]);

    vmovsd(Xmm(16) | k4, ptr[rax]);
    vmovsd(Xmm(17) | k4, ptr[rax]);
