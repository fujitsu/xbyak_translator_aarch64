...
public:
  ...
  void genJitTestCode() {
    ...
    vmovsd(Xmm(1) | k1 | T_z, ptr[rax]);
    vmovsd(Xmm(2) | k2 | T_z, ptr[rax]);
    vmovsd(Xmm(3) | k3 | T_z, ptr[rax]);
    vmovsd(Xmm(4) | k4 | T_z, ptr[rax]);
    vmovsd(Xmm(5) | k5 | T_z, ptr[rax]);
    vmovsd(Xmm(6) | k6 | T_z, ptr[rax]);
    vmovsd(Xmm(7) | k7 | T_z, ptr[rax]);

    vmovsd(Xmm(16) | k4 | T_z, ptr[rax]);
    vmovsd(Xmm(17) | k4 | T_z, ptr[rax]);
