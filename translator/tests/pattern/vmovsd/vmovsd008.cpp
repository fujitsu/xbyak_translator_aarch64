...
public:
  ...
  void genJitTestCode() {
    ...
    vmovsd(ptr[rax] | k1, Xmm(0));
    vmovups(Zmm(21), ptr[rax]);

    vmovsd(ptr[rax] | k2, Xmm(1));
    vmovups(Zmm(22), ptr[rax]);

    vmovsd(ptr[rax] | k3, Xmm(16));
    vmovups(Zmm(23), ptr[rax]);

    vmovsd(ptr[rax] | k4, Xmm(17));
    vmovups(Zmm(24), ptr[rax]);

    vmovsd(ptr[rax] | k5, Xmm(17));
    vmovups(Zmm(25), ptr[rax]);

    vmovsd(ptr[rax] | k6, Xmm(17));
    vmovups(Zmm(26), ptr[rax]);

    vmovsd(ptr[rax] | k7, Xmm(17));
