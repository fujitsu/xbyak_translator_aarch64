...
public:
  ...
  void genJitTestCode() {
    ...
    vunpckhpd(Ymm(1)|k1, Ymm(1), Ymm(2));
    vunpckhpd(Ymm(2)|k2, Ymm(1), Ymm(2));
    vunpckhpd(Ymm(3)|k3, Ymm(1), Ymm(2));
    vunpckhpd(Ymm(4)|k4, Ymm(1), Ymm(2));
    vunpckhpd(Ymm(5)|k5, Ymm(1), Ymm(2));
    vunpckhpd(Ymm(6)|k6, Ymm(1), Ymm(2));
    vunpckhpd(Ymm(7)|k7, Ymm(1), Ymm(2));
  }
};
