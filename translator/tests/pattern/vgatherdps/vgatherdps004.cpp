...
public:
  ...
  void genJitTestCode() {
    ...
    vgatherdps(Xmm(1), ptr[rax + Xmm(15)*2 + 0x10], Xmm(8));
    vgatherdps(Xmm(2), ptr[rax + Xmm(15)*2 - 0x10], Xmm(9));
    vgatherdps(Xmm(3), ptr[rax + Xmm(15)*2], Xmm(10));
    vgatherdps(Xmm(4), ptr[rax + Xmm(15)*2], Xmm(11));
    vgatherdps(Xmm(5), ptr[rax + Xmm(15)*2], Xmm(12));
    vgatherdps(Xmm(6), ptr[rax + Xmm(15)*2], Xmm(13));
    vgatherdps(Xmm(7), ptr[rax + Xmm(15)*2], Xmm(14));
    mov(rax, 5);
  }
};
