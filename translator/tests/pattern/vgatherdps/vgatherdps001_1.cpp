...
public:
  ...
  void genJitTestCode() {
     ...
     * other. */
    vgatherdps(Ymm(7), ptr[rax + Ymm(0) * 2 + 0x10], Ymm(8));
    vgatherdps(Ymm(6), ptr[rax + Ymm(0) * 2 - 0x10], Ymm(9));
    vgatherdps(Ymm(5), ptr[rax + Ymm(0) * 2], Ymm(10));
    vgatherdps(Ymm(4), ptr[rax + Ymm(0) * 2], Ymm(11));
    vgatherdps(Ymm(3), ptr[rax + Ymm(0) * 2], Ymm(12));
    vgatherdps(Ymm(2), ptr[rax + Ymm(0) * 2], Ymm(13));
    vgatherdps(Ymm(1), ptr[rax + Ymm(0) * 2], Ymm(14));
    mov(rax, 5);
  }
};
