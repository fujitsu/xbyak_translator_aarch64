...
public:
  ...
  void genJitTestCode() {
    ...
    vpbroadcastd(Xmm(0) | k1, ptr[rax]);
    vpbroadcastd(Ymm(1) | k1, ptr[rax]);
    vpbroadcastd(Zmm(2) | k1, ptr[rax]);
    vpbroadcastd(Xmm(3) | k2, ptr[rax]);
    vpbroadcastd(Ymm(4) | k3, ptr[rax]);
    vpbroadcastd(Zmm(5) | k4, ptr[rax]);
    vpbroadcastd(Xmm(6) | k3, ptr[rax]);
    vpbroadcastd(Ymm(7) | k4, ptr[rax]);
    vpbroadcastd(Zmm(8) | k2, ptr[rax]);
