...
public:
  ...
  void genJitTestCode() {
    ...
    vpbroadcastd(Xmm(6) | k1 | T_z, r8d);
    vpbroadcastd(Ymm(7) | k1 | T_z, r9d);
    vpbroadcastd(Zmm(8) | k1 | T_z, r10d);
    vpbroadcastd(Xmm(9) | k4 | T_z, r8d);
    vpbroadcastd(Ymm(10) | k2 | T_z, r9d);
    vpbroadcastd(Zmm(11) | k3 | T_z, r10d);
  }
};
