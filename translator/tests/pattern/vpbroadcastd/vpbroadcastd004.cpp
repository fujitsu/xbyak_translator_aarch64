...
public:
  ...
  void genJitTestCode() {
    ...
    vpbroadcastd(Xmm(3) | k2 | T_z, Xmm(28));
    vpbroadcastd(Ymm(4) | k3 | T_z, Xmm(27));
    vpbroadcastd(Zmm(5) | k4 | T_z, Xmm(26));
    vpbroadcastd(Xmm(6) | k7 | T_z, Xmm(25));
    vpbroadcastd(Ymm(7) | k7 | T_z, Xmm(24));
    vpbroadcastd(Zmm(8) | k7 | T_z, Xmm(23));
    vpbroadcastd(Xmm(9) | k1 | T_z, r8d);
    vpbroadcastd(Ymm(10) | k1 | T_z, r9d);
    vpbroadcastd(Zmm(11) | k1 | T_z, r10d);
    vpbroadcastd(Xmm(12) | k4 | T_z, r8d);
    vpbroadcastd(Ymm(13) | k2 | T_z, r9d);
    vpbroadcastd(Zmm(14) | k3 | T_z, r10d);
    vpbroadcastd(Xmm(15) | k7 | T_z, r8d);
    vpbroadcastd(Ymm(16) | k7 | T_z, r9d);
    vpbroadcastd(Zmm(17) | k7 | T_z, r10d);
