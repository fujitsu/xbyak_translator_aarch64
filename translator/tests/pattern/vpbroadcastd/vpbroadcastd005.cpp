...
public:
  ...
  void genJitTestCode() {
    ...
    vpbroadcastd(Xmm(0) | k1 | T_z, ptr[rax]);
    vpbroadcastd(Ymm(1) | k1 | T_z, ptr[rax]);
    vpbroadcastd(Zmm(2) | k1 | T_z, ptr[rax]);
    vpbroadcastd(Xmm(3) | k2 | T_z, ptr[rax]);
    vpbroadcastd(Ymm(4) | k3 | T_z, ptr[rax]);
    vpbroadcastd(Zmm(5) | k4 | T_z, ptr[rax]);
    vpbroadcastd(Xmm(6) | k3 | T_z, ptr[rax]);
    vpbroadcastd(Ymm(7) | k4 | T_z, ptr[rax]);
    vpbroadcastd(Zmm(8) | k2 | T_z, ptr[rax]);
    vpbroadcastd(Xmm(9) | k4 | T_z, ptr[rax]);
    vpbroadcastd(Ymm(10) | k2 | T_z, ptr[rax]);
    vpbroadcastd(Zmm(11) | k3 | T_z, ptr[rax]);
    vpbroadcastd(Xmm(12) | k7 | T_z, ptr[rax]);
    vpbroadcastd(Ymm(13) | k7 | T_z, ptr[rax]);
    vpbroadcastd(Zmm(14) | k7 | T_z, ptr[rax]);
