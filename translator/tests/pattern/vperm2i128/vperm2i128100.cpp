...
public:
  ...
  void genJitTestCode() {
    ...
    /* VEX */
    vperm2i128(Ymm(0), Ymm(1), Ymm(2), 1);

    vperm2i128(Ymm(3), Ymm(3), Ymm(4), 1);
    vperm2i128(Ymm(5), Ymm(6), Ymm(5), 1);
    vperm2i128(Ymm(7), Ymm(8), Ymm(8), 1);
    vperm2i128(Ymm(9), Ymm(9), Ymm(9), 1);
  }
};
