...
public:
  ...
  void genJitTestCode() {
    ...
    vpmovzxwd(Xmm(1) | k1, ptr[rax]);
    vpmovzxwd(Xmm(2) | k2, ptr[rax]);
    vpmovzxwd(Xmm(3) | k3, ptr[rax]);
    vpmovzxwd(Xmm(4) | k4, ptr[rax]);
    vpmovzxwd(Xmm(5) | k5, ptr[rax]);
    vpmovzxwd(Xmm(6) | k6, ptr[rax]);
    vpmovzxwd(Xmm(7) | k7, ptr[rax]);

    /* Register index is EVEX range. */
    vpmovzxwd(Xmm(21) | k1, ptr[rcx]);
    vpmovzxwd(Xmm(22) | k2, ptr[rcx]);
    vpmovzxwd(Xmm(23) | k3, ptr[rcx]);
    vpmovzxwd(Xmm(24) | k4, ptr[rcx]);
    vpmovzxwd(Xmm(25) | k5, ptr[rcx]);
    vpmovzxwd(Xmm(26) | k6, ptr[rcx]);
    vpmovzxwd(Xmm(27) | k7, ptr[rcx]);
