...
public:
  ...
  void genJitTestCode() {
    ...
    vpmovzxwd(Zmm(1) | k1, ptr[rax]);
    vpmovzxwd(Zmm(2) | k2, ptr[rax]);
    vpmovzxwd(Zmm(3) | k3, ptr[rax]);
    vpmovzxwd(Zmm(4) | k4, ptr[rax]);
    vpmovzxwd(Zmm(5) | k5, ptr[rax]);
    vpmovzxwd(Zmm(6) | k6, ptr[rax]);
    vpmovzxwd(Zmm(7) | k7, ptr[rax]);

    /* Register index is EVEX range. */
    vpmovzxwd(Zmm(21) | k1, ptr[rcx]);
    vpmovzxwd(Zmm(22) | k2, ptr[rcx]);
    vpmovzxwd(Zmm(23) | k3, ptr[rcx]);
    vpmovzxwd(Zmm(24) | k4, ptr[rcx]);
    vpmovzxwd(Zmm(25) | k5, ptr[rcx]);
    vpmovzxwd(Zmm(26) | k6, ptr[rcx]);
    vpmovzxwd(Zmm(27) | k7, ptr[rcx]);
