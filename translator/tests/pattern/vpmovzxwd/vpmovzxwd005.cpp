...
public:
  ...
  void genJitTestCode() {
    ...
    vpmovzxwd(Zmm(1) | k1 | T_z, ptr[rax]);
    vpmovzxwd(Zmm(2) | k2 | T_z, ptr[rax]);
    vpmovzxwd(Zmm(3) | k3 | T_z, ptr[rax]);
    vpmovzxwd(Zmm(4) | k4 | T_z, ptr[rax]);
    vpmovzxwd(Zmm(5) | k5 | T_z, ptr[rax]);
    vpmovzxwd(Zmm(6) | k6 | T_z, ptr[rax]);
    vpmovzxwd(Zmm(7) | k7 | T_z, ptr[rax]);

    /* Register index is EVEX range. */
    vpmovzxwd(Zmm(21) | k1 | T_z, ptr[rcx]);
    vpmovzxwd(Zmm(22) | k2 | T_z, ptr[rcx]);
    vpmovzxwd(Zmm(23) | k3 | T_z, ptr[rcx]);
    vpmovzxwd(Zmm(24) | k4 | T_z, ptr[rcx]);
    vpmovzxwd(Zmm(25) | k5 | T_z, ptr[rcx]);
    vpmovzxwd(Zmm(26) | k6 | T_z, ptr[rcx]);
    vpmovzxwd(Zmm(27) | k7 | T_z, ptr[rcx]);
