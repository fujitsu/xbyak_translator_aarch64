...
public:
  ...
  void genJitTestCode() {
    ...
    vpmovzxwd(Xmm(1) | k1 | T_z, ptr[rax]);
    vpmovzxwd(Xmm(2) | k2 | T_z, ptr[rax]);
    vpmovzxwd(Xmm(3) | k3 | T_z, ptr[rax]);
    vpmovzxwd(Xmm(4) | k4 | T_z, ptr[rax]);
    vpmovzxwd(Xmm(5) | k5 | T_z, ptr[rax]);
    vpmovzxwd(Xmm(6) | k6 | T_z, ptr[rax]);
    vpmovzxwd(Xmm(7) | k7 | T_z, ptr[rax]);

    /* Register index is EVEX range. */
    vpmovzxwd(Xmm(21) | k1 | T_z, ptr[rcx]);
    vpmovzxwd(Xmm(22) | k2 | T_z, ptr[rcx]);
    vpmovzxwd(Xmm(23) | k3 | T_z, ptr[rcx]);
    vpmovzxwd(Xmm(24) | k4 | T_z, ptr[rcx]);
    vpmovzxwd(Xmm(25) | k5 | T_z, ptr[rcx]);
    vpmovzxwd(Xmm(26) | k6 | T_z, ptr[rcx]);
    vpmovzxwd(Xmm(27) | k7 | T_z, ptr[rcx]);
