...
public:
  ...
  void genJitTestCode() {
    ...
    vpmovzxwd(Ymm(1) | k1, ptr[rax]);
    vpmovzxwd(Ymm(2) | k2, ptr[rax]);
    vpmovzxwd(Ymm(3) | k3, ptr[rax]);
    vpmovzxwd(Ymm(4) | k4, ptr[rax]);
    vpmovzxwd(Ymm(5) | k5, ptr[rax]);
    vpmovzxwd(Ymm(6) | k6, ptr[rax]);
    vpmovzxwd(Ymm(7) | k7, ptr[rax]);

    /* Register index is EVEX range. */
    vpmovzxwd(Ymm(21) | k1, ptr[rcx]);
    vpmovzxwd(Ymm(22) | k2, ptr[rcx]);
    vpmovzxwd(Ymm(23) | k3, ptr[rcx]);
    vpmovzxwd(Ymm(24) | k4, ptr[rcx]);
    vpmovzxwd(Ymm(25) | k5, ptr[rcx]);
    vpmovzxwd(Ymm(26) | k6, ptr[rcx]);
    vpmovzxwd(Ymm(27) | k7, ptr[rcx]);
