...
public:
  ...
  void genJitTestCode() {
    ...
    vpmovzxwd(Ymm(1) | k1 | T_z, ptr[rax]);
    vpmovzxwd(Ymm(2) | k2 | T_z, ptr[rax]);
    vpmovzxwd(Ymm(3) | k3 | T_z, ptr[rax]);
    vpmovzxwd(Ymm(4) | k4 | T_z, ptr[rax]);
    vpmovzxwd(Ymm(5) | k5 | T_z, ptr[rax]);
    vpmovzxwd(Ymm(6) | k6 | T_z, ptr[rax]);
    vpmovzxwd(Ymm(7) | k7 | T_z, ptr[rax]);

    /* Register index is EVEX range. */
    vpmovzxwd(Ymm(21) | k1 | T_z, ptr[rcx]);
    vpmovzxwd(Ymm(22) | k2 | T_z, ptr[rcx]);
    vpmovzxwd(Ymm(23) | k3 | T_z, ptr[rcx]);
    vpmovzxwd(Ymm(24) | k4 | T_z, ptr[rcx]);
    vpmovzxwd(Ymm(25) | k5 | T_z, ptr[rcx]);
    vpmovzxwd(Ymm(26) | k6 | T_z, ptr[rcx]);
    vpmovzxwd(Ymm(27) | k7 | T_z, ptr[rcx]);
