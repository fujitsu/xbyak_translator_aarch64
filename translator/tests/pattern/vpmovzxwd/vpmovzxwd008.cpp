...
public:
  ...
  void genJitTestCode() {
    ...
    vpmovzxwd(Ymm(1) | k1 | T_z, Xmm(0));
    vpmovzxwd(Ymm(2) | k2 | T_z, Xmm(0));
    vpmovzxwd(Ymm(3) | k3 | T_z, Xmm(0));
    vpmovzxwd(Ymm(4) | k4 | T_z, Xmm(0));
    vpmovzxwd(Ymm(5) | k5 | T_z, Xmm(0));
    ...
    vpmovzxwd(Ymm(22) | k2 | T_z, Xmm(20));
    vpmovzxwd(Ymm(23) | k3 | T_z, Xmm(20));
    vpmovzxwd(Ymm(24) | k4 | T_z, Xmm(20));
    vpmovzxwd(Ymm(25) | k5 | T_z, Xmm(20));
