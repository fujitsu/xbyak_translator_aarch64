...
public:
  ...
  void genJitTestCode() {
    ...
    vpunpcklwd(Xmm(0) | k1, Xmm(1), ptr[rax]);
    vpunpcklwd(Xmm(2) | k2, Xmm(2), ptr[rax]);

    vpunpcklwd(Ymm(3) | k3, Ymm(4), ptr[rax]);
    vpunpcklwd(Ymm(5) | k4, Ymm(5), ptr[rax]);

    vpunpcklwd(Zmm(6) | k5, Zmm(7), ptr[rax]);
    vpunpcklwd(Zmm(8) | k6, Zmm(8), ptr[rax]);

    vpunpcklwd(Xmm(20) | k1, Xmm(21), ptr[rax]);
    vpunpcklwd(Xmm(22) | k2, Xmm(22), ptr[rax]);

    vpunpcklwd(Ymm(23) | k3, Ymm(24), ptr[rax]);
    vpunpcklwd(Ymm(25) | k4, Ymm(25), ptr[rax]);
