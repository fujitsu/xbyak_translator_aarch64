...
public:
  ...
  void genJitTestCode() {
    ...
    /*
    vpunpcklwd(Xmm(8) | k1, Xmm(8), Xmm(31));
    vpunpcklwd(Xmm(9) | k2, Xmm(9), Xmm(31));
    vpunpcklwd(Xmm(10) | k3, Xmm(10), Xmm(31));
    vpunpcklwd(Xmm(11) | k4, Xmm(11), Xmm(31));
    vpunpcklwd(Xmm(12) | k5, Xmm(12), Xmm(31));
    vpunpcklwd(Xmm(13) | k6, Xmm(13), Xmm(31));
    vpunpcklwd(Xmm(14) | k7, Xmm(14), Xmm(31));

    vpunpcklwd(Xmm(15) | k1, Xmm(30), Xmm(15));
    vpunpcklwd(Xmm(16) | k2, Xmm(30), Xmm(16));
    vpunpcklwd(Xmm(17) | k3, Xmm(30), Xmm(17));
    vpunpcklwd(Xmm(18) | k4, Xmm(30), Xmm(18));
    vpunpcklwd(Xmm(19) | k5, Xmm(30), Xmm(19));
