...
public:
  ...
  void genJitTestCode() {
    ...
    vpbroadcastw(Xmm(0) | k1 | T_z, Xmm(31));
    vpbroadcastw(Ymm(1) | k1 | T_z, Xmm(30));
    vpbroadcastw(Zmm(2) | k1 | T_z, Xmm(29));
    vpbroadcastw(Xmm(3) | k2 | T_z, Xmm(28));
    vpbroadcastw(Ymm(4) | k3 | T_z, Xmm(27));
    vpbroadcastw(Zmm(5) | k4 | T_z, Xmm(26));
    vpbroadcastw(Xmm(6) | k7 | T_z, Xmm(25));
    vpbroadcastw(Ymm(7) | k7 | T_z, Xmm(24));
    vpbroadcastw(Zmm(8) | k7 | T_z, Xmm(23));
    vpbroadcastw(Xmm(9) | k1 | T_z, r8w);
    vpbroadcastw(Ymm(10) | k1 | T_z, r9w);
    vpbroadcastw(Zmm(11) | k1 | T_z, r10w);
    vpbroadcastw(Xmm(12) | k4 | T_z, r8w);
    vpbroadcastw(Ymm(13) | k2 | T_z, r9w);
    vpbroadcastw(Zmm(14) | k3 | T_z, r10w);
    vpbroadcastw(Xmm(15) | k7 | T_z, r8w);
    vpbroadcastw(Ymm(16) | k7 | T_z, r9w);
    vpbroadcastw(Zmm(17) | k7 | T_z, r10w);
