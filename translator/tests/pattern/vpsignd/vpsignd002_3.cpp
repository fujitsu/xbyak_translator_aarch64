...
public:
  ...
  void genJitTestCode() {
    ...
    vpsignd(xmm1, xmm8, ptr[rax + 64 * 0]);
    vpsignd(xmm2, xmm9, ptr[rax + 64 * 1]);
    vpsignd(xmm3, xmm10, ptr[rax + 64 * 2]);
    vpsignd(xmm4, xmm11, ptr[rax + 64 * 3]);

    vpsignd(xmm15, xmm15, ptr[rax + 64 * 7]);
