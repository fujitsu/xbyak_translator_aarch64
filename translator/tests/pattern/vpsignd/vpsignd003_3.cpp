...
public:
  ...
  void genJitTestCode() {
    ...
    vpsignd(ymm1, ymm8, ptr[rax + 64 * 0]);
    vpsignd(ymm2, ymm9, ptr[rax + 64 * 1]);
    vpsignd(ymm3, ymm10, ptr[rax + 64 * 2]);
    vpsignd(ymm4, ymm11, ptr[rax + 64 * 3]);

    vpsignd(ymm15, ymm15, ptr[rax + 64 * 7]);
