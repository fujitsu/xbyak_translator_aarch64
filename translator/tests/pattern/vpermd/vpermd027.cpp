...
public:
  ...
  void genJitTestCode() {
    ...
    /* z31 - z29 are used as zTmpIdx - zTmp3Idx */
    vpermd(Ymm(1) | k1 | T_z, Ymm(30), ptr_b[rcx]);
    vpermd(Ymm(2) | k2 | T_z, Ymm(30), ptr_b[rcx]);
    vpermd(Ymm(3) | k3 | T_z, Ymm(3), ptr_b[rcx]);
    vpermd(Ymm(4) | k4 | T_z, Ymm(30), ptr_b[rcx]);
    vpermd(Ymm(5) | k5 | T_z, Ymm(5), ptr_b[rcx]);
    vpermd(Ymm(6) | k6 | T_z, Ymm(30), ptr_b[rcx]);
    vpermd(Ymm(7) | k7 | T_z, Ymm(30), ptr_b[rcx]);
