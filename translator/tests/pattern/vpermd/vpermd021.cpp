...
public:
  ...
  void genJitTestCode() {
    ...
    vpermd(Ymm(16), Ymm(8), ptr[rcx]);
    vpermd(Ymm(17), Ymm(9), ptr[rcx]);
    vpermd(Ymm(18), Ymm(10), ptr[rcx]);
    vpermd(Ymm(19), Ymm(11), ptr[rcx]);

    vpermd(Ymm(29), Ymm(8), ptr[rcx]);
    vpermd(Ymm(30), Ymm(9), ptr[rcx]);
    vpermd(Ymm(31), Ymm(10), ptr[rcx]);
