...
public:
  ...
  void genJitTestCode() {
    ...
    /* z31 - z29 are used as zTmpIdx - zTmp3Idx */
    vpermd(Ymm(1) | k1, Ymm(30), ptr[rcx]);
    vpermd(Ymm(2) | k2, Ymm(30), ptr[rcx]);
    vpermd(Ymm(3) | k3, Ymm(3), ptr[rcx]);
    vpermd(Ymm(4) | k4, Ymm(30), ptr[rcx]);
    vpermd(Ymm(5) | k5, Ymm(5), ptr[rcx]);
    vpermd(Ymm(6) | k6, Ymm(30), ptr[rcx]);
    vpermd(Ymm(7) | k7, Ymm(30), ptr[rcx]);
