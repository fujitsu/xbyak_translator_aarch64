...
public:
  ...
  void genJitTestCode() {
    ...
    vpermd(Ymm(16), Ymm(8), Ymm(15));
    vpermd(Ymm(17), Ymm(9), Ymm(15));
    vpermd(Ymm(18), Ymm(10), Ymm(15));
    vpermd(Ymm(19), Ymm(11), Ymm(15));

    vpermd(Ymm(29), Ymm(8), Ymm(15));
    vpermd(Ymm(30), Ymm(9), Ymm(15));
    vpermd(Ymm(31), Ymm(10), Ymm(15));
  }
};
