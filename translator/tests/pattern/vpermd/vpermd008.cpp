...
public:
  ...
  void genJitTestCode() {
    ...
    /* z31 - z29 are used as zTmpIdx - zTmp3Idx */
    vpermd(Zmm(1) | k1, Zmm(30), ptr_b[rcx]);
    vpermd(Zmm(2) | k2, Zmm(30), ptr_b[rcx]);
    vpermd(Zmm(3) | k3, Zmm(3), ptr_b[rcx]);
    vpermd(Zmm(4) | k4, Zmm(30), ptr_b[rcx]);
    vpermd(Zmm(5) | k5, Zmm(5), ptr_b[rcx]);
    vpermd(Zmm(6) | k6, Zmm(30), ptr_b[rcx]);
    vpermd(Zmm(7) | k7, Zmm(30), ptr_b[rcx]);
