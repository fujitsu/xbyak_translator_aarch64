...
public:
  ...
  void genJitTestCode() {
    ...
    /* z31 - z29 are used as zTmpIdx - zTmp3Idx */
    vpermd(Zmm(1) | k1 | T_z, Zmm(30), ptr[rcx]);
    vpermd(Zmm(2) | k2 | T_z, Zmm(30), ptr[rcx]);
    vpermd(Zmm(3) | k3 | T_z, Zmm(3), ptr[rcx]);
    vpermd(Zmm(4) | k4 | T_z, Zmm(30), ptr[rcx]);
    vpermd(Zmm(5) | k5 | T_z, Zmm(5), ptr[rcx]);
    vpermd(Zmm(6) | k6 | T_z, Zmm(30), ptr[rcx]);
    vpermd(Zmm(7) | k7 | T_z, Zmm(30), ptr[rcx]);
