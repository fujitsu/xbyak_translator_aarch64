...
public:
  ...
  void genJitTestCode() {
    ...
    vpermd(Ymm(0), Ymm(8), Ymm(15));
    vpermd(Ymm(1), Ymm(9), Ymm(15));
    vpermd(Ymm(2), Ymm(10), Ymm(15));
    vpermd(Ymm(3), Ymm(11), Ymm(15));

    vpermd(Ymm(4), Ymm(8), Ymm(15));
    vpermd(Ymm(5), Ymm(9), Ymm(15));
    vpermd(Ymm(6), Ymm(10), Ymm(15));
  }
};
