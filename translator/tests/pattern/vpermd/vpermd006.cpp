...
public:
  ...
  void genJitTestCode() {
    ...
    /* z31 - z29 are used as zTmpIdx - zTmp3Idx */
    vpermd(Zmm(0), Zmm(8), ptr_b[rcx]);
    vpermd(Zmm(1), Zmm(9), ptr_b[rcx]);
    vpermd(Zmm(2), Zmm(10), ptr_b[rcx]);
    vpermd(Zmm(3), Zmm(11), ptr_b[rcx]);

    vpermd(Zmm(29), Zmm(8), ptr_b[rcx]);
    vpermd(Zmm(30), Zmm(9), ptr_b[rcx]);
    vpermd(Zmm(31), Zmm(10), ptr_b[rcx]);
