...
/* Address is aligned */
    ...
    mov(rax, addr5);
    vfmadd213ps(Ymm(16) | k1 | T_z, Ymm(17), ptr[rax]);
    mov(rax, addr6);
    vfmadd213ps(Ymm(19) | k2 | T_z, Ymm(19), ptr[rax]);
    mov(rax, addr7);
    vfmadd213ps(Ymm(21) | k3 | T_z, Ymm(22), ptr[rax]);
    mov(rax, addr8);
    vfmadd213ps(Ymm(22) | k4 | T_z, Ymm(23), ptr[rax]);
    mov(rax, addr9);
    vfmadd213ps(Ymm(24) | k5 | T_z, Ymm(24), ptr[rax]);
    mov(rax,
