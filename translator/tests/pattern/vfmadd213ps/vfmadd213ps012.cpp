...
public:
  ...
  void genJitTestCode() {
    ...
    /* EVEX encode */
    vfmadd213ps(Ymm(20) | k5, Ymm(21), Ymm(22));
    vfmadd213ps(Ymm(23) | k4, Ymm(23), Ymm(24));
    vfmadd213ps(Ymm(25) | k3, Ymm(26), Ymm(25));
    vfmadd213ps(Ymm(27) | k2, Ymm(28), Ymm(28));
    vfmadd213ps(Ymm(29) | k1, Ymm(29), Ymm(29));
  }
};
