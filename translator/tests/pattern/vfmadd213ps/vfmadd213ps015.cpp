...
/* Address is aligned */
    ...
    mov(rax, addr5);
    vfmadd213ps(Zmm(16) | k1 | T_z, Zmm(17), ptr[rax]);
    mov(rax, addr6);
    vfmadd213ps(Zmm(19) | k2 | T_z, Zmm(19), ptr[rax]);
    mov(rax, addr7);
    vfmadd213ps(Zmm(21) | k3 | T_z, Zmm(22), ptr[rax]);
    mov(rax, addr8);
    vfmadd213ps(Zmm(22) | k4 | T_z, Zmm(23), ptr[rax]);
    mov(rax, addr9);
    vfmadd213ps(Zmm(24) | k5 | T_z, Zmm(24), ptr[rax]);
    mov(rax,
