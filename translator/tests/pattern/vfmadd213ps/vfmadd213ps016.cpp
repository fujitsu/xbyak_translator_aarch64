...
public:
  ...
  void genJitTestCode() {
    ...
    /* EVEX encode */
    vfmadd213ps(Zmm(20) | k5, Zmm(21), Zmm(22));
    vfmadd213ps(Zmm(23) | k4, Zmm(23), Zmm(24));
    vfmadd213ps(Zmm(25) | k3, Zmm(26), Zmm(25));
    vfmadd213ps(Zmm(27) | k2, Zmm(28), Zmm(28));
    vfmadd213ps(Zmm(29) | k1, Zmm(29), Zmm(29));
