...
/* Address is aligned */
    ...
    mov(rax, addr5);
    vfmadd213ps(Xmm(16) | k1 | T_z, Xmm(17), ptr[rax]);
    mov(rax, addr6);
    vfmadd213ps(Xmm(19) | k2 | T_z, Xmm(19), ptr[rax]);
    mov(rax, addr7);
    vfmadd213ps(Xmm(21) | k3 | T_z, Xmm(22), ptr[rax]);
    mov(rax, addr8);
    vfmadd213ps(Xmm(22) | k4 | T_z, Xmm(23), ptr[rax]);
    mov(rax, addr9);
    vfmadd213ps(Xmm(24) | k5 | T_z, Xmm(24), ptr[rax]);
    mov(rax,
