...
/* Address is aligned */
    ...
    mov(rax, addr5);
    vfmadd132ps(Xmm(16) | k1, Xmm(17), ptr[rax]);
    vmovdqu8(Xmm(25), ptr[rax]);
    mov(rax, addr6);
    vfmadd132ps(Xmm(19) | k2, Xmm(19), ptr[rax]);
    vmovdqu8(Xmm(26), ptr[rax]);
    mov(rax, addr7);
    vfmadd132ps(Xmm(21) | k3, Xmm(22), ptr[rax]);
    vmovdqu8(Xmm(27), ptr[rax]);
    mov(rax, addr8);
    vfmadd132ps(Xmm(22) | k4, Xmm(23), ptr[rax]);
    vmovdqu8(Xmm(28), ptr[rax]);
    mov(rax, addr9);
    vfmadd132ps(Xmm(24) | k5, Xmm(24), ptr[rax]);
