...
/* Address is aligned */
    ...
    mov(rax, addr5);
    vfmadd132ps(Zmm(16) | k1, Zmm(17), ptr[rax]);
    vmovdqu8(Zmm(25), ptr[rax]);
    mov(rax, addr6);
    vfmadd132ps(Zmm(19) | k2, Zmm(19), ptr[rax]);
    vmovdqu8(Zmm(26), ptr[rax]);
    mov(rax, addr7);
    vfmadd132ps(Zmm(21) | k3, Zmm(22), ptr[rax]);
    vmovdqu8(Zmm(27), ptr[rax]);
    mov(rax, addr8);
    vfmadd132ps(Zmm(22) | k4, Zmm(23), ptr[rax]);
    vmovdqu8(Zmm(28), ptr[rax]);
    mov(rax, addr9);
    vfmadd132ps(Zmm(24) | k5, Zmm(24), ptr[rax]);
