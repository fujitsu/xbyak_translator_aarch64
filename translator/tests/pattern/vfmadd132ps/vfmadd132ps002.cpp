...
/* Address is aligned */
    ...
    mov(rax, addr5);
    vfmadd132ps(Zmm(16), Zmm(17), ptr[rax]);
    vmovdqu8(Zmm(25), ptr[rax]);
    mov(rax, addr6);
    vfmadd132ps(Zmm(19), Zmm(19), ptr[rax]);
    vmovdqu8(Zmm(26), ptr[rax]);
    mov(rax, addr7);
    vfmadd132ps(Zmm(21), Zmm(22), ptr[rax]);
    vmovdqu8(Zmm(27), ptr[rax]);
    mov(rax, addr8);
    vfmadd132ps(Zmm(22), Zmm(23), ptr[rax]);
    vmovdqu8(Zmm(28), ptr[rax]);
    mov(rax, addr9);
    vfmadd132ps(Zmm(24), Zmm(24), ptr[rax]);
