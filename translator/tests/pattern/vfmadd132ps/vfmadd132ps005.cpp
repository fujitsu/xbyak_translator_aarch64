...
public:
  ...
  void genJitTestCode() {
    ...
    /* EVEX encode */
    vfmadd132ps(Zmm(20) | k1, Zmm(21), Zmm(22));
    vfmadd132ps(Zmm(23) | k2, Zmm(23), Zmm(24));
    vfmadd132ps(Zmm(25) | k3, Zmm(26), Zmm(25));
    vfmadd132ps(Zmm(27) | k4, Zmm(28), Zmm(28));
    vfmadd132ps(Zmm(29) | k5, Zmm(29), Zmm(29));
  }
};
