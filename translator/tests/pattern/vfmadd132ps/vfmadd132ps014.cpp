...
public:
  ...
  void genJitTestCode() {
    ...
    /* EVEX encode */
    vfmadd132ps(Xmm(20) | k1 | T_z, Xmm(21), Xmm(22));
    vfmadd132ps(Xmm(23) | k2 | T_z, Xmm(23), Xmm(24));
    vfmadd132ps(Xmm(25) | k3 | T_z, Xmm(26), Xmm(25));
    vfmadd132ps(Xmm(27) | k4 | T_z, Xmm(28), Xmm(28));
    vfmadd132ps(Xmm(29) | k5 | T_z, Xmm(29), Xmm(29));
