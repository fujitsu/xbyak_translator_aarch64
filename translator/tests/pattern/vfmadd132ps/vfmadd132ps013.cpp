...
public:
  void setInitialRegValue() {
    ...
    for (unsigned int j = 0; j < NUM_Z_REG; j++) {
      for (unsigned int i = 0; i < NUM_BYTES_Z_REG / 2 / sizeof(float); i++) {
...
/* Address is aligned */
    ...
    mov(rax, addr);
    vfmadd132ps(Xmm(0), Xmm(1), ptr[rax]);
    vmovdqu8(Xmm(10), ptr[rax]);
    mov(rax, addr1);
    vfmadd132ps(Xmm(3), Xmm(3), ptr[rax]);
    vmovdqu8(Xmm(11), ptr[rax]);
    mov(rax, addr2);
    vfmadd132ps(Xmm(5), Xmm(6), ptr[rax]);
    vmovdqu8(Xmm(12), ptr[rax]);
    mov(rax, addr3);
    vfmadd132ps(Xmm(7), Xmm(8), ptr[rax]);
    vmovdqu8(Xmm(13), ptr[rax]);
    mov(rax, addr4);
    vfmadd132ps(Xmm(9), Xmm(9), ptr[rax]);
    vmovdqu8(Xmm(14), ptr[rax]);
    ...
    mov(rax, addr5);
    vfmadd132ps(Xmm(16), Xmm(17), ptr[rax]);
    vmovdqu8(Xmm(25), ptr[rax]);
    mov(rax, addr6);
    vfmadd132ps(Xmm(19), Xmm(19), ptr[rax]);
    vmovdqu8(Xmm(26), ptr[rax]);
    mov(rax, addr7);
    vfmadd132ps(Xmm(21), Xmm(22), ptr[rax]);
    vmovdqu8(Xmm(27), ptr[rax]);
    mov(rax, addr8);
    vfmadd132ps(Xmm(22), Xmm(23), ptr[rax]);
    vmovdqu8(Xmm(28), ptr[rax]);
    mov(rax, addr9);
    vfmadd132ps(Xmm(24), Xmm(24), ptr[rax]);
    vmovdqu8(Xmm(29), ptr[rax]);
    mov(rax,
