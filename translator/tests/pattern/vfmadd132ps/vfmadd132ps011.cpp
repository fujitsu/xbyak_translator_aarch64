...
/* Address is aligned */
    ...
    mov(rax, addr5);
    vfmadd132ps(Ymm(16) | k1, Ymm(17), ptr[rax]);
    vmovdqu8(Ymm(25), ptr[rax]);
    mov(rax, addr6);
    vfmadd132ps(Ymm(19) | k2, Ymm(19), ptr[rax]);
    vmovdqu8(Ymm(26), ptr[rax]);
    mov(rax, addr7);
    vfmadd132ps(Ymm(21) | k3, Ymm(22), ptr[rax]);
    vmovdqu8(Ymm(27), ptr[rax]);
    mov(rax, addr8);
    vfmadd132ps(Ymm(22) | k4, Ymm(23), ptr[rax]);
    vmovdqu8(Ymm(28), ptr[rax]);
    mov(rax, addr9);
    vfmadd132ps(Ymm(24) | k5, Ymm(24), ptr[rax]);
