...
public:
  ...
  void genJitTestCode() {
    ...
    /* EVEX encode */
    vfmadd132ps(Ymm(20) | k1 | T_z, Ymm(21), Ymm(22));
    vfmadd132ps(Ymm(23) | k2 | T_z, Ymm(23), Ymm(24));
    vfmadd132ps(Ymm(25) | k3 | T_z, Ymm(26), Ymm(25));
    vfmadd132ps(Ymm(27) | k4 | T_z, Ymm(28), Ymm(28));
    vfmadd132ps(Ymm(29) | k5 | T_z, Ymm(29), Ymm(29));
  }
};
