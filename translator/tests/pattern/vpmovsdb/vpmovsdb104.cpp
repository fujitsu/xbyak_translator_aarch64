...
public:
  ...
  void genJitTestCode() {
    ...
    /* Dst=Mem, src=Zmm */
    vpmovsdb(Xmm(1) | k1, Zmm(31));
    vpmovsdb(Xmm(2) | k2, Zmm(31));
    vpmovsdb(Xmm(3) | k3, Zmm(31));
    vpmovsdb(Xmm(4) | k4, Zmm(31));
    vpmovsdb(Xmm(5) | k7, Zmm(31));
    /* Dst=Mem, src=Ymm */
    vpmovsdb(Xmm(6) | k1, Ymm(31));
    vpmovsdb(Xmm(7) | k2, Ymm(31));
    vpmovsdb(Xmm(8) | k3, Ymm(31));
    vpmovsdb(Xmm(9) | k4, Ymm(31));
    vpmovsdb(Xmm(10) | k7, Ymm(31));
    /* Dst=Mem, src=Xmm */
    vpmovsdb(Xmm(11) | k1, Xmm(31));
    vpmovsdb(Xmm(12) | k2, Xmm(31));
    vpmovsdb(Xmm(13) | k3, Xmm(31));
    vpmovsdb(Xmm(14) | k4, Xmm(31));
    vpmovsdb(Xmm(15) | k7, Xmm(31));
  }
};
