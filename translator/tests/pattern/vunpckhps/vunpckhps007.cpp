...
public:
  ...
  void genJitTestCode() {
    ...
    vunpckhps(Zmm(1) | k1, Zmm(1), Zmm(2));
    vunpckhps(Zmm(2) | k2, Zmm(1), Zmm(2));
    vunpckhps(Zmm(3) | k3, Zmm(1), Zmm(2));
    vunpckhps(Zmm(4) | k4, Zmm(1), Zmm(2));
    vunpckhps(Zmm(5) | k5, Zmm(1), Zmm(2));
    vunpckhps(Zmm(6) | k6, Zmm(1), Zmm(2));
    vunpckhps(Zmm(7) | k7, Zmm(1), Zmm(2));
  }
};
