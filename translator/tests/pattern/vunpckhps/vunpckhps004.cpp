...
public:
  ...
  void genJitTestCode() {
    ...
    vunpckhps(Zmm(1) | k1 | T_z, Zmm(1), Zmm(2));
    vunpckhps(Zmm(2) | k2 | T_z, Zmm(1), Zmm(2));
    vunpckhps(Zmm(3) | k3 | T_z, Zmm(1), Zmm(2));
    vunpckhps(Zmm(4) | k4 | T_z, Zmm(1), Zmm(2));
    vunpckhps(Zmm(5) | k5 | T_z, Zmm(1), Zmm(2));
    vunpckhps(Zmm(6) | k6 | T_z, Zmm(1), Zmm(2));
    vunpckhps(Zmm(7) | k7 | T_z, Zmm(1), Zmm(2));
  }
};
