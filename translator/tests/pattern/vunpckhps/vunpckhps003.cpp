...
public:
  ...
  void genJitTestCode() {
    ...
    vunpckhps(Ymm(1) | k1 | T_z, Ymm(1), Ymm(2));
    vunpckhps(Ymm(2) | k2 | T_z, Ymm(1), Ymm(2));
    vunpckhps(Ymm(3) | k3 | T_z, Ymm(1), Ymm(2));
    vunpckhps(Ymm(4) | k4 | T_z, Ymm(1), Ymm(2));
    vunpckhps(Ymm(5) | k5 | T_z, Ymm(1), Ymm(2));
    vunpckhps(Ymm(6) | k6 | T_z, Ymm(1), Ymm(2));
    vunpckhps(Ymm(7) | k7 | T_z, Ymm(1), Ymm(2));
  }
};
