...
public:
  ...
  void genJitTestCode() {
    ...
    vunpckhps(Xmm(1) | k1, Xmm(1), Xmm(2));
    vunpckhps(Xmm(2) | k2, Xmm(1), Xmm(2));
    vunpckhps(Xmm(3) | k3, Xmm(1), Xmm(2));
    vunpckhps(Xmm(4) | k4, Xmm(1), Xmm(2));
    vunpckhps(Xmm(5) | k5, Xmm(1), Xmm(2));
    vunpckhps(Xmm(6) | k6, Xmm(1), Xmm(2));
    vunpckhps(Xmm(7) | k7, Xmm(1), Xmm(2));
  }
};
