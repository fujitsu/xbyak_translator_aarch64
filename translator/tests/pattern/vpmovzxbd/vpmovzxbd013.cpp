...
public:
  ...
  void genJitTestCode() {
    ...
    vpmovzxbd(Xmm(1) | k1 | T_z, ptr[rax]);
    vpmovzxbd(Xmm(2) | k2 | T_z, ptr[rax]);
    vpmovzxbd(Xmm(3) | k3 | T_z, ptr[rax]);
    vpmovzxbd(Xmm(4) | k4 | T_z, ptr[rax]);
    vpmovzxbd(Xmm(5) | k5 | T_z, ptr[rax]);
    vpmovzxbd(Xmm(6) | k6 | T_z, ptr[rax]);
    vpmovzxbd(Xmm(7) | k7 | T_z, ptr[rax]);

    /* Register index is EVEX range. */
    vpmovzxbd(Xmm(21) | k1 | T_z, ptr[rcx]);
    vpmovzxbd(Xmm(22) | k2 | T_z, ptr[rcx]);
    vpmovzxbd(Xmm(23) | k3 | T_z, ptr[rcx]);
    vpmovzxbd(Xmm(24) | k4 | T_z, ptr[rcx]);
    vpmovzxbd(Xmm(25) | k5 | T_z, ptr[rcx]);
    vpmovzxbd(Xmm(26) | k6 | T_z, ptr[rcx]);
    vpmovzxbd(Xmm(27) | k7 | T_z, ptr[rcx]);
