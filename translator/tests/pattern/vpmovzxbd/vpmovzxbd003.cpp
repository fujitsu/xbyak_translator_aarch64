...
public:
  ...
  void genJitTestCode() {
    ...
    vpmovzxbd(Zmm(1) | k1, ptr[rax]);
    vpmovzxbd(Zmm(2) | k2, ptr[rax]);
    vpmovzxbd(Zmm(3) | k3, ptr[rax]);
    vpmovzxbd(Zmm(4) | k4, ptr[rax]);
    vpmovzxbd(Zmm(5) | k5, ptr[rax]);
    vpmovzxbd(Zmm(6) | k6, ptr[rax]);
    vpmovzxbd(Zmm(7) | k7, ptr[rax]);

    /* Register index is EVEX range. */
    vpmovzxbd(Zmm(21) | k1, ptr[rcx]);
    vpmovzxbd(Zmm(22) | k2, ptr[rcx]);
    vpmovzxbd(Zmm(23) | k3, ptr[rcx]);
    vpmovzxbd(Zmm(24) | k4, ptr[rcx]);
    vpmovzxbd(Zmm(25) | k5, ptr[rcx]);
    vpmovzxbd(Zmm(26) | k6, ptr[rcx]);
    vpmovzxbd(Zmm(27) | k7, ptr[rcx]);
