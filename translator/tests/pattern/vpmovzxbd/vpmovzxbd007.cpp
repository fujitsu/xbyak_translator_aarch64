...
public:
  ...
  void genJitTestCode() {
    ...
    vpmovzxbd(Ymm(1) | k1, ptr[rax]);
    vpmovzxbd(Ymm(2) | k2, ptr[rax]);
    vpmovzxbd(Ymm(3) | k3, ptr[rax]);
    vpmovzxbd(Ymm(4) | k4, ptr[rax]);
    vpmovzxbd(Ymm(5) | k5, ptr[rax]);
    vpmovzxbd(Ymm(6) | k6, ptr[rax]);
    vpmovzxbd(Ymm(7) | k7, ptr[rax]);

    /* Register index is EVEX range. */
    vpmovzxbd(Ymm(21) | k1, ptr[rcx]);
    vpmovzxbd(Ymm(22) | k2, ptr[rcx]);
    vpmovzxbd(Ymm(23) | k3, ptr[rcx]);
    vpmovzxbd(Ymm(24) | k4, ptr[rcx]);
    vpmovzxbd(Ymm(25) | k5, ptr[rcx]);
    vpmovzxbd(Ymm(26) | k6, ptr[rcx]);
    vpmovzxbd(Ymm(27) | k7, ptr[rcx]);
