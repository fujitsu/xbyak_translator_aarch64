...
public:
  ...
  void genJitTestCode() {
    ...
    vpmovzxbd(Zmm(1) | k1 | T_z, ptr[rax]);
    vpmovzxbd(Zmm(2) | k2 | T_z, ptr[rax]);
    vpmovzxbd(Zmm(3) | k3 | T_z, ptr[rax]);
    vpmovzxbd(Zmm(4) | k4 | T_z, ptr[rax]);
    vpmovzxbd(Zmm(5) | k5 | T_z, ptr[rax]);
    vpmovzxbd(Zmm(6) | k6 | T_z, ptr[rax]);
    vpmovzxbd(Zmm(7) | k7 | T_z, ptr[rax]);

    /* Register index is EVEX range. */
    vpmovzxbd(Zmm(21) | k1 | T_z, ptr[rcx]);
    vpmovzxbd(Zmm(22) | k2 | T_z, ptr[rcx]);
    vpmovzxbd(Zmm(23) | k3 | T_z, ptr[rcx]);
    vpmovzxbd(Zmm(24) | k4 | T_z, ptr[rcx]);
    vpmovzxbd(Zmm(25) | k5 | T_z, ptr[rcx]);
    vpmovzxbd(Zmm(26) | k6 | T_z, ptr[rcx]);
    vpmovzxbd(Zmm(27) | k7 | T_z, ptr[rcx]);
