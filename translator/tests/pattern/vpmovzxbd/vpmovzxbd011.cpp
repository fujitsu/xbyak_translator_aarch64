...
public:
  ...
  void genJitTestCode() {
    ...
    vpmovzxbd(Xmm(1) | k1, ptr[rax]);
    vpmovzxbd(Xmm(2) | k2, ptr[rax]);
    vpmovzxbd(Xmm(3) | k3, ptr[rax]);
    vpmovzxbd(Xmm(4) | k4, ptr[rax]);
    vpmovzxbd(Xmm(5) | k5, ptr[rax]);
    vpmovzxbd(Xmm(6) | k6, ptr[rax]);
    vpmovzxbd(Xmm(7) | k7, ptr[rax]);

    /* Register index is EVEX range. */
    vpmovzxbd(Xmm(21) | k1, ptr[rcx]);
    vpmovzxbd(Xmm(22) | k2, ptr[rcx]);
    vpmovzxbd(Xmm(23) | k3, ptr[rcx]);
    vpmovzxbd(Xmm(24) | k4, ptr[rcx]);
    vpmovzxbd(Xmm(25) | k5, ptr[rcx]);
    vpmovzxbd(Xmm(26) | k6, ptr[rcx]);
    vpmovzxbd(Xmm(27) | k7, ptr[rcx]);
