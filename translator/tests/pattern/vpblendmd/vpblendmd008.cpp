...
public:
  ...
  void genJitTestCode() {
    ...
    vpblendmd(Xmm(1) | k1, Xmm(30), ptr_b[rax]);
    vpblendmd(Xmm(2) | k2, Xmm(30), ptr_b[rax]);
    vpblendmd(Xmm(3) | k3, Xmm(30), ptr_b[rax]);
    vpblendmd(Xmm(4) | k4, Xmm(30), ptr_b[rax]);
    vpblendmd(Xmm(5) | k5, Xmm(30), ptr_b[rax]);
    vpblendmd(Xmm(6) | k6, Xmm(30), ptr_b[rax]);
    vpblendmd(Xmm(7) | k7, Xmm(30), ptr_b[rax]);

    vpblendmd(Xmm(10) | k6, Xmm(10), ptr_b[rax]); /* dstIdx = srcIdx */
    vpblendmd(Xmm(11) | k7, Xmm(11), ptr_b[rax]); /* dstIdx = srcIdx */
