...
public:
  ...
  void genJitTestCode() {
    ...
    vpblendmd(Zmm(1) | k1 | T_z, Zmm(30), ptr[rax]);
    vpblendmd(Zmm(2) | k2 | T_z, Zmm(30), ptr[rax]);
    vpblendmd(Zmm(3) | k3 | T_z, Zmm(30), ptr[rax]);
    vpblendmd(Zmm(4) | k4 | T_z, Zmm(30), ptr[rax]);
    vpblendmd(Zmm(5) | k5 | T_z, Zmm(30), ptr[rax]);
    vpblendmd(Zmm(6) | k6 | T_z, Zmm(30), ptr[rax]);
    vpblendmd(Zmm(7) | k7 | T_z, Zmm(30), ptr[rax]);

    vpblendmd(Zmm(10) | k6 | T_z, Zmm(10), ptr[rax]); /* dstIdx = srcIdx */
    vpblendmd(Zmm(11) | k7 | T_z, Zmm(11), ptr[rax]); /* dstIdx = srcIdx */
