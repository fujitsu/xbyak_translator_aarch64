...
public:
  ...
  void genJitTestCode() {
    ...
    vpblendmd(Ymm(1) | k1, Ymm(30), ptr[rax]);
    vpblendmd(Ymm(2) | k2, Ymm(30), ptr[rax]);
    vpblendmd(Ymm(3) | k3, Ymm(30), ptr[rax]);
    vpblendmd(Ymm(4) | k4, Ymm(30), ptr[rax]);
    vpblendmd(Ymm(5) | k5, Ymm(30), ptr[rax]);
    vpblendmd(Ymm(6) | k6, Ymm(30), ptr[rax]);
    vpblendmd(Ymm(7) | k7, Ymm(30), ptr[rax]);

    vpblendmd(Ymm(10) | k6, Ymm(10), ptr[rax]); /* dstIdx = srcIdx */
    vpblendmd(Ymm(11) | k7, Ymm(11), ptr[rax]); /* dstIdx = srcIdx */
