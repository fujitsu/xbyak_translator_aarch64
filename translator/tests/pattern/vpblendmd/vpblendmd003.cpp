...
public:
  ...
  void genJitTestCode() {
    ...
    vpblendmd(Zmm(1) | k1, Zmm(30), Zmm(31));
    vpblendmd(Zmm(2) | k2, Zmm(30), Zmm(31));
    vpblendmd(Zmm(3) | k3, Zmm(30), Zmm(31));
    vpblendmd(Zmm(4) | k4, Zmm(30), Zmm(31));
    vpblendmd(Zmm(5) | k5, Zmm(30), Zmm(31));
