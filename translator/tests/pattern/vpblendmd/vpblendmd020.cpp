...
public:
  ...
  void genJitTestCode() {
    ...
    vpblendmd(Ymm(1) | k1 | T_z, Ymm(30), ptr_b[rax]);
    vpblendmd(Ymm(2) | k2 | T_z, Ymm(30), ptr_b[rax]);
    vpblendmd(Ymm(3) | k3 | T_z, Ymm(30), ptr_b[rax]);
    vpblendmd(Ymm(4) | k4 | T_z, Ymm(30), ptr_b[rax]);
    vpblendmd(Ymm(5) | k5 | T_z, Ymm(30), ptr_b[rax]);
    vpblendmd(Ymm(6) | k6 | T_z, Ymm(30), ptr_b[rax]);
    vpblendmd(Ymm(7) | k7 | T_z, Ymm(30), ptr_b[rax]);

    vpblendmd(Ymm(10) | k6 | T_z, Ymm(10), ptr_b[rax]); /* dstIdx = srcIdx */
    vpblendmd(Ymm(11) | k7 | T_z, Ymm(11), ptr_b[rax]); /* dstIdx = srcIdx */
