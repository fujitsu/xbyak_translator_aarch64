...
public:
  ...
  void genJitTestCode() {
    ...
    vblendvps(Ymm(2), Ymm(0), ptr[rax], Ymm(11));
    vblendvps(Ymm(3), Ymm(0), ptr[rax], Ymm(12));
    vblendvps(Ymm(4), Ymm(0), ptr[rax], Ymm(13));

    vblendvps(Ymm(5), Ymm(5), ptr[rax], Ymm(11));
    vblendvps(Ymm(6), Ymm(6), ptr[rax], Ymm(12));
    vblendvps(Ymm(7), Ymm(7), ptr[rax], Ymm(13));

    addr = reinterpret_cast<size_t>(&(inputZReg[8].ud_dt[0]));
    mov(rax, addr);
    vblendvps(Ymm(8), Ymm(0), ptr[rax], Ymm(11));
    addr = reinterpret_cast<size_t>(&(inputZReg[9].ud_dt[0]));
    mov(rax, addr);
    vblendvps(Ymm(9), Ymm(0), ptr[rax], Ymm(12));
    addr = reinterpret_cast<size_t>(&(inputZReg[10].ud_dt[0]));
    mov(rax, addr);
    vblendvps(Ymm(10), Ymm(0), ptr[rax], Ymm(13));
