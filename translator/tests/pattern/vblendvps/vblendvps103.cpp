...
public:
  ...
  void genJitTestCode() {
    ...
    vblendvps(Xmm(2), Xmm(1), Xmm(11), Xmm(11));
    vblendvps(Xmm(3), Xmm(1), Xmm(12), Xmm(12));
    vblendvps(Xmm(4), Xmm(1), Xmm(13), Xmm(13));

    vblendvps(Xmm(5), Xmm(11), Xmm(1), Xmm(11));
    vblendvps(Xmm(6), Xmm(12), Xmm(1), Xmm(12));
    vblendvps(Xmm(7), Xmm(13), Xmm(1), Xmm(13));
  }
};
