...
public:
  ...
  void genJitTestCode() {
    ...
    vblendvps(Ymm(0), Ymm(0), Ymm(7), Ymm(11));
    vblendvps(Ymm(2), Ymm(2), Ymm(7), Ymm(12));
    vblendvps(Ymm(3), Ymm(3), Ymm(7), Ymm(13));

    vblendvps(Ymm(4), Ymm(7), Ymm(4), Ymm(11));
    vblendvps(Ymm(5), Ymm(7), Ymm(5), Ymm(12));
    vblendvps(Ymm(6), Ymm(7), Ymm(6), Ymm(13));
  }
};
