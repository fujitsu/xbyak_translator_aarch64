...
public:
  ...
  void genJitTestCode() {
    ...
    vblendvps(Xmm(0), Xmm(0), Xmm(7), Xmm(11));
    vblendvps(Xmm(2), Xmm(2), Xmm(7), Xmm(12));
    vblendvps(Xmm(3), Xmm(3), Xmm(7), Xmm(13));

    vblendvps(Xmm(4), Xmm(7), Xmm(4), Xmm(11));
    vblendvps(Xmm(5), Xmm(7), Xmm(5), Xmm(12));
    vblendvps(Xmm(6), Xmm(7), Xmm(6), Xmm(13));
  }
};
