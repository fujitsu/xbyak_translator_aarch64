...
public:
  ...
  void genJitTestCode() {
    ...
    vblendvps(Ymm(2), Ymm(1), Ymm(11), Ymm(11));
    vblendvps(Ymm(3), Ymm(1), Ymm(12), Ymm(12));
    vblendvps(Ymm(4), Ymm(1), Ymm(13), Ymm(13));

    vblendvps(Ymm(5), Ymm(11), Ymm(1), Ymm(11));
    vblendvps(Ymm(6), Ymm(12), Ymm(1), Ymm(12));
    vblendvps(Ymm(7), Ymm(13), Ymm(1), Ymm(13));
  }
};
