...
public:
  ...
  void genJitTestCode() {
    ...
    vpunpckldq(Ymm(2) | k2, Ymm(30), Ymm(31));
    vpunpckldq(Ymm(3) | k3, Ymm(30), Ymm(31));
    vpunpckldq(Ymm(4) | k4, Ymm(30), Ymm(31));
    vpunpckldq(Ymm(5) | k5, Ymm(30), Ymm(31));
    ...
    */
    vpunpckldq(Ymm(22) | k1, Ymm(22), Ymm(22));
    vpunpckldq(Ymm(23) | k2, Ymm(23), Ymm(23));
    vpunpckldq(Ymm(24) | k3, Ymm(24), Ymm(24));
    vpunpckldq(Ymm(25) | k4, Ymm(25), Ymm(25));
