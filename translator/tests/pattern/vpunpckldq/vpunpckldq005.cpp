...
public:
  ...
  void genJitTestCode() {
    ...
    vpunpckldq(Xmm(2) | k2, Xmm(30), Xmm(31));
    vpunpckldq(Xmm(3) | k3, Xmm(30), Xmm(31));
    vpunpckldq(Xmm(4) | k4, Xmm(30), Xmm(31));
    vpunpckldq(Xmm(5) | k5, Xmm(30), Xmm(31));
    ...
    */
    vpunpckldq(Xmm(22) | k1, Xmm(22), Xmm(22));
    vpunpckldq(Xmm(23) | k2, Xmm(23), Xmm(23));
    vpunpckldq(Xmm(24) | k3, Xmm(24), Xmm(24));
    vpunpckldq(Xmm(25) | k4, Xmm(25), Xmm(25));
