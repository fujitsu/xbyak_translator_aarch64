...
public:
  ...
  void genJitTestCode() {
    ...
    vmovdqu32(Ymm(0) | k1 | T_z, Ymm(1));
    vmovdqu32(Ymm(2) | k2 | T_z, Ymm(3));
    vmovdqu32(Ymm(4) | k3 | T_z, Ymm(5));
    vmovdqu32(Ymm(6) | k4 | T_z, Ymm(7));
    vmovdqu32(Ymm(8) | k5 | T_z, Ymm(9));
    vmovdqu32(Ymm(10) | k6 | T_z, Ymm(11));
    vmovdqu32(Ymm(12) | k7 | T_z, Ymm(13));

    vmovdqu32(Ymm(14) | k1 | T_z, Ymm(14));
    vmovdqu32(Ymm(15) | k2 | T_z, Ymm(15));
    vmovdqu32(Ymm(16) | k3 | T_z, Ymm(16));
    vmovdqu32(Ymm(17) | k4 | T_z, Ymm(17));
    vmovdqu32(Ymm(18) | k5 | T_z, Ymm(18));
    vmovdqu32(Ymm(19) | k6 | T_z, Ymm(19));
    vmovdqu32(Ymm(20) | k7 | T_z, Ymm(20));
  }
};
