...
public:
  ...
  void genJitTestCode() {
    ...
    vmovdqu32(Xmm(0) | k1 | T_z, Xmm(1));
    vmovdqu32(Xmm(2) | k2 | T_z, Xmm(3));
    vmovdqu32(Xmm(4) | k3 | T_z, Xmm(5));
    vmovdqu32(Xmm(6) | k4 | T_z, Xmm(7));
    vmovdqu32(Xmm(8) | k5 | T_z, Xmm(9));
    vmovdqu32(Xmm(10) | k6 | T_z, Xmm(11));
    vmovdqu32(Xmm(12) | k7 | T_z, Xmm(13));

    vmovdqu32(Xmm(14) | k1 | T_z, Xmm(14));
    vmovdqu32(Xmm(15) | k2 | T_z, Xmm(15));
    vmovdqu32(Xmm(16) | k3 | T_z, Xmm(16));
    vmovdqu32(Xmm(17) | k4 | T_z, Xmm(17));
    vmovdqu32(Xmm(18) | k5 | T_z, Xmm(18));
    vmovdqu32(Xmm(19) | k6 | T_z, Xmm(19));
    vmovdqu32(Xmm(20) | k7 | T_z, Xmm(20));
  }
};
