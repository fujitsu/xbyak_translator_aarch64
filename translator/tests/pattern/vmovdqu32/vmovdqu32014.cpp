...
public:
  ...
  void genJitTestCode() {
    ...
    vmovdqu32(ptr[rax] | k1 | T_z, Ymm(0));
    vmovdqu32(Zmm(1), ptr[rax]);

    vmovdqu32(ptr[rax] | k2 | T_z, Ymm(2));
    vmovdqu32(Zmm(3), ptr[rax]);

    vmovdqu32(ptr[rax] | k3 | T_z, Ymm(4));
    vmovdqu32(Zmm(5), ptr[rax]);

    vmovdqu32(ptr[rax] | k4 | T_z, Ymm(6));
    vmovdqu32(Zmm(7), ptr[rax]);

    vmovdqu32(ptr[rax] | k5 | T_z, Ymm(8));
    vmovdqu32(Zmm(9), ptr[rax]);

    vmovdqu32(ptr[rax] | k6 | T_z, Ymm(10));
    vmovdqu32(Zmm(11), ptr[rax]);

    vmovdqu32(ptr[rax] | k7 | T_z, Ymm(12));
    ...
    vmovdqu32(ptr[rax] | k1 | T_z, Ymm(14));
    vmovdqu32(Zmm(15), ptr[rax]);

    vmovdqu32(ptr[rax] | k2 | T_z, Ymm(16));
    vmovdqu32(Zmm(17), ptr[rax]);

    vmovdqu32(ptr[rax] | k3 | T_z, Ymm(18));
    vmovdqu32(Zmm(19), ptr[rax]);

    vmovdqu32(ptr[rax] | k4 | T_z, Ymm(20));
    vmovdqu32(Zmm(21), ptr[rax]);

    vmovdqu32(ptr[rax] | k5 | T_z, Ymm(22));
    vmovdqu32(Zmm(23), ptr[rax]);

    vmovdqu32(ptr[rax] | k6 | T_z, Ymm(24));
    vmovdqu32(Zmm(25), ptr[rax]);

    vmovdqu32(ptr[rax] | k7 | T_z, Ymm(26));
