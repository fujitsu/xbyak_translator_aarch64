...
public:
  ...
  void genJitTestCode() {
    ...
    vmovdqu32(Ymm(0) | k1, Ymm(1));
    vmovdqu32(Ymm(2) | k2, Ymm(3));
    vmovdqu32(Ymm(4) | k3, Ymm(5));
    vmovdqu32(Ymm(6) | k4, Ymm(7));
    vmovdqu32(Ymm(8) | k5, Ymm(9));
    vmovdqu32(Ymm(10) | k6, Ymm(11));
    vmovdqu32(Ymm(12) | k7, Ymm(13));

    vmovdqu32(Ymm(14) | k1, Ymm(14));
    vmovdqu32(Ymm(15) | k2, Ymm(15));
    vmovdqu32(Ymm(16) | k3, Ymm(16));
    vmovdqu32(Ymm(17) | k4, Ymm(17));
    vmovdqu32(Ymm(18) | k5, Ymm(18));
    vmovdqu32(Ymm(19) | k6, Ymm(19));
    vmovdqu32(Ymm(20) | k7, Ymm(20));
  }
};
