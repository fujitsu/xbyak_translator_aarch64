...
public:
  ...
  void genJitTestCode() {
    ...
    vmovdqu32(Zmm(0) | k1, Zmm(1));
    vmovdqu32(Zmm(2) | k2, Zmm(3));
    vmovdqu32(Zmm(4) | k3, Zmm(5));
    vmovdqu32(Zmm(6) | k4, Zmm(7));
    vmovdqu32(Zmm(8) | k5, Zmm(9));
    vmovdqu32(Zmm(10) | k6, Zmm(11));
    vmovdqu32(Zmm(12) | k7, Zmm(13));

    vmovdqu32(Zmm(14) | k1, Zmm(14));
    vmovdqu32(Zmm(15) | k2, Zmm(15));
    vmovdqu32(Zmm(16) | k3, Zmm(16));
    vmovdqu32(Zmm(17) | k4, Zmm(17));
    vmovdqu32(Zmm(18) | k5, Zmm(18));
    vmovdqu32(Zmm(19) | k6, Zmm(19));
    vmovdqu32(Zmm(20) | k7, Zmm(20));
  }
};
