...
public:
  ...
  void genJitTestCode() {
    ...
    vmovdqu16(Zmm(1) | k1 | T_z, ptr[rax]);
    vmovdqu16(Zmm(2) | k2 | T_z, ptr[rax]);
    vmovdqu16(Zmm(3) | k3 | T_z, ptr[rax]);
    vmovdqu16(Zmm(4) | k4 | T_z, ptr[rax]);
    vmovdqu16(Zmm(5) | k5 | T_z, ptr[rax]);
    vmovdqu16(Zmm(6) | k6 | T_z, ptr[rax]);
    vmovdqu16(Zmm(7) | k7 | T_z, ptr[rax]);
