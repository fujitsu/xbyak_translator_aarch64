...
public:
  ...
  void genJitTestCode() {
    ...
    vmovdqu16(Xmm(0) | k1, Xmm(1));
    vmovdqu16(Xmm(2) | k2, Xmm(3));
    vmovdqu16(Xmm(4) | k3, Xmm(5));
    vmovdqu16(Xmm(6) | k4, Xmm(7));
    vmovdqu16(Xmm(8) | k5, Xmm(9));
    vmovdqu16(Xmm(10) | k6, Xmm(11));
    vmovdqu16(Xmm(12) | k7, Xmm(13));

    vmovdqu16(Xmm(14) | k1, Xmm(14));
    vmovdqu16(Xmm(15) | k2, Xmm(15));
    vmovdqu16(Xmm(16) | k3, Xmm(16));
    vmovdqu16(Xmm(17) | k4, Xmm(17));
    vmovdqu16(Xmm(18) | k5, Xmm(18));
    vmovdqu16(Xmm(19) | k6, Xmm(19));
    vmovdqu16(Xmm(20) | k7, Xmm(20));
  }
};
