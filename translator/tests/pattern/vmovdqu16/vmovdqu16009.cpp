...
public:
  ...
  void genJitTestCode() {
    ...
    vmovdqu16(Zmm(0) | k1, Zmm(1));
    vmovdqu16(Zmm(2) | k2, Zmm(3));
    vmovdqu16(Zmm(4) | k3, Zmm(5));
    vmovdqu16(Zmm(6) | k4, Zmm(7));
    vmovdqu16(Zmm(8) | k5, Zmm(9));
    vmovdqu16(Zmm(10) | k6, Zmm(11));
    vmovdqu16(Zmm(12) | k7, Zmm(13));

    vmovdqu16(Zmm(14) | k1, Zmm(14));
    vmovdqu16(Zmm(15) | k2, Zmm(15));
    vmovdqu16(Zmm(16) | k3, Zmm(16));
    vmovdqu16(Zmm(17) | k4, Zmm(17));
    vmovdqu16(Zmm(18) | k5, Zmm(18));
    vmovdqu16(Zmm(19) | k6, Zmm(19));
    vmovdqu16(Zmm(20) | k7, Zmm(20));
  }
};
