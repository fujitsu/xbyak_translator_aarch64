...
public:
  ...
  void genJitTestCode() {
    ...
    */
    ...
    mov(rax, addr);
    mov(rbx, addr);
    vmovdqu16(Zmm(8), ptr[rax]);
    //vmovdqu16(ptr[rbx], Zmm(8));
    //vmovdqu16(Zmm(9), ptr[rbx]);
#endif
    ...
    mov(rax, addr);
    mov(rbx, addr);
    vmovdqu16(Xmm(4), ptr[rax]);
    vmovdqu16(ptr[rbx], Xmm(4));
    vmovdqu16(Xmm(5), ptr[rbx]);
#endif
    ...
    mov(rax, addr);
    mov(rbx, addr);
    vmovdqu16(Ymm(6), ptr[rax]);
    vmovdqu16(ptr[rbx], Ymm(6));
    vmovdqu16(Ymm(7), ptr[rbx]);
#endif
    ...
    mov(rax, addr);
    mov(rbx, addr);
    vmovdqu16(Zmm(10), ptr[rax]);
    vmovdqu16(ptr[rbx], Zmm(10));
    vmovdqu16(Zmm(11), ptr[rbx]);
#endif
    */
    mov(rax,
