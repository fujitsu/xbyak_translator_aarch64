...
public:
  ...
  void genJitTestCode() {
    ...
    /* z31 - z29 are used as zTmpIdx - zTmp3Idx */
    vpermi2ps(Zmm(0), Zmm(16), ptr[rcx]);
    vpermi2ps(Zmm(1), Zmm(17), ptr[rcx]);
    vpermi2ps(Zmm(2), Zmm(18), ptr[rcx]);
    vpermi2ps(Zmm(3), Zmm(19), ptr[rcx]);

    vpermi2ps(Zmm(4), Zmm(20), ptr[rcx]);
    vpermi2ps(Zmm(5), Zmm(21), ptr[rcx]);
    vpermi2ps(Zmm(6), Zmm(22), ptr[rcx]);
    vpermi2ps(Zmm(7), Zmm(23), ptr[rcx]);
